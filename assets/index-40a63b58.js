(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();function Fh(t,e){const n=Object.create(null),i=t.split(",");for(let s=0;s<i.length;s++)n[i[s]]=!0;return e?s=>!!n[s.toLowerCase()]:s=>!!n[s]}const Pe={},ws=[],Zt=()=>{},tw=()=>!1,nw=/^on[^a-z]/,Fc=t=>nw.test(t),Uh=t=>t.startsWith("onUpdate:"),at=Object.assign,zh=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},iw=Object.prototype.hasOwnProperty,de=(t,e)=>iw.call(t,e),W=Array.isArray,bs=t=>ko(t)==="[object Map]",er=t=>ko(t)==="[object Set]",Qf=t=>ko(t)==="[object Date]",Z=t=>typeof t=="function",He=t=>typeof t=="string",Ls=t=>typeof t=="symbol",Ae=t=>t!==null&&typeof t=="object",n_=t=>(Ae(t)||Z(t))&&Z(t.then)&&Z(t.catch),i_=Object.prototype.toString,ko=t=>i_.call(t),sw=t=>ko(t).slice(8,-1),s_=t=>ko(t)==="[object Object]",jh=t=>He(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,ka=Fh(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Uc=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},rw=/-(\w)/g,bn=Uc(t=>t.replace(rw,(e,n)=>n?n.toUpperCase():"")),ow=/\B([A-Z])/g,tr=Uc(t=>t.replace(ow,"-$1").toLowerCase()),zc=Uc(t=>t.charAt(0).toUpperCase()+t.slice(1)),Ul=Uc(t=>t?`on${zc(t)}`:""),Ki=(t,e)=>!Object.is(t,e),Na=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},Ha=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},r_=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let Yf;const Au=()=>Yf||(Yf=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Zr(t){if(W(t)){const e={};for(let n=0;n<t.length;n++){const i=t[n],s=He(i)?uw(i):Zr(i);if(s)for(const r in s)e[r]=s[r]}return e}else if(He(t)||Ae(t))return t}const aw=/;(?![^(]*\))/g,cw=/:([^]+)/,lw=/\/\*[^]*?\*\//g;function uw(t){const e={};return t.replace(lw,"").split(aw).forEach(n=>{if(n){const i=n.split(cw);i.length>1&&(e[i[0].trim()]=i[1].trim())}}),e}function No(t){let e="";if(He(t))e=t;else if(W(t))for(let n=0;n<t.length;n++){const i=No(t[n]);i&&(e+=i+" ")}else if(Ae(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const hw="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",dw=Fh(hw);function o_(t){return!!t||t===""}function fw(t,e){if(t.length!==e.length)return!1;let n=!0;for(let i=0;n&&i<t.length;i++)n=xo(t[i],e[i]);return n}function xo(t,e){if(t===e)return!0;let n=Qf(t),i=Qf(e);if(n||i)return n&&i?t.getTime()===e.getTime():!1;if(n=Ls(t),i=Ls(e),n||i)return t===e;if(n=W(t),i=W(e),n||i)return n&&i?fw(t,e):!1;if(n=Ae(t),i=Ae(e),n||i){if(!n||!i)return!1;const s=Object.keys(t).length,r=Object.keys(e).length;if(s!==r)return!1;for(const o in t){const a=t.hasOwnProperty(o),c=e.hasOwnProperty(o);if(a&&!c||!a&&c||!xo(t[o],e[o]))return!1}}return String(t)===String(e)}function Bh(t,e){return t.findIndex(n=>xo(n,e))}const At=t=>He(t)?t:t==null?"":W(t)||Ae(t)&&(t.toString===i_||!Z(t.toString))?JSON.stringify(t,a_,2):String(t),a_=(t,e)=>e&&e.__v_isRef?a_(t,e.value):bs(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[i,s])=>(n[`${i} =>`]=s,n),{})}:er(e)?{[`Set(${e.size})`]:[...e.values()]}:Ae(e)&&!W(e)&&!s_(e)?String(e):e;let Nt;class c_{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this.parent=Nt,!e&&Nt&&(this.index=(Nt.scopes||(Nt.scopes=[])).push(this)-1)}get active(){return this._active}run(e){if(this._active){const n=Nt;try{return Nt=this,e()}finally{Nt=n}}}on(){Nt=this}off(){Nt=this.parent}stop(e){if(this._active){let n,i;for(n=0,i=this.effects.length;n<i;n++)this.effects[n].stop();for(n=0,i=this.cleanups.length;n<i;n++)this.cleanups[n]();if(this.scopes)for(n=0,i=this.scopes.length;n<i;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!e){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0,this._active=!1}}}function jc(t){return new c_(t)}function pw(t,e=Nt){e&&e.active&&e.effects.push(t)}function $h(){return Nt}function l_(t){Nt&&Nt.cleanups.push(t)}const Wh=t=>{const e=new Set(t);return e.w=0,e.n=0,e},u_=t=>(t.w&vi)>0,h_=t=>(t.n&vi)>0,mw=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=vi},gw=t=>{const{deps:e}=t;if(e.length){let n=0;for(let i=0;i<e.length;i++){const s=e[i];u_(s)&&!h_(s)?s.delete(t):e[n++]=s,s.w&=~vi,s.n&=~vi}e.length=n}},Ka=new WeakMap;let Sr=0,vi=1;const Cu=30;let Kt;const Ui=Symbol(""),Su=Symbol("");class Hh{constructor(e,n=null,i){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,pw(this,i)}run(){if(!this.active)return this.fn();let e=Kt,n=li;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=Kt,Kt=this,li=!0,vi=1<<++Sr,Sr<=Cu?mw(this):Xf(this),this.fn()}finally{Sr<=Cu&&gw(this),vi=1<<--Sr,Kt=this.parent,li=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){Kt===this?this.deferStop=!0:this.active&&(Xf(this),this.onStop&&this.onStop(),this.active=!1)}}function Xf(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let li=!0;const d_=[];function nr(){d_.push(li),li=!1}function ir(){const t=d_.pop();li=t===void 0?!0:t}function St(t,e,n){if(li&&Kt){let i=Ka.get(t);i||Ka.set(t,i=new Map);let s=i.get(n);s||i.set(n,s=Wh()),f_(s)}}function f_(t,e){let n=!1;Sr<=Cu?h_(t)||(t.n|=vi,n=!u_(t)):n=!t.has(Kt),n&&(t.add(Kt),Kt.deps.push(t))}function jn(t,e,n,i,s,r){const o=Ka.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&W(t)){const c=Number(i);o.forEach((l,u)=>{(u==="length"||!Ls(u)&&u>=c)&&a.push(l)})}else switch(n!==void 0&&a.push(o.get(n)),e){case"add":W(t)?jh(n)&&a.push(o.get("length")):(a.push(o.get(Ui)),bs(t)&&a.push(o.get(Su)));break;case"delete":W(t)||(a.push(o.get(Ui)),bs(t)&&a.push(o.get(Su)));break;case"set":bs(t)&&a.push(o.get(Ui));break}if(a.length===1)a[0]&&Pu(a[0]);else{const c=[];for(const l of a)l&&c.push(...l);Pu(Wh(c))}}function Pu(t,e){const n=W(t)?t:[...t];for(const i of n)i.computed&&Jf(i);for(const i of n)i.computed||Jf(i)}function Jf(t,e){(t!==Kt||t.allowRecurse)&&(t.scheduler?t.scheduler():t.run())}function _w(t,e){var n;return(n=Ka.get(t))==null?void 0:n.get(e)}const vw=Fh("__proto__,__v_isRef,__isVue"),p_=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(Ls)),Zf=yw();function yw(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const i=fe(this);for(let r=0,o=this.length;r<o;r++)St(i,"get",r+"");const s=i[e](...n);return s===-1||s===!1?i[e](...n.map(fe)):s}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){nr();const i=fe(this)[e].apply(this,n);return ir(),i}}),t}function Ew(t){const e=fe(this);return St(e,"has",t),e.hasOwnProperty(t)}class m_{constructor(e=!1,n=!1){this._isReadonly=e,this._shallow=n}get(e,n,i){const s=this._isReadonly,r=this._shallow;if(n==="__v_isReactive")return!s;if(n==="__v_isReadonly")return s;if(n==="__v_isShallow")return r;if(n==="__v_raw"&&i===(s?r?Ow:y_:r?v_:__).get(e))return e;const o=W(e);if(!s){if(o&&de(Zf,n))return Reflect.get(Zf,n,i);if(n==="hasOwnProperty")return Ew}const a=Reflect.get(e,n,i);return(Ls(n)?p_.has(n):vw(n))||(s||St(e,"get",n),r)?a:Me(a)?o&&jh(n)?a:a.value:Ae(a)?s?T_(a):Oo(a):a}}class g_ extends m_{constructor(e=!1){super(!1,e)}set(e,n,i,s){let r=e[n];if(Ms(r)&&Me(r)&&!Me(i))return!1;if(!this._shallow&&(!Ga(i)&&!Ms(i)&&(r=fe(r),i=fe(i)),!W(e)&&Me(r)&&!Me(i)))return r.value=i,!0;const o=W(e)&&jh(n)?Number(n)<e.length:de(e,n),a=Reflect.set(e,n,i,s);return e===fe(s)&&(o?Ki(i,r)&&jn(e,"set",n,i):jn(e,"add",n,i)),a}deleteProperty(e,n){const i=de(e,n);e[n];const s=Reflect.deleteProperty(e,n);return s&&i&&jn(e,"delete",n,void 0),s}has(e,n){const i=Reflect.has(e,n);return(!Ls(n)||!p_.has(n))&&St(e,"has",n),i}ownKeys(e){return St(e,"iterate",W(e)?"length":Ui),Reflect.ownKeys(e)}}class Tw extends m_{constructor(e=!1){super(!0,e)}set(e,n){return!0}deleteProperty(e,n){return!0}}const Iw=new g_,ww=new Tw,bw=new g_(!0),Kh=t=>t,Bc=t=>Reflect.getPrototypeOf(t);function aa(t,e,n=!1,i=!1){t=t.__v_raw;const s=fe(t),r=fe(e);n||(Ki(e,r)&&St(s,"get",e),St(s,"get",r));const{has:o}=Bc(s),a=i?Kh:n?Yh:eo;if(o.call(s,e))return a(t.get(e));if(o.call(s,r))return a(t.get(r));t!==s&&t.get(e)}function ca(t,e=!1){const n=this.__v_raw,i=fe(n),s=fe(t);return e||(Ki(t,s)&&St(i,"has",t),St(i,"has",s)),t===s?n.has(t):n.has(t)||n.has(s)}function la(t,e=!1){return t=t.__v_raw,!e&&St(fe(t),"iterate",Ui),Reflect.get(t,"size",t)}function ep(t){t=fe(t);const e=fe(this);return Bc(e).has.call(e,t)||(e.add(t),jn(e,"add",t,t)),this}function tp(t,e){e=fe(e);const n=fe(this),{has:i,get:s}=Bc(n);let r=i.call(n,t);r||(t=fe(t),r=i.call(n,t));const o=s.call(n,t);return n.set(t,e),r?Ki(e,o)&&jn(n,"set",t,e):jn(n,"add",t,e),this}function np(t){const e=fe(this),{has:n,get:i}=Bc(e);let s=n.call(e,t);s||(t=fe(t),s=n.call(e,t)),i&&i.call(e,t);const r=e.delete(t);return s&&jn(e,"delete",t,void 0),r}function ip(){const t=fe(this),e=t.size!==0,n=t.clear();return e&&jn(t,"clear",void 0,void 0),n}function ua(t,e){return function(i,s){const r=this,o=r.__v_raw,a=fe(o),c=e?Kh:t?Yh:eo;return!t&&St(a,"iterate",Ui),o.forEach((l,u)=>i.call(s,c(l),c(u),r))}}function ha(t,e,n){return function(...i){const s=this.__v_raw,r=fe(s),o=bs(r),a=t==="entries"||t===Symbol.iterator&&o,c=t==="keys"&&o,l=s[t](...i),u=n?Kh:e?Yh:eo;return!e&&St(r,"iterate",c?Su:Ui),{next(){const{value:h,done:d}=l.next();return d?{value:h,done:d}:{value:a?[u(h[0]),u(h[1])]:u(h),done:d}},[Symbol.iterator](){return this}}}}function Zn(t){return function(...e){return t==="delete"?!1:this}}function Rw(){const t={get(r){return aa(this,r)},get size(){return la(this)},has:ca,add:ep,set:tp,delete:np,clear:ip,forEach:ua(!1,!1)},e={get(r){return aa(this,r,!1,!0)},get size(){return la(this)},has:ca,add:ep,set:tp,delete:np,clear:ip,forEach:ua(!1,!0)},n={get(r){return aa(this,r,!0)},get size(){return la(this,!0)},has(r){return ca.call(this,r,!0)},add:Zn("add"),set:Zn("set"),delete:Zn("delete"),clear:Zn("clear"),forEach:ua(!0,!1)},i={get(r){return aa(this,r,!0,!0)},get size(){return la(this,!0)},has(r){return ca.call(this,r,!0)},add:Zn("add"),set:Zn("set"),delete:Zn("delete"),clear:Zn("clear"),forEach:ua(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=ha(r,!1,!1),n[r]=ha(r,!0,!1),e[r]=ha(r,!1,!0),i[r]=ha(r,!0,!0)}),[t,n,e,i]}const[Aw,Cw,Sw,Pw]=Rw();function Gh(t,e){const n=e?t?Pw:Sw:t?Cw:Aw;return(i,s,r)=>s==="__v_isReactive"?!t:s==="__v_isReadonly"?t:s==="__v_raw"?i:Reflect.get(de(n,s)&&s in i?n:i,s,r)}const kw={get:Gh(!1,!1)},Nw={get:Gh(!1,!0)},xw={get:Gh(!0,!1)},__=new WeakMap,v_=new WeakMap,y_=new WeakMap,Ow=new WeakMap;function Dw(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Lw(t){return t.__v_skip||!Object.isExtensible(t)?0:Dw(sw(t))}function Oo(t){return Ms(t)?t:Qh(t,!1,Iw,kw,__)}function E_(t){return Qh(t,!1,bw,Nw,v_)}function T_(t){return Qh(t,!0,ww,xw,y_)}function Qh(t,e,n,i,s){if(!Ae(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const r=s.get(t);if(r)return r;const o=Lw(t);if(o===0)return t;const a=new Proxy(t,o===2?i:n);return s.set(t,a),a}function ui(t){return Ms(t)?ui(t.__v_raw):!!(t&&t.__v_isReactive)}function Ms(t){return!!(t&&t.__v_isReadonly)}function Ga(t){return!!(t&&t.__v_isShallow)}function I_(t){return ui(t)||Ms(t)}function fe(t){const e=t&&t.__v_raw;return e?fe(e):t}function $c(t){return Ha(t,"__v_skip",!0),t}const eo=t=>Ae(t)?Oo(t):t,Yh=t=>Ae(t)?T_(t):t;function w_(t){li&&Kt&&(t=fe(t),f_(t.dep||(t.dep=Wh())))}function b_(t,e){t=fe(t);const n=t.dep;n&&Pu(n)}function Me(t){return!!(t&&t.__v_isRef===!0)}function hi(t){return A_(t,!1)}function R_(t){return A_(t,!0)}function A_(t,e){return Me(t)?t:new Mw(t,e)}class Mw{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:fe(e),this._value=n?e:eo(e)}get value(){return w_(this),this._value}set value(e){const n=this.__v_isShallow||Ga(e)||Ms(e);e=n?e:fe(e),Ki(e,this._rawValue)&&(this._rawValue=e,this._value=n?e:eo(e),b_(this))}}function zi(t){return Me(t)?t.value:t}function Ln(t){return Z(t)?t():zi(t)}const qw={get:(t,e,n)=>zi(Reflect.get(t,e,n)),set:(t,e,n,i)=>{const s=t[e];return Me(s)&&!Me(n)?(s.value=n,!0):Reflect.set(t,e,n,i)}};function C_(t){return ui(t)?t:new Proxy(t,qw)}function Vw(t){const e=W(t)?new Array(t.length):{};for(const n in t)e[n]=S_(t,n);return e}class Fw{constructor(e,n,i){this._object=e,this._key=n,this._defaultValue=i,this.__v_isRef=!0}get value(){const e=this._object[this._key];return e===void 0?this._defaultValue:e}set value(e){this._object[this._key]=e}get dep(){return _w(fe(this._object),this._key)}}class Uw{constructor(e){this._getter=e,this.__v_isRef=!0,this.__v_isReadonly=!0}get value(){return this._getter()}}function zw(t,e,n){return Me(t)?t:Z(t)?new Uw(t):Ae(t)&&arguments.length>1?S_(t,e,n):hi(t)}function S_(t,e,n){const i=t[e];return Me(i)?i:new Fw(t,e,n)}class jw{constructor(e,n,i,s){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this._dirty=!0,this.effect=new Hh(e,()=>{this._dirty||(this._dirty=!0,b_(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!s,this.__v_isReadonly=i}get value(){const e=fe(this);return w_(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}function Bw(t,e,n=!1){let i,s;const r=Z(t);return r?(i=t,s=Zt):(i=t.get,s=t.set),new jw(i,s,r||!s,n)}function di(t,e,n,i){let s;try{s=i?t(...i):t()}catch(r){Wc(r,e,n)}return s}function en(t,e,n,i){if(Z(t)){const r=di(t,e,n,i);return r&&n_(r)&&r.catch(o=>{Wc(o,e,n)}),r}const s=[];for(let r=0;r<t.length;r++)s.push(en(t[r],e,n,i));return s}function Wc(t,e,n,i=!0){const s=e?e.vnode:null;if(e){let r=e.parent;const o=e.proxy,a=n;for(;r;){const l=r.ec;if(l){for(let u=0;u<l.length;u++)if(l[u](t,o,a)===!1)return}r=r.parent}const c=e.appContext.config.errorHandler;if(c){di(c,null,10,[t,o,a]);return}}$w(t,n,s,i)}function $w(t,e,n,i=!0){console.error(t)}let to=!1,ku=!1;const gt=[];let hn=0;const Rs=[];let Mn=null,xi=0;const P_=Promise.resolve();let Xh=null;function Jh(t){const e=Xh||P_;return t?e.then(this?t.bind(this):t):e}function Ww(t){let e=hn+1,n=gt.length;for(;e<n;){const i=e+n>>>1,s=gt[i],r=no(s);r<t||r===t&&s.pre?e=i+1:n=i}return e}function Zh(t){(!gt.length||!gt.includes(t,to&&t.allowRecurse?hn+1:hn))&&(t.id==null?gt.push(t):gt.splice(Ww(t.id),0,t),k_())}function k_(){!to&&!ku&&(ku=!0,Xh=P_.then(x_))}function Hw(t){const e=gt.indexOf(t);e>hn&&gt.splice(e,1)}function Kw(t){W(t)?Rs.push(...t):(!Mn||!Mn.includes(t,t.allowRecurse?xi+1:xi))&&Rs.push(t),k_()}function sp(t,e=to?hn+1:0){for(;e<gt.length;e++){const n=gt[e];n&&n.pre&&(gt.splice(e,1),e--,n())}}function N_(t){if(Rs.length){const e=[...new Set(Rs)];if(Rs.length=0,Mn){Mn.push(...e);return}for(Mn=e,Mn.sort((n,i)=>no(n)-no(i)),xi=0;xi<Mn.length;xi++)Mn[xi]();Mn=null,xi=0}}const no=t=>t.id==null?1/0:t.id,Gw=(t,e)=>{const n=no(t)-no(e);if(n===0){if(t.pre&&!e.pre)return-1;if(e.pre&&!t.pre)return 1}return n};function x_(t){ku=!1,to=!0,gt.sort(Gw);const e=Zt;try{for(hn=0;hn<gt.length;hn++){const n=gt[hn];n&&n.active!==!1&&di(n,null,14)}}finally{hn=0,gt.length=0,N_(),to=!1,Xh=null,(gt.length||Rs.length)&&x_()}}function Qw(t,e,...n){if(t.isUnmounted)return;const i=t.vnode.props||Pe;let s=n;const r=e.startsWith("update:"),o=r&&e.slice(7);if(o&&o in i){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:h,trim:d}=i[u]||Pe;d&&(s=n.map(f=>He(f)?f.trim():f)),h&&(s=n.map(r_))}let a,c=i[a=Ul(e)]||i[a=Ul(bn(e))];!c&&r&&(c=i[a=Ul(tr(e))]),c&&en(c,t,6,s);const l=i[a+"Once"];if(l){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,en(l,t,6,s)}}function O_(t,e,n=!1){const i=e.emitsCache,s=i.get(t);if(s!==void 0)return s;const r=t.emits;let o={},a=!1;if(!Z(t)){const c=l=>{const u=O_(l,e,!0);u&&(a=!0,at(o,u))};!n&&e.mixins.length&&e.mixins.forEach(c),t.extends&&c(t.extends),t.mixins&&t.mixins.forEach(c)}return!r&&!a?(Ae(t)&&i.set(t,null),null):(W(r)?r.forEach(c=>o[c]=null):at(o,r),Ae(t)&&i.set(t,o),o)}function Hc(t,e){return!t||!Fc(e)?!1:(e=e.slice(2).replace(/Once$/,""),de(t,e[0].toLowerCase()+e.slice(1))||de(t,tr(e))||de(t,e))}let Ye=null,D_=null;function Qa(t){const e=Ye;return Ye=t,D_=t&&t.type.__scopeId||null,e}function xa(t,e=Ye,n){if(!e||t._n)return t;const i=(...s)=>{i._d&&mp(-1);const r=Qa(e);let o;try{o=t(...s)}finally{Qa(r),i._d&&mp(1)}return o};return i._n=!0,i._c=!0,i._d=!0,i}function zl(t){const{type:e,vnode:n,proxy:i,withProxy:s,props:r,propsOptions:[o],slots:a,attrs:c,emit:l,render:u,renderCache:h,data:d,setupState:f,ctx:g,inheritAttrs:v}=t;let y,I;const P=Qa(t);try{if(n.shapeFlag&4){const R=s||i;y=un(u.call(R,R,h,r,f,d,g)),I=c}else{const R=e;y=un(R.length>1?R(r,{attrs:c,slots:a,emit:l}):R(r,null)),I=e.props?c:Yw(c)}}catch(R){Fr.length=0,Wc(R,t,1),y=Fe(yi)}let k=y;if(I&&v!==!1){const R=Object.keys(I),{shapeFlag:K}=k;R.length&&K&7&&(o&&R.some(Uh)&&(I=Xw(I,o)),k=qs(k,I))}return n.dirs&&(k=qs(k),k.dirs=k.dirs?k.dirs.concat(n.dirs):n.dirs),n.transition&&(k.transition=n.transition),y=k,Qa(P),y}const Yw=t=>{let e;for(const n in t)(n==="class"||n==="style"||Fc(n))&&((e||(e={}))[n]=t[n]);return e},Xw=(t,e)=>{const n={};for(const i in t)(!Uh(i)||!(i.slice(9)in e))&&(n[i]=t[i]);return n};function Jw(t,e,n){const{props:i,children:s,component:r}=t,{props:o,children:a,patchFlag:c}=e,l=r.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return i?rp(i,o,l):!!o;if(c&8){const u=e.dynamicProps;for(let h=0;h<u.length;h++){const d=u[h];if(o[d]!==i[d]&&!Hc(l,d))return!0}}}else return(s||a)&&(!a||!a.$stable)?!0:i===o?!1:i?o?rp(i,o,l):!0:!!o;return!1}function rp(t,e,n){const i=Object.keys(e);if(i.length!==Object.keys(t).length)return!0;for(let s=0;s<i.length;s++){const r=i[s];if(e[r]!==t[r]&&!Hc(n,r))return!0}return!1}function Zw({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const L_="components";function fi(t,e){return t0(L_,t,!0,e)||t}const e0=Symbol.for("v-ndc");function t0(t,e,n=!0,i=!1){const s=Ye||$e;if(s){const r=s.type;if(t===L_){const a=K0(r,!1);if(a&&(a===e||a===bn(e)||a===zc(bn(e))))return r}const o=op(s[t]||r[t],e)||op(s.appContext[t],e);return!o&&i?r:o}}function op(t,e){return t&&(t[e]||t[bn(e)]||t[zc(bn(e))])}const n0=t=>t.__isSuspense;function i0(t,e){e&&e.pendingBranch?W(t)?e.effects.push(...t):e.effects.push(t):Kw(t)}const da={};function As(t,e,n){return M_(t,e,n)}function M_(t,e,{immediate:n,deep:i,flush:s,onTrack:r,onTrigger:o}=Pe){var a;const c=$h()===((a=$e)==null?void 0:a.scope)?$e:null;let l,u=!1,h=!1;if(Me(t)?(l=()=>t.value,u=Ga(t)):ui(t)?(l=()=>t,i=!0):W(t)?(h=!0,u=t.some(R=>ui(R)||Ga(R)),l=()=>t.map(R=>{if(Me(R))return R.value;if(ui(R))return Di(R);if(Z(R))return di(R,c,2)})):Z(t)?e?l=()=>di(t,c,2):l=()=>{if(!(c&&c.isUnmounted))return d&&d(),en(t,c,3,[f])}:l=Zt,e&&i){const R=l;l=()=>Di(R())}let d,f=R=>{d=P.onStop=()=>{di(R,c,4)}},g;if(ro)if(f=Zt,e?n&&en(e,c,3,[l(),h?[]:void 0,f]):l(),s==="sync"){const R=Y0();g=R.__watcherHandles||(R.__watcherHandles=[])}else return Zt;let v=h?new Array(t.length).fill(da):da;const y=()=>{if(P.active)if(e){const R=P.run();(i||u||(h?R.some((K,ie)=>Ki(K,v[ie])):Ki(R,v)))&&(d&&d(),en(e,c,3,[R,v===da?void 0:h&&v[0]===da?[]:v,f]),v=R)}else P.run()};y.allowRecurse=!!e;let I;s==="sync"?I=y:s==="post"?I=()=>Rt(y,c&&c.suspense):(y.pre=!0,c&&(y.id=c.uid),I=()=>Zh(y));const P=new Hh(l,I);e?n?y():v=P.run():s==="post"?Rt(P.run.bind(P),c&&c.suspense):P.run();const k=()=>{P.stop(),c&&c.scope&&zh(c.scope.effects,P)};return g&&g.push(k),k}function s0(t,e,n){const i=this.proxy,s=He(t)?t.includes(".")?q_(i,t):()=>i[t]:t.bind(i,i);let r;Z(e)?r=e:(r=e.handler,n=e);const o=$e;Vs(this);const a=M_(s,r.bind(i),n);return o?Vs(o):Bi(),a}function q_(t,e){const n=e.split(".");return()=>{let i=t;for(let s=0;s<n.length&&i;s++)i=i[n[s]];return i}}function Di(t,e){if(!Ae(t)||t.__v_skip||(e=e||new Set,e.has(t)))return t;if(e.add(t),Me(t))Di(t.value,e);else if(W(t))for(let n=0;n<t.length;n++)Di(t[n],e);else if(er(t)||bs(t))t.forEach(n=>{Di(n,e)});else if(s_(t))for(const n in t)Di(t[n],e);return t}function V_(t,e){const n=Ye;if(n===null)return t;const i=Yc(n)||n.proxy,s=t.dirs||(t.dirs=[]);for(let r=0;r<e.length;r++){let[o,a,c,l=Pe]=e[r];o&&(Z(o)&&(o={mounted:o,updated:o}),o.deep&&Di(a),s.push({dir:o,instance:i,value:a,oldValue:void 0,arg:c,modifiers:l}))}return t}function Si(t,e,n,i){const s=t.dirs,r=e&&e.dirs;for(let o=0;o<s.length;o++){const a=s[o];r&&(a.oldValue=r[o].value);let c=a.dir[i];c&&(nr(),en(c,n,8,[t.el,a,t,e]),ir())}}/*! #__NO_SIDE_EFFECTS__ */function F_(t,e){return Z(t)?(()=>at({name:t.name},e,{setup:t}))():t}const qr=t=>!!t.type.__asyncLoader,U_=t=>t.type.__isKeepAlive;function r0(t,e){z_(t,"a",e)}function o0(t,e){z_(t,"da",e)}function z_(t,e,n=$e){const i=t.__wdc||(t.__wdc=()=>{let s=n;for(;s;){if(s.isDeactivated)return;s=s.parent}return t()});if(Kc(e,i,n),n){let s=n.parent;for(;s&&s.parent;)U_(s.parent.vnode)&&a0(i,e,n,s),s=s.parent}}function a0(t,e,n,i){const s=Kc(e,t,i,!0);j_(()=>{zh(i[e],s)},n)}function Kc(t,e,n=$e,i=!1){if(n){const s=n[t]||(n[t]=[]),r=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;nr(),Vs(n);const a=en(e,n,t,o);return Bi(),ir(),a});return i?s.unshift(r):s.push(r),r}}const Yn=t=>(e,n=$e)=>(!ro||t==="sp")&&Kc(t,(...i)=>e(...i),n),c0=Yn("bm"),l0=Yn("m"),u0=Yn("bu"),h0=Yn("u"),d0=Yn("bum"),j_=Yn("um"),B_=Yn("sp"),f0=Yn("rtg"),p0=Yn("rtc");function m0(t,e=$e){Kc("ec",t,e)}function Ya(t,e,n,i){let s;const r=n&&n[i];if(W(t)||He(t)){s=new Array(t.length);for(let o=0,a=t.length;o<a;o++)s[o]=e(t[o],o,void 0,r&&r[o])}else if(typeof t=="number"){s=new Array(t);for(let o=0;o<t;o++)s[o]=e(o+1,o,void 0,r&&r[o])}else if(Ae(t))if(t[Symbol.iterator])s=Array.from(t,(o,a)=>e(o,a,void 0,r&&r[a]));else{const o=Object.keys(t);s=new Array(o.length);for(let a=0,c=o.length;a<c;a++){const l=o[a];s[a]=e(t[l],l,a,r&&r[a])}}else s=[];return n&&(n[i]=s),s}function g0(t,e,n={},i,s){if(Ye.isCE||Ye.parent&&qr(Ye.parent)&&Ye.parent.isCE)return e!=="default"&&(n.name=e),Fe("slot",n,i&&i());let r=t[e];r&&r._c&&(r._d=!1),ve();const o=r&&$_(r(n)),a=Do(tt,{key:n.key||o&&o.key||`_${e}`},o||(i?i():[]),o&&t._===1?64:-2);return!s&&a.scopeId&&(a.slotScopeIds=[a.scopeId+"-s"]),r&&r._c&&(r._d=!0),a}function $_(t){return t.some(e=>Ja(e)?!(e.type===yi||e.type===tt&&!$_(e.children)):!0)?t:null}const Nu=t=>t?nv(t)?Yc(t)||t.proxy:Nu(t.parent):null,Vr=at(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>Nu(t.parent),$root:t=>Nu(t.root),$emit:t=>t.emit,$options:t=>ed(t),$forceUpdate:t=>t.f||(t.f=()=>Zh(t.update)),$nextTick:t=>t.n||(t.n=Jh.bind(t.proxy)),$watch:t=>s0.bind(t)}),jl=(t,e)=>t!==Pe&&!t.__isScriptSetup&&de(t,e),_0={get({_:t},e){const{ctx:n,setupState:i,data:s,props:r,accessCache:o,type:a,appContext:c}=t;let l;if(e[0]!=="$"){const f=o[e];if(f!==void 0)switch(f){case 1:return i[e];case 2:return s[e];case 4:return n[e];case 3:return r[e]}else{if(jl(i,e))return o[e]=1,i[e];if(s!==Pe&&de(s,e))return o[e]=2,s[e];if((l=t.propsOptions[0])&&de(l,e))return o[e]=3,r[e];if(n!==Pe&&de(n,e))return o[e]=4,n[e];xu&&(o[e]=0)}}const u=Vr[e];let h,d;if(u)return e==="$attrs"&&St(t,"get",e),u(t);if((h=a.__cssModules)&&(h=h[e]))return h;if(n!==Pe&&de(n,e))return o[e]=4,n[e];if(d=c.config.globalProperties,de(d,e))return d[e]},set({_:t},e,n){const{data:i,setupState:s,ctx:r}=t;return jl(s,e)?(s[e]=n,!0):i!==Pe&&de(i,e)?(i[e]=n,!0):de(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(r[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:i,appContext:s,propsOptions:r}},o){let a;return!!n[o]||t!==Pe&&de(t,o)||jl(e,o)||(a=r[0])&&de(a,o)||de(i,o)||de(Vr,o)||de(s.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:de(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};function ap(t){return W(t)?t.reduce((e,n)=>(e[n]=null,e),{}):t}let xu=!0;function v0(t){const e=ed(t),n=t.proxy,i=t.ctx;xu=!1,e.beforeCreate&&cp(e.beforeCreate,t,"bc");const{data:s,computed:r,methods:o,watch:a,provide:c,inject:l,created:u,beforeMount:h,mounted:d,beforeUpdate:f,updated:g,activated:v,deactivated:y,beforeDestroy:I,beforeUnmount:P,destroyed:k,unmounted:R,render:K,renderTracked:ie,renderTriggered:he,errorCaptured:G,serverPrefetch:ne,expose:Ie,inheritAttrs:ct,components:Pt,directives:qt,filters:Ci}=e;if(l&&y0(l,i,null),o)for(const Re in o){const ge=o[Re];Z(ge)&&(i[Re]=ge.bind(n))}if(s){const Re=s.call(n,n);Ae(Re)&&(t.data=Oo(Re))}if(xu=!0,r)for(const Re in r){const ge=r[Re],On=Z(ge)?ge.bind(n,n):Z(ge.get)?ge.get.bind(n,n):Zt,Jn=!Z(ge)&&Z(ge.set)?ge.set.bind(n):Zt,an=Ut({get:On,set:Jn});Object.defineProperty(i,Re,{enumerable:!0,configurable:!0,get:()=>an.value,set:bt=>an.value=bt})}if(a)for(const Re in a)W_(a[Re],i,n,Re);if(c){const Re=Z(c)?c.call(n):c;Reflect.ownKeys(Re).forEach(ge=>{Oa(ge,Re[ge])})}u&&cp(u,t,"c");function pe(Re,ge){W(ge)?ge.forEach(On=>Re(On.bind(n))):ge&&Re(ge.bind(n))}if(pe(c0,h),pe(l0,d),pe(u0,f),pe(h0,g),pe(r0,v),pe(o0,y),pe(m0,G),pe(p0,ie),pe(f0,he),pe(d0,P),pe(j_,R),pe(B_,ne),W(Ie))if(Ie.length){const Re=t.exposed||(t.exposed={});Ie.forEach(ge=>{Object.defineProperty(Re,ge,{get:()=>n[ge],set:On=>n[ge]=On})})}else t.exposed||(t.exposed={});K&&t.render===Zt&&(t.render=K),ct!=null&&(t.inheritAttrs=ct),Pt&&(t.components=Pt),qt&&(t.directives=qt)}function y0(t,e,n=Zt){W(t)&&(t=Ou(t));for(const i in t){const s=t[i];let r;Ae(s)?"default"in s?r=$t(s.from||i,s.default,!0):r=$t(s.from||i):r=$t(s),Me(r)?Object.defineProperty(e,i,{enumerable:!0,configurable:!0,get:()=>r.value,set:o=>r.value=o}):e[i]=r}}function cp(t,e,n){en(W(t)?t.map(i=>i.bind(e.proxy)):t.bind(e.proxy),e,n)}function W_(t,e,n,i){const s=i.includes(".")?q_(n,i):()=>n[i];if(He(t)){const r=e[t];Z(r)&&As(s,r)}else if(Z(t))As(s,t.bind(n));else if(Ae(t))if(W(t))t.forEach(r=>W_(r,e,n,i));else{const r=Z(t.handler)?t.handler.bind(n):e[t.handler];Z(r)&&As(s,r,t)}}function ed(t){const e=t.type,{mixins:n,extends:i}=e,{mixins:s,optionsCache:r,config:{optionMergeStrategies:o}}=t.appContext,a=r.get(e);let c;return a?c=a:!s.length&&!n&&!i?c=e:(c={},s.length&&s.forEach(l=>Xa(c,l,o,!0)),Xa(c,e,o)),Ae(e)&&r.set(e,c),c}function Xa(t,e,n,i=!1){const{mixins:s,extends:r}=e;r&&Xa(t,r,n,!0),s&&s.forEach(o=>Xa(t,o,n,!0));for(const o in e)if(!(i&&o==="expose")){const a=E0[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const E0={data:lp,props:up,emits:up,methods:Pr,computed:Pr,beforeCreate:It,created:It,beforeMount:It,mounted:It,beforeUpdate:It,updated:It,beforeDestroy:It,beforeUnmount:It,destroyed:It,unmounted:It,activated:It,deactivated:It,errorCaptured:It,serverPrefetch:It,components:Pr,directives:Pr,watch:I0,provide:lp,inject:T0};function lp(t,e){return e?t?function(){return at(Z(t)?t.call(this,this):t,Z(e)?e.call(this,this):e)}:e:t}function T0(t,e){return Pr(Ou(t),Ou(e))}function Ou(t){if(W(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function It(t,e){return t?[...new Set([].concat(t,e))]:e}function Pr(t,e){return t?at(Object.create(null),t,e):e}function up(t,e){return t?W(t)&&W(e)?[...new Set([...t,...e])]:at(Object.create(null),ap(t),ap(e??{})):e}function I0(t,e){if(!t)return e;if(!e)return t;const n=at(Object.create(null),t);for(const i in e)n[i]=It(t[i],e[i]);return n}function H_(){return{app:null,config:{isNativeTag:tw,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let w0=0;function b0(t,e){return function(i,s=null){Z(i)||(i=at({},i)),s!=null&&!Ae(s)&&(s=null);const r=H_(),o=new WeakSet;let a=!1;const c=r.app={_uid:w0++,_component:i,_props:s,_container:null,_context:r,_instance:null,version:X0,get config(){return r.config},set config(l){},use(l,...u){return o.has(l)||(l&&Z(l.install)?(o.add(l),l.install(c,...u)):Z(l)&&(o.add(l),l(c,...u))),c},mixin(l){return r.mixins.includes(l)||r.mixins.push(l),c},component(l,u){return u?(r.components[l]=u,c):r.components[l]},directive(l,u){return u?(r.directives[l]=u,c):r.directives[l]},mount(l,u,h){if(!a){const d=Fe(i,s);return d.appContext=r,u&&e?e(d,l):t(d,l,h),a=!0,c._container=l,l.__vue_app__=c,Yc(d.component)||d.component.proxy}},unmount(){a&&(t(null,c._container),delete c._container.__vue_app__)},provide(l,u){return r.provides[l]=u,c},runWithContext(l){io=c;try{return l()}finally{io=null}}};return c}}let io=null;function Oa(t,e){if($e){let n=$e.provides;const i=$e.parent&&$e.parent.provides;i===n&&(n=$e.provides=Object.create(i)),n[t]=e}}function $t(t,e,n=!1){const i=$e||Ye;if(i||io){const s=i?i.parent==null?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides:io._context.provides;if(s&&t in s)return s[t];if(arguments.length>1)return n&&Z(e)?e.call(i&&i.proxy):e}}function R0(){return!!($e||Ye||io)}function A0(t,e,n,i=!1){const s={},r={};Ha(r,Qc,1),t.propsDefaults=Object.create(null),K_(t,e,s,r);for(const o in t.propsOptions[0])o in s||(s[o]=void 0);n?t.props=i?s:E_(s):t.type.props?t.props=s:t.props=r,t.attrs=r}function C0(t,e,n,i){const{props:s,attrs:r,vnode:{patchFlag:o}}=t,a=fe(s),[c]=t.propsOptions;let l=!1;if((i||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let h=0;h<u.length;h++){let d=u[h];if(Hc(t.emitsOptions,d))continue;const f=e[d];if(c)if(de(r,d))f!==r[d]&&(r[d]=f,l=!0);else{const g=bn(d);s[g]=Du(c,a,g,f,t,!1)}else f!==r[d]&&(r[d]=f,l=!0)}}}else{K_(t,e,s,r)&&(l=!0);let u;for(const h in a)(!e||!de(e,h)&&((u=tr(h))===h||!de(e,u)))&&(c?n&&(n[h]!==void 0||n[u]!==void 0)&&(s[h]=Du(c,a,h,void 0,t,!0)):delete s[h]);if(r!==a)for(const h in r)(!e||!de(e,h))&&(delete r[h],l=!0)}l&&jn(t,"set","$attrs")}function K_(t,e,n,i){const[s,r]=t.propsOptions;let o=!1,a;if(e)for(let c in e){if(ka(c))continue;const l=e[c];let u;s&&de(s,u=bn(c))?!r||!r.includes(u)?n[u]=l:(a||(a={}))[u]=l:Hc(t.emitsOptions,c)||(!(c in i)||l!==i[c])&&(i[c]=l,o=!0)}if(r){const c=fe(n),l=a||Pe;for(let u=0;u<r.length;u++){const h=r[u];n[h]=Du(s,c,h,l[h],t,!de(l,h))}}return o}function Du(t,e,n,i,s,r){const o=t[n];if(o!=null){const a=de(o,"default");if(a&&i===void 0){const c=o.default;if(o.type!==Function&&!o.skipFactory&&Z(c)){const{propsDefaults:l}=s;n in l?i=l[n]:(Vs(s),i=l[n]=c.call(null,e),Bi())}else i=c}o[0]&&(r&&!a?i=!1:o[1]&&(i===""||i===tr(n))&&(i=!0))}return i}function G_(t,e,n=!1){const i=e.propsCache,s=i.get(t);if(s)return s;const r=t.props,o={},a=[];let c=!1;if(!Z(t)){const u=h=>{c=!0;const[d,f]=G_(h,e,!0);at(o,d),f&&a.push(...f)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!r&&!c)return Ae(t)&&i.set(t,ws),ws;if(W(r))for(let u=0;u<r.length;u++){const h=bn(r[u]);hp(h)&&(o[h]=Pe)}else if(r)for(const u in r){const h=bn(u);if(hp(h)){const d=r[u],f=o[h]=W(d)||Z(d)?{type:d}:at({},d);if(f){const g=pp(Boolean,f.type),v=pp(String,f.type);f[0]=g>-1,f[1]=v<0||g<v,(g>-1||de(f,"default"))&&a.push(h)}}}const l=[o,a];return Ae(t)&&i.set(t,l),l}function hp(t){return t[0]!=="$"}function dp(t){const e=t&&t.toString().match(/^\s*(function|class) (\w+)/);return e?e[2]:t===null?"null":""}function fp(t,e){return dp(t)===dp(e)}function pp(t,e){return W(e)?e.findIndex(n=>fp(n,t)):Z(e)&&fp(e,t)?0:-1}const Q_=t=>t[0]==="_"||t==="$stable",td=t=>W(t)?t.map(un):[un(t)],S0=(t,e,n)=>{if(e._n)return e;const i=xa((...s)=>td(e(...s)),n);return i._c=!1,i},Y_=(t,e,n)=>{const i=t._ctx;for(const s in t){if(Q_(s))continue;const r=t[s];if(Z(r))e[s]=S0(s,r,i);else if(r!=null){const o=td(r);e[s]=()=>o}}},X_=(t,e)=>{const n=td(e);t.slots.default=()=>n},P0=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=fe(e),Ha(e,"_",n)):Y_(e,t.slots={})}else t.slots={},e&&X_(t,e);Ha(t.slots,Qc,1)},k0=(t,e,n)=>{const{vnode:i,slots:s}=t;let r=!0,o=Pe;if(i.shapeFlag&32){const a=e._;a?n&&a===1?r=!1:(at(s,e),!n&&a===1&&delete s._):(r=!e.$stable,Y_(e,s)),o=e}else e&&(X_(t,e),o={default:1});if(r)for(const a in s)!Q_(a)&&o[a]==null&&delete s[a]};function Lu(t,e,n,i,s=!1){if(W(t)){t.forEach((d,f)=>Lu(d,e&&(W(e)?e[f]:e),n,i,s));return}if(qr(i)&&!s)return;const r=i.shapeFlag&4?Yc(i.component)||i.component.proxy:i.el,o=s?null:r,{i:a,r:c}=t,l=e&&e.r,u=a.refs===Pe?a.refs={}:a.refs,h=a.setupState;if(l!=null&&l!==c&&(He(l)?(u[l]=null,de(h,l)&&(h[l]=null)):Me(l)&&(l.value=null)),Z(c))di(c,a,12,[o,u]);else{const d=He(c),f=Me(c);if(d||f){const g=()=>{if(t.f){const v=d?de(h,c)?h[c]:u[c]:c.value;s?W(v)&&zh(v,r):W(v)?v.includes(r)||v.push(r):d?(u[c]=[r],de(h,c)&&(h[c]=u[c])):(c.value=[r],t.k&&(u[t.k]=c.value))}else d?(u[c]=o,de(h,c)&&(h[c]=o)):f&&(c.value=o,t.k&&(u[t.k]=o))};o?(g.id=-1,Rt(g,n)):g()}}}const Rt=i0;function N0(t){return x0(t)}function x0(t,e){const n=Au();n.__VUE__=!0;const{insert:i,remove:s,patchProp:r,createElement:o,createText:a,createComment:c,setText:l,setElementText:u,parentNode:h,nextSibling:d,setScopeId:f=Zt,insertStaticContent:g}=t,v=(p,m,_,E=null,w=null,A=null,M=!1,N=null,x=!!m.dynamicChildren)=>{if(p===m)return;p&&!vr(p,m)&&(E=T(p),bt(p,w,A,!0),p=null),m.patchFlag===-2&&(x=!1,m.dynamicChildren=null);const{type:S,ref:B,shapeFlag:F}=m;switch(S){case Gc:y(p,m,_,E);break;case yi:I(p,m,_,E);break;case Bl:p==null&&P(m,_,E,M);break;case tt:Pt(p,m,_,E,w,A,M,N,x);break;default:F&1?K(p,m,_,E,w,A,M,N,x):F&6?qt(p,m,_,E,w,A,M,N,x):(F&64||F&128)&&S.process(p,m,_,E,w,A,M,N,x,O)}B!=null&&w&&Lu(B,p&&p.ref,A,m||p,!m)},y=(p,m,_,E)=>{if(p==null)i(m.el=a(m.children),_,E);else{const w=m.el=p.el;m.children!==p.children&&l(w,m.children)}},I=(p,m,_,E)=>{p==null?i(m.el=c(m.children||""),_,E):m.el=p.el},P=(p,m,_,E)=>{[p.el,p.anchor]=g(p.children,m,_,E,p.el,p.anchor)},k=({el:p,anchor:m},_,E)=>{let w;for(;p&&p!==m;)w=d(p),i(p,_,E),p=w;i(m,_,E)},R=({el:p,anchor:m})=>{let _;for(;p&&p!==m;)_=d(p),s(p),p=_;s(m)},K=(p,m,_,E,w,A,M,N,x)=>{M=M||m.type==="svg",p==null?ie(m,_,E,w,A,M,N,x):ne(p,m,w,A,M,N,x)},ie=(p,m,_,E,w,A,M,N)=>{let x,S;const{type:B,props:F,shapeFlag:$,transition:ee,dirs:se}=p;if(x=p.el=o(p.type,A,F&&F.is,F),$&8?u(x,p.children):$&16&&G(p.children,x,null,E,w,A&&B!=="foreignObject",M,N),se&&Si(p,null,E,"created"),he(x,p,p.scopeId,M,E),F){for(const we in F)we!=="value"&&!ka(we)&&r(x,we,null,F[we],A,p.children,E,w,lt);"value"in F&&r(x,"value",null,F.value),(S=F.onVnodeBeforeMount)&&ln(S,E,p)}se&&Si(p,null,E,"beforeMount");const Ce=O0(w,ee);Ce&&ee.beforeEnter(x),i(x,m,_),((S=F&&F.onVnodeMounted)||Ce||se)&&Rt(()=>{S&&ln(S,E,p),Ce&&ee.enter(x),se&&Si(p,null,E,"mounted")},w)},he=(p,m,_,E,w)=>{if(_&&f(p,_),E)for(let A=0;A<E.length;A++)f(p,E[A]);if(w){let A=w.subTree;if(m===A){const M=w.vnode;he(p,M,M.scopeId,M.slotScopeIds,w.parent)}}},G=(p,m,_,E,w,A,M,N,x=0)=>{for(let S=x;S<p.length;S++){const B=p[S]=N?ii(p[S]):un(p[S]);v(null,B,m,_,E,w,A,M,N)}},ne=(p,m,_,E,w,A,M)=>{const N=m.el=p.el;let{patchFlag:x,dynamicChildren:S,dirs:B}=m;x|=p.patchFlag&16;const F=p.props||Pe,$=m.props||Pe;let ee;_&&Pi(_,!1),(ee=$.onVnodeBeforeUpdate)&&ln(ee,_,m,p),B&&Si(m,p,_,"beforeUpdate"),_&&Pi(_,!0);const se=w&&m.type!=="foreignObject";if(S?Ie(p.dynamicChildren,S,N,_,E,se,A):M||ge(p,m,N,null,_,E,se,A,!1),x>0){if(x&16)ct(N,m,F,$,_,E,w);else if(x&2&&F.class!==$.class&&r(N,"class",null,$.class,w),x&4&&r(N,"style",F.style,$.style,w),x&8){const Ce=m.dynamicProps;for(let we=0;we<Ce.length;we++){const Ue=Ce[we],Ht=F[Ue],hs=$[Ue];(hs!==Ht||Ue==="value")&&r(N,Ue,Ht,hs,w,p.children,_,E,lt)}}x&1&&p.children!==m.children&&u(N,m.children)}else!M&&S==null&&ct(N,m,F,$,_,E,w);((ee=$.onVnodeUpdated)||B)&&Rt(()=>{ee&&ln(ee,_,m,p),B&&Si(m,p,_,"updated")},E)},Ie=(p,m,_,E,w,A,M)=>{for(let N=0;N<m.length;N++){const x=p[N],S=m[N],B=x.el&&(x.type===tt||!vr(x,S)||x.shapeFlag&70)?h(x.el):_;v(x,S,B,null,E,w,A,M,!0)}},ct=(p,m,_,E,w,A,M)=>{if(_!==E){if(_!==Pe)for(const N in _)!ka(N)&&!(N in E)&&r(p,N,_[N],null,M,m.children,w,A,lt);for(const N in E){if(ka(N))continue;const x=E[N],S=_[N];x!==S&&N!=="value"&&r(p,N,S,x,M,m.children,w,A,lt)}"value"in E&&r(p,"value",_.value,E.value)}},Pt=(p,m,_,E,w,A,M,N,x)=>{const S=m.el=p?p.el:a(""),B=m.anchor=p?p.anchor:a("");let{patchFlag:F,dynamicChildren:$,slotScopeIds:ee}=m;ee&&(N=N?N.concat(ee):ee),p==null?(i(S,_,E),i(B,_,E),G(m.children,_,B,w,A,M,N,x)):F>0&&F&64&&$&&p.dynamicChildren?(Ie(p.dynamicChildren,$,_,w,A,M,N),(m.key!=null||w&&m===w.subTree)&&J_(p,m,!0)):ge(p,m,_,B,w,A,M,N,x)},qt=(p,m,_,E,w,A,M,N,x)=>{m.slotScopeIds=N,p==null?m.shapeFlag&512?w.ctx.activate(m,_,E,M,x):Ci(m,_,E,w,A,M,x):Vt(p,m,x)},Ci=(p,m,_,E,w,A,M)=>{const N=p.component=j0(p,E,w);if(U_(p)&&(N.ctx.renderer=O),B0(N),N.asyncDep){if(w&&w.registerDep(N,pe),!p.el){const x=N.subTree=Fe(yi);I(null,x,m,_)}return}pe(N,p,m,_,w,A,M)},Vt=(p,m,_)=>{const E=m.component=p.component;if(Jw(p,m,_))if(E.asyncDep&&!E.asyncResolved){Re(E,m,_);return}else E.next=m,Hw(E.update),E.update();else m.el=p.el,E.vnode=m},pe=(p,m,_,E,w,A,M)=>{const N=()=>{if(p.isMounted){let{next:B,bu:F,u:$,parent:ee,vnode:se}=p,Ce=B,we;Pi(p,!1),B?(B.el=se.el,Re(p,B,M)):B=se,F&&Na(F),(we=B.props&&B.props.onVnodeBeforeUpdate)&&ln(we,ee,B,se),Pi(p,!0);const Ue=zl(p),Ht=p.subTree;p.subTree=Ue,v(Ht,Ue,h(Ht.el),T(Ht),p,w,A),B.el=Ue.el,Ce===null&&Zw(p,Ue.el),$&&Rt($,w),(we=B.props&&B.props.onVnodeUpdated)&&Rt(()=>ln(we,ee,B,se),w)}else{let B;const{el:F,props:$}=m,{bm:ee,m:se,parent:Ce}=p,we=qr(m);if(Pi(p,!1),ee&&Na(ee),!we&&(B=$&&$.onVnodeBeforeMount)&&ln(B,Ce,m),Pi(p,!0),F&&_e){const Ue=()=>{p.subTree=zl(p),_e(F,p.subTree,p,w,null)};we?m.type.__asyncLoader().then(()=>!p.isUnmounted&&Ue()):Ue()}else{const Ue=p.subTree=zl(p);v(null,Ue,_,E,p,w,A),m.el=Ue.el}if(se&&Rt(se,w),!we&&(B=$&&$.onVnodeMounted)){const Ue=m;Rt(()=>ln(B,Ce,Ue),w)}(m.shapeFlag&256||Ce&&qr(Ce.vnode)&&Ce.vnode.shapeFlag&256)&&p.a&&Rt(p.a,w),p.isMounted=!0,m=_=E=null}},x=p.effect=new Hh(N,()=>Zh(S),p.scope),S=p.update=()=>x.run();S.id=p.uid,Pi(p,!0),S()},Re=(p,m,_)=>{m.component=p;const E=p.vnode.props;p.vnode=m,p.next=null,C0(p,m.props,E,_),k0(p,m.children,_),nr(),sp(),ir()},ge=(p,m,_,E,w,A,M,N,x=!1)=>{const S=p&&p.children,B=p?p.shapeFlag:0,F=m.children,{patchFlag:$,shapeFlag:ee}=m;if($>0){if($&128){Jn(S,F,_,E,w,A,M,N,x);return}else if($&256){On(S,F,_,E,w,A,M,N,x);return}}ee&8?(B&16&&lt(S,w,A),F!==S&&u(_,F)):B&16?ee&16?Jn(S,F,_,E,w,A,M,N,x):lt(S,w,A,!0):(B&8&&u(_,""),ee&16&&G(F,_,E,w,A,M,N,x))},On=(p,m,_,E,w,A,M,N,x)=>{p=p||ws,m=m||ws;const S=p.length,B=m.length,F=Math.min(S,B);let $;for($=0;$<F;$++){const ee=m[$]=x?ii(m[$]):un(m[$]);v(p[$],ee,_,null,w,A,M,N,x)}S>B?lt(p,w,A,!0,!1,F):G(m,_,E,w,A,M,N,x,F)},Jn=(p,m,_,E,w,A,M,N,x)=>{let S=0;const B=m.length;let F=p.length-1,$=B-1;for(;S<=F&&S<=$;){const ee=p[S],se=m[S]=x?ii(m[S]):un(m[S]);if(vr(ee,se))v(ee,se,_,null,w,A,M,N,x);else break;S++}for(;S<=F&&S<=$;){const ee=p[F],se=m[$]=x?ii(m[$]):un(m[$]);if(vr(ee,se))v(ee,se,_,null,w,A,M,N,x);else break;F--,$--}if(S>F){if(S<=$){const ee=$+1,se=ee<B?m[ee].el:E;for(;S<=$;)v(null,m[S]=x?ii(m[S]):un(m[S]),_,se,w,A,M,N,x),S++}}else if(S>$)for(;S<=F;)bt(p[S],w,A,!0),S++;else{const ee=S,se=S,Ce=new Map;for(S=se;S<=$;S++){const kt=m[S]=x?ii(m[S]):un(m[S]);kt.key!=null&&Ce.set(kt.key,S)}let we,Ue=0;const Ht=$-se+1;let hs=!1,Hf=0;const _r=new Array(Ht);for(S=0;S<Ht;S++)_r[S]=0;for(S=ee;S<=F;S++){const kt=p[S];if(Ue>=Ht){bt(kt,w,A,!0);continue}let cn;if(kt.key!=null)cn=Ce.get(kt.key);else for(we=se;we<=$;we++)if(_r[we-se]===0&&vr(kt,m[we])){cn=we;break}cn===void 0?bt(kt,w,A,!0):(_r[cn-se]=S+1,cn>=Hf?Hf=cn:hs=!0,v(kt,m[cn],_,null,w,A,M,N,x),Ue++)}const Kf=hs?D0(_r):ws;for(we=Kf.length-1,S=Ht-1;S>=0;S--){const kt=se+S,cn=m[kt],Gf=kt+1<B?m[kt+1].el:E;_r[S]===0?v(null,cn,_,Gf,w,A,M,N,x):hs&&(we<0||S!==Kf[we]?an(cn,_,Gf,2):we--)}}},an=(p,m,_,E,w=null)=>{const{el:A,type:M,transition:N,children:x,shapeFlag:S}=p;if(S&6){an(p.component.subTree,m,_,E);return}if(S&128){p.suspense.move(m,_,E);return}if(S&64){M.move(p,m,_,O);return}if(M===tt){i(A,m,_);for(let F=0;F<x.length;F++)an(x[F],m,_,E);i(p.anchor,m,_);return}if(M===Bl){k(p,m,_);return}if(E!==2&&S&1&&N)if(E===0)N.beforeEnter(A),i(A,m,_),Rt(()=>N.enter(A),w);else{const{leave:F,delayLeave:$,afterLeave:ee}=N,se=()=>i(A,m,_),Ce=()=>{F(A,()=>{se(),ee&&ee()})};$?$(A,se,Ce):Ce()}else i(A,m,_)},bt=(p,m,_,E=!1,w=!1)=>{const{type:A,props:M,ref:N,children:x,dynamicChildren:S,shapeFlag:B,patchFlag:F,dirs:$}=p;if(N!=null&&Lu(N,null,_,p,!0),B&256){m.ctx.deactivate(p);return}const ee=B&1&&$,se=!qr(p);let Ce;if(se&&(Ce=M&&M.onVnodeBeforeUnmount)&&ln(Ce,m,p),B&6)oa(p.component,_,E);else{if(B&128){p.suspense.unmount(_,E);return}ee&&Si(p,null,m,"beforeUnmount"),B&64?p.type.remove(p,m,_,w,O,E):S&&(A!==tt||F>0&&F&64)?lt(S,m,_,!1,!0):(A===tt&&F&384||!w&&B&16)&&lt(x,m,_),E&&ls(p)}(se&&(Ce=M&&M.onVnodeUnmounted)||ee)&&Rt(()=>{Ce&&ln(Ce,m,p),ee&&Si(p,null,m,"unmounted")},_)},ls=p=>{const{type:m,el:_,anchor:E,transition:w}=p;if(m===tt){us(_,E);return}if(m===Bl){R(p);return}const A=()=>{s(_),w&&!w.persisted&&w.afterLeave&&w.afterLeave()};if(p.shapeFlag&1&&w&&!w.persisted){const{leave:M,delayLeave:N}=w,x=()=>M(_,A);N?N(p.el,A,x):x()}else A()},us=(p,m)=>{let _;for(;p!==m;)_=d(p),s(p),p=_;s(m)},oa=(p,m,_)=>{const{bum:E,scope:w,update:A,subTree:M,um:N}=p;E&&Na(E),w.stop(),A&&(A.active=!1,bt(M,p,m,_)),N&&Rt(N,m),Rt(()=>{p.isUnmounted=!0},m),m&&m.pendingBranch&&!m.isUnmounted&&p.asyncDep&&!p.asyncResolved&&p.suspenseId===m.pendingId&&(m.deps--,m.deps===0&&m.resolve())},lt=(p,m,_,E=!1,w=!1,A=0)=>{for(let M=A;M<p.length;M++)bt(p[M],m,_,E,w)},T=p=>p.shapeFlag&6?T(p.component.subTree):p.shapeFlag&128?p.suspense.next():d(p.anchor||p.el),q=(p,m,_)=>{p==null?m._vnode&&bt(m._vnode,null,null,!0):v(m._vnode||null,p,m,null,null,null,_),sp(),N_(),m._vnode=p},O={p:v,um:bt,m:an,r:ls,mt:Ci,mc:G,pc:ge,pbc:Ie,n:T,o:t};let U,_e;return e&&([U,_e]=e(O)),{render:q,hydrate:U,createApp:b0(q,U)}}function Pi({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function O0(t,e){return(!t||t&&!t.pendingBranch)&&e&&!e.persisted}function J_(t,e,n=!1){const i=t.children,s=e.children;if(W(i)&&W(s))for(let r=0;r<i.length;r++){const o=i[r];let a=s[r];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=s[r]=ii(s[r]),a.el=o.el),n||J_(o,a)),a.type===Gc&&(a.el=o.el)}}function D0(t){const e=t.slice(),n=[0];let i,s,r,o,a;const c=t.length;for(i=0;i<c;i++){const l=t[i];if(l!==0){if(s=n[n.length-1],t[s]<l){e[i]=s,n.push(i);continue}for(r=0,o=n.length-1;r<o;)a=r+o>>1,t[n[a]]<l?r=a+1:o=a;l<t[n[r]]&&(r>0&&(e[i]=n[r-1]),n[r]=i)}}for(r=n.length,o=n[r-1];r-- >0;)n[r]=o,o=e[o];return n}const L0=t=>t.__isTeleport,tt=Symbol.for("v-fgt"),Gc=Symbol.for("v-txt"),yi=Symbol.for("v-cmt"),Bl=Symbol.for("v-stc"),Fr=[];let Qt=null;function ve(t=!1){Fr.push(Qt=t?null:[])}function M0(){Fr.pop(),Qt=Fr[Fr.length-1]||null}let so=1;function mp(t){so+=t}function Z_(t){return t.dynamicChildren=so>0?Qt||ws:null,M0(),so>0&&Qt&&Qt.push(t),t}function ke(t,e,n,i,s,r){return Z_(j(t,e,n,i,s,r,!0))}function Do(t,e,n,i,s){return Z_(Fe(t,e,n,i,s,!0))}function Ja(t){return t?t.__v_isVNode===!0:!1}function vr(t,e){return t.type===e.type&&t.key===e.key}const Qc="__vInternal",ev=({key:t})=>t??null,Da=({ref:t,ref_key:e,ref_for:n})=>(typeof t=="number"&&(t=""+t),t!=null?He(t)||Me(t)||Z(t)?{i:Ye,r:t,k:e,f:!!n}:t:null);function j(t,e=null,n=null,i=0,s=null,r=t===tt?0:1,o=!1,a=!1){const c={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&ev(e),ref:e&&Da(e),scopeId:D_,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:i,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:Ye};return a?(nd(c,n),r&128&&t.normalize(c)):n&&(c.shapeFlag|=He(n)?8:16),so>0&&!o&&Qt&&(c.patchFlag>0||r&6)&&c.patchFlag!==32&&Qt.push(c),c}const Fe=q0;function q0(t,e=null,n=null,i=0,s=null,r=!1){if((!t||t===e0)&&(t=yi),Ja(t)){const a=qs(t,e,!0);return n&&nd(a,n),so>0&&!r&&Qt&&(a.shapeFlag&6?Qt[Qt.indexOf(t)]=a:Qt.push(a)),a.patchFlag|=-2,a}if(G0(t)&&(t=t.__vccOpts),e){e=V0(e);let{class:a,style:c}=e;a&&!He(a)&&(e.class=No(a)),Ae(c)&&(I_(c)&&!W(c)&&(c=at({},c)),e.style=Zr(c))}const o=He(t)?1:n0(t)?128:L0(t)?64:Ae(t)?4:Z(t)?2:0;return j(t,e,n,i,s,o,r,!0)}function V0(t){return t?I_(t)||Qc in t?at({},t):t:null}function qs(t,e,n=!1){const{props:i,ref:s,patchFlag:r,children:o}=t,a=e?F0(i||{},e):i;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:a,key:a&&ev(a),ref:e&&e.ref?n&&s?W(s)?s.concat(Da(e)):[s,Da(e)]:Da(e):s,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==tt?r===-1?16:r|16:r,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&qs(t.ssContent),ssFallback:t.ssFallback&&qs(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce}}function ji(t=" ",e=0){return Fe(Gc,null,t,e)}function dn(t="",e=!1){return e?(ve(),Do(yi,null,t)):Fe(yi,null,t)}function un(t){return t==null||typeof t=="boolean"?Fe(yi):W(t)?Fe(tt,null,t.slice()):typeof t=="object"?ii(t):Fe(Gc,null,String(t))}function ii(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:qs(t)}function nd(t,e){let n=0;const{shapeFlag:i}=t;if(e==null)e=null;else if(W(e))n=16;else if(typeof e=="object")if(i&65){const s=e.default;s&&(s._c&&(s._d=!1),nd(t,s()),s._c&&(s._d=!0));return}else{n=32;const s=e._;!s&&!(Qc in e)?e._ctx=Ye:s===3&&Ye&&(Ye.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else Z(e)?(e={default:e,_ctx:Ye},n=32):(e=String(e),i&64?(n=16,e=[ji(e)]):n=8);t.children=e,t.shapeFlag|=n}function F0(...t){const e={};for(let n=0;n<t.length;n++){const i=t[n];for(const s in i)if(s==="class")e.class!==i.class&&(e.class=No([e.class,i.class]));else if(s==="style")e.style=Zr([e.style,i.style]);else if(Fc(s)){const r=e[s],o=i[s];o&&r!==o&&!(W(r)&&r.includes(o))&&(e[s]=r?[].concat(r,o):o)}else s!==""&&(e[s]=i[s])}return e}function ln(t,e,n,i=null){en(t,e,7,[n,i])}const U0=H_();let z0=0;function j0(t,e,n){const i=t.type,s=(e?e.appContext:t.appContext)||U0,r={uid:z0++,vnode:t,type:i,parent:e,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,scope:new c_(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(s.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:G_(i,s),emitsOptions:O_(i,s),emit:null,emitted:null,propsDefaults:Pe,inheritAttrs:i.inheritAttrs,ctx:Pe,data:Pe,props:Pe,attrs:Pe,slots:Pe,refs:Pe,setupState:Pe,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=e?e.root:r,r.emit=Qw.bind(null,r),t.ce&&t.ce(r),r}let $e=null;const tv=()=>$e||Ye;let id,ds,gp="__VUE_INSTANCE_SETTERS__";(ds=Au()[gp])||(ds=Au()[gp]=[]),ds.push(t=>$e=t),id=t=>{ds.length>1?ds.forEach(e=>e(t)):ds[0](t)};const Vs=t=>{id(t),t.scope.on()},Bi=()=>{$e&&$e.scope.off(),id(null)};function nv(t){return t.vnode.shapeFlag&4}let ro=!1;function B0(t,e=!1){ro=e;const{props:n,children:i}=t.vnode,s=nv(t);A0(t,n,s,e),P0(t,i);const r=s?$0(t,e):void 0;return ro=!1,r}function $0(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=$c(new Proxy(t.ctx,_0));const{setup:i}=n;if(i){const s=t.setupContext=i.length>1?H0(t):null;Vs(t),nr();const r=di(i,t,0,[t.props,s]);if(ir(),Bi(),n_(r)){if(r.then(Bi,Bi),e)return r.then(o=>{_p(t,o,e)}).catch(o=>{Wc(o,t,0)});t.asyncDep=r}else _p(t,r,e)}else iv(t,e)}function _p(t,e,n){Z(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:Ae(e)&&(t.setupState=C_(e)),iv(t,n)}let vp;function iv(t,e,n){const i=t.type;if(!t.render){if(!e&&vp&&!i.render){const s=i.template||ed(t).template;if(s){const{isCustomElement:r,compilerOptions:o}=t.appContext.config,{delimiters:a,compilerOptions:c}=i,l=at(at({isCustomElement:r,delimiters:a},o),c);i.render=vp(s,l)}}t.render=i.render||Zt}{Vs(t),nr();try{v0(t)}finally{ir(),Bi()}}}function W0(t){return t.attrsProxy||(t.attrsProxy=new Proxy(t.attrs,{get(e,n){return St(t,"get","$attrs"),e[n]}}))}function H0(t){const e=n=>{t.exposed=n||{}};return{get attrs(){return W0(t)},slots:t.slots,emit:t.emit,expose:e}}function Yc(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(C_($c(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in Vr)return Vr[n](t)},has(e,n){return n in e||n in Vr}}))}function K0(t,e=!0){return Z(t)?t.displayName||t.name:t.name||e&&t.__name}function G0(t){return Z(t)&&"__vccOpts"in t}const Ut=(t,e)=>Bw(t,e,ro);function sv(t,e,n){const i=arguments.length;return i===2?Ae(e)&&!W(e)?Ja(e)?Fe(t,null,[e]):Fe(t,e):Fe(t,null,e):(i>3?n=Array.prototype.slice.call(arguments,2):i===3&&Ja(n)&&(n=[n]),Fe(t,e,n))}const Q0=Symbol.for("v-scx"),Y0=()=>$t(Q0),X0="3.3.8",J0="http://www.w3.org/2000/svg",Oi=typeof document<"u"?document:null,yp=Oi&&Oi.createElement("template"),Z0={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,i)=>{const s=e?Oi.createElementNS(J0,t):Oi.createElement(t,n?{is:n}:void 0);return t==="select"&&i&&i.multiple!=null&&s.setAttribute("multiple",i.multiple),s},createText:t=>Oi.createTextNode(t),createComment:t=>Oi.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>Oi.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,n,i,s,r){const o=n?n.previousSibling:e.lastChild;if(s&&(s===r||s.nextSibling))for(;e.insertBefore(s.cloneNode(!0),n),!(s===r||!(s=s.nextSibling)););else{yp.innerHTML=i?`<svg>${t}</svg>`:t;const a=yp.content;if(i){const c=a.firstChild;for(;c.firstChild;)a.appendChild(c.firstChild);a.removeChild(c)}e.insertBefore(a,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}},eb=Symbol("_vtc");function tb(t,e,n){const i=t[eb];i&&(e=(e?[e,...i]:[...i]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}const nb=Symbol("_vod");function ib(t,e,n){const i=t.style,s=He(n);if(n&&!s){if(e&&!He(e))for(const r in e)n[r]==null&&Mu(i,r,"");for(const r in n)Mu(i,r,n[r])}else{const r=i.display;s?e!==n&&(i.cssText=n):e&&t.removeAttribute("style"),nb in t&&(i.display=r)}}const Ep=/\s*!important$/;function Mu(t,e,n){if(W(n))n.forEach(i=>Mu(t,e,i));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const i=sb(t,e);Ep.test(n)?t.setProperty(tr(i),n.replace(Ep,""),"important"):t[i]=n}}const Tp=["Webkit","Moz","ms"],$l={};function sb(t,e){const n=$l[e];if(n)return n;let i=bn(e);if(i!=="filter"&&i in t)return $l[e]=i;i=zc(i);for(let s=0;s<Tp.length;s++){const r=Tp[s]+i;if(r in t)return $l[e]=r}return e}const Ip="http://www.w3.org/1999/xlink";function rb(t,e,n,i,s){if(i&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(Ip,e.slice(6,e.length)):t.setAttributeNS(Ip,e,n);else{const r=dw(e);n==null||r&&!o_(n)?t.removeAttribute(e):t.setAttribute(e,r?"":n)}}function ob(t,e,n,i,s,r,o){if(e==="innerHTML"||e==="textContent"){i&&o(i,s,r),t[e]=n??"";return}const a=t.tagName;if(e==="value"&&a!=="PROGRESS"&&!a.includes("-")){t._value=n;const l=a==="OPTION"?t.getAttribute("value"):t.value,u=n??"";l!==u&&(t.value=u),n==null&&t.removeAttribute(e);return}let c=!1;if(n===""||n==null){const l=typeof t[e];l==="boolean"?n=o_(n):n==null&&l==="string"?(n="",c=!0):l==="number"&&(n=0,c=!0)}try{t[e]=n}catch{}c&&t.removeAttribute(e)}function sd(t,e,n,i){t.addEventListener(e,n,i)}function ab(t,e,n,i){t.removeEventListener(e,n,i)}const wp=Symbol("_vei");function cb(t,e,n,i,s=null){const r=t[wp]||(t[wp]={}),o=r[e];if(i&&o)o.value=i;else{const[a,c]=lb(e);if(i){const l=r[e]=db(i,s);sd(t,a,l,c)}else o&&(ab(t,a,o,c),r[e]=void 0)}}const bp=/(?:Once|Passive|Capture)$/;function lb(t){let e;if(bp.test(t)){e={};let i;for(;i=t.match(bp);)t=t.slice(0,t.length-i[0].length),e[i[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):tr(t.slice(2)),e]}let Wl=0;const ub=Promise.resolve(),hb=()=>Wl||(ub.then(()=>Wl=0),Wl=Date.now());function db(t,e){const n=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=n.attached)return;en(fb(i,n.value),e,5,[i])};return n.value=t,n.attached=hb(),n}function fb(t,e){if(W(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(i=>s=>!s._stopped&&i&&i(s))}else return e}const Rp=/^on[a-z]/,pb=(t,e,n,i,s=!1,r,o,a,c)=>{e==="class"?tb(t,i,s):e==="style"?ib(t,n,i):Fc(e)?Uh(e)||cb(t,e,n,i,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):mb(t,e,i,s))?ob(t,e,i,r,o,a,c):(e==="true-value"?t._trueValue=i:e==="false-value"&&(t._falseValue=i),rb(t,e,i,s))};function mb(t,e,n,i){return i?!!(e==="innerHTML"||e==="textContent"||e in t&&Rp.test(e)&&Z(n)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA"||Rp.test(e)&&He(n)?!1:e in t}const Za=t=>{const e=t.props["onUpdate:modelValue"]||!1;return W(e)?n=>Na(e,n):e},Cs=Symbol("_assign"),gb={deep:!0,created(t,e,n){t[Cs]=Za(n),sd(t,"change",()=>{const i=t._modelValue,s=oo(t),r=t.checked,o=t[Cs];if(W(i)){const a=Bh(i,s),c=a!==-1;if(r&&!c)o(i.concat(s));else if(!r&&c){const l=[...i];l.splice(a,1),o(l)}}else if(er(i)){const a=new Set(i);r?a.add(s):a.delete(s),o(a)}else o(rv(t,r))})},mounted:Ap,beforeUpdate(t,e,n){t[Cs]=Za(n),Ap(t,e,n)}};function Ap(t,{value:e,oldValue:n},i){t._modelValue=e,W(e)?t.checked=Bh(e,i.props.value)>-1:er(e)?t.checked=e.has(i.props.value):e!==n&&(t.checked=xo(e,rv(t,!0)))}const _b={deep:!0,created(t,{value:e,modifiers:{number:n}},i){const s=er(e);sd(t,"change",()=>{const r=Array.prototype.filter.call(t.options,o=>o.selected).map(o=>n?r_(oo(o)):oo(o));t[Cs](t.multiple?s?new Set(r):r:r[0])}),t[Cs]=Za(i)},mounted(t,{value:e}){Cp(t,e)},beforeUpdate(t,e,n){t[Cs]=Za(n)},updated(t,{value:e}){Cp(t,e)}};function Cp(t,e){const n=t.multiple;if(!(n&&!W(e)&&!er(e))){for(let i=0,s=t.options.length;i<s;i++){const r=t.options[i],o=oo(r);if(n)W(e)?r.selected=Bh(e,o)>-1:r.selected=e.has(o);else if(xo(oo(r),e)){t.selectedIndex!==i&&(t.selectedIndex=i);return}}!n&&t.selectedIndex!==-1&&(t.selectedIndex=-1)}}function oo(t){return"_value"in t?t._value:t.value}function rv(t,e){const n=e?"_trueValue":"_falseValue";return n in t?t[n]:e}const vb=at({patchProp:pb},Z0);let Sp;function yb(){return Sp||(Sp=N0(vb))}const Eb=(...t)=>{const e=yb().createApp(...t),{mount:n}=e;return e.mount=i=>{const s=Tb(i);if(!s)return;const r=e._component;!Z(r)&&!r.render&&!r.template&&(r.template=s.innerHTML),s.innerHTML="";const o=n(s,!1,s instanceof SVGElement);return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),o},e};function Tb(t){return He(t)?document.querySelector(t):t}var Ib=!1;/*!
 * pinia v2.1.7
 * (c) 2023 Eduardo San Martin Morote
 * @license MIT
 */let ov;const Xc=t=>ov=t,av=Symbol();function qu(t){return t&&typeof t=="object"&&Object.prototype.toString.call(t)==="[object Object]"&&typeof t.toJSON!="function"}var Ur;(function(t){t.direct="direct",t.patchObject="patch object",t.patchFunction="patch function"})(Ur||(Ur={}));function wb(){const t=jc(!0),e=t.run(()=>hi({}));let n=[],i=[];const s=$c({install(r){Xc(s),s._a=r,r.provide(av,s),r.config.globalProperties.$pinia=s,i.forEach(o=>n.push(o)),i=[]},use(r){return!this._a&&!Ib?i.push(r):n.push(r),this},_p:n,_a:null,_e:t,_s:new Map,state:e});return s}const cv=()=>{};function Pp(t,e,n,i=cv){t.push(e);const s=()=>{const r=t.indexOf(e);r>-1&&(t.splice(r,1),i())};return!n&&$h()&&l_(s),s}function fs(t,...e){t.slice().forEach(n=>{n(...e)})}const bb=t=>t();function Vu(t,e){t instanceof Map&&e instanceof Map&&e.forEach((n,i)=>t.set(i,n)),t instanceof Set&&e instanceof Set&&e.forEach(t.add,t);for(const n in e){if(!e.hasOwnProperty(n))continue;const i=e[n],s=t[n];qu(s)&&qu(i)&&t.hasOwnProperty(n)&&!Me(i)&&!ui(i)?t[n]=Vu(s,i):t[n]=i}return t}const Rb=Symbol();function Ab(t){return!qu(t)||!t.hasOwnProperty(Rb)}const{assign:ni}=Object;function Cb(t){return!!(Me(t)&&t.effect)}function Sb(t,e,n,i){const{state:s,actions:r,getters:o}=e,a=n.state.value[t];let c;function l(){a||(n.state.value[t]=s?s():{});const u=Vw(n.state.value[t]);return ni(u,r,Object.keys(o||{}).reduce((h,d)=>(h[d]=$c(Ut(()=>{Xc(n);const f=n._s.get(t);return o[d].call(f,f)})),h),{}))}return c=lv(t,l,e,n,i,!0),c}function lv(t,e,n={},i,s,r){let o;const a=ni({actions:{}},n),c={deep:!0};let l,u,h=[],d=[],f;const g=i.state.value[t];!r&&!g&&(i.state.value[t]={}),hi({});let v;function y(G){let ne;l=u=!1,typeof G=="function"?(G(i.state.value[t]),ne={type:Ur.patchFunction,storeId:t,events:f}):(Vu(i.state.value[t],G),ne={type:Ur.patchObject,payload:G,storeId:t,events:f});const Ie=v=Symbol();Jh().then(()=>{v===Ie&&(l=!0)}),u=!0,fs(h,ne,i.state.value[t])}const I=r?function(){const{state:ne}=n,Ie=ne?ne():{};this.$patch(ct=>{ni(ct,Ie)})}:cv;function P(){o.stop(),h=[],d=[],i._s.delete(t)}function k(G,ne){return function(){Xc(i);const Ie=Array.from(arguments),ct=[],Pt=[];function qt(pe){ct.push(pe)}function Ci(pe){Pt.push(pe)}fs(d,{args:Ie,name:G,store:K,after:qt,onError:Ci});let Vt;try{Vt=ne.apply(this&&this.$id===t?this:K,Ie)}catch(pe){throw fs(Pt,pe),pe}return Vt instanceof Promise?Vt.then(pe=>(fs(ct,pe),pe)).catch(pe=>(fs(Pt,pe),Promise.reject(pe))):(fs(ct,Vt),Vt)}}const R={_p:i,$id:t,$onAction:Pp.bind(null,d),$patch:y,$reset:I,$subscribe(G,ne={}){const Ie=Pp(h,G,ne.detached,()=>ct()),ct=o.run(()=>As(()=>i.state.value[t],Pt=>{(ne.flush==="sync"?u:l)&&G({storeId:t,type:Ur.direct,events:f},Pt)},ni({},c,ne)));return Ie},$dispose:P},K=Oo(R);i._s.set(t,K);const he=(i._a&&i._a.runWithContext||bb)(()=>i._e.run(()=>(o=jc()).run(e)));for(const G in he){const ne=he[G];if(Me(ne)&&!Cb(ne)||ui(ne))r||(g&&Ab(ne)&&(Me(ne)?ne.value=g[G]:Vu(ne,g[G])),i.state.value[t][G]=ne);else if(typeof ne=="function"){const Ie=k(G,ne);he[G]=Ie,a.actions[G]=ne}}return ni(K,he),ni(fe(K),he),Object.defineProperty(K,"$state",{get:()=>i.state.value[t],set:G=>{y(ne=>{ni(ne,G)})}}),i._p.forEach(G=>{ni(K,o.run(()=>G({store:K,app:i._a,pinia:i,options:a})))}),g&&r&&n.hydrate&&n.hydrate(K.$state,g),l=!0,u=!0,K}function uv(t,e,n){let i,s;const r=typeof e=="function";typeof t=="string"?(i=t,s=r?n:e):(s=t,i=t.id);function o(a,c){const l=R0();return a=a||(l?$t(av,null):null),a&&Xc(a),a=ov,a._s.has(i)||(r?lv(i,e,s,a):Sb(i,s,a)),a._s.get(i)}return o.$id=i,o}const kn=(t,e)=>{const n=t.__vccOpts||t;for(const[i,s]of e)n[i]=s;return n},Pb={};function kb(t,e){const n=fi("router-view");return ve(),Do(n)}const Nb=kn(Pb,[["render",kb]]);/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const D=function(t,e){if(!t)throw sr(e)},sr=function(t){return new Error("Firebase Database ("+hv.SDK_VERSION+") INTERNAL ASSERT FAILED: "+t)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wb="FirebaseError";class Nn extends Error{constructor(e,n,i){super(n),this.code=e,this.customData=i,this.name=Wb,Object.setPrototypeOf(this,Nn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,rr.prototype.create)}}class rr{constructor(e,n,i){this.service=e,this.serviceName=n,this.errors=i}create(e,...n){const i=n[0]||{},s=`${this.service}/${e}`,r=this.errors[e],o=r?Hb(r,i):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new Nn(s,a,i)}}function Hb(t,e){return t.replace(Kb,(n,i)=>{const s=e[i];return s!=null?String(s):`<${i}?>`})}const Kb=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tv=function(t){let e={},n={},i={},s="";try{const r=t.split(".");e=co(tc(r[0])||""),n=co(tc(r[1])||""),s=r[2],i=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:i,signature:s}},Gb=function(t){const e=Tv(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},Qb=function(t){const e=Tv(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tR=function(t){const e=[];let n=0;for(let i=0;i<t.length;i++){let s=t.charCodeAt(i);if(s>=55296&&s<=56319){const r=s-55296;i++,D(i<t.length,"Surrogate pair missing trail surrogate.");const o=t.charCodeAt(i)-56320;s=65536+(r<<10)+o}s<128?e[n++]=s:s<2048?(e[n++]=s>>6|192,e[n++]=s&63|128):s<65536?(e[n++]=s>>12|224,e[n++]=s>>6&63|128,e[n++]=s&63|128):(e[n++]=s>>18|240,e[n++]=s>>12&63|128,e[n++]=s>>6&63|128,e[n++]=s&63|128)}return e},Zc=function(t){let e=0;for(let n=0;n<t.length;n++){const i=t.charCodeAt(n);i<128?e++:i<2048?e+=2:i>=55296&&i<=56319?(e+=4,n++):e+=3}return e};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const YR={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},mi=new rr("app","Firebase",YR);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bi=KR;function bv(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const i=Object.assign({name:Bu,automaticDataCollectionEnabled:!1},e),s=i.name;if(typeof s!="string"||!s)throw mi.create("bad-app-name",{appName:String(s)});if(n||(n=gv()),!n)throw mi.create("no-options");const r=sc.get(s);if(r){if(ic(n,r.options)&&ic(i,r.config))return r;throw mi.create("duplicate-app",{appName:s})}const o=new rR(s);for(const c of $u.values())o.addComponent(c);const a=new XR(n,i,o);return sc.set(s,a),a}function ld(t=Bu){const e=sc.get(t);if(!e&&t===Bu&&gv())return bv();if(!e)throw mi.create("no-app",{appName:t});return e}function Ot(t,e,n){var i;let s=(i=GR[t])!==null&&i!==void 0?i:t;n&&(s+=`-${n}`);const r=s.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${s}" with version "${e}":`];r&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Gi.warn(a.join(" "));return}Rn(new nn(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const JR="firebase-heartbeat-database",ZR=1,lo="firebase-heartbeat-store";let Yl=null;function Rv(){return Yl||(Yl=vR(JR,ZR,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(lo)}}}).catch(t=>{throw mi.create("idb-open",{originalErrorMessage:t.message})})),Yl}async function eA(t){try{return await(await Rv()).transaction(lo).objectStore(lo).get(Av(t))}catch(e){if(e instanceof Nn)Gi.warn(e.message);else{const n=mi.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Gi.warn(n.message)}}}async function Lp(t,e){try{const i=(await Rv()).transaction(lo,"readwrite");await i.objectStore(lo).put(e,Av(t)),await i.done}catch(n){if(n instanceof Nn)Gi.warn(n.message);else{const i=mi.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Gi.warn(i.message)}}}function Av(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rc=new Lo("@firebase/auth");function cA(t,...e){rc.logLevel<=re.WARN&&rc.warn(`Auth (${bi}): ${t}`,...e)}function La(t,...e){rc.logLevel<=re.ERROR&&rc.error(`Auth (${bi}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function An(t,...e){throw hd(t,...e)}function yn(t,...e){return hd(t,...e)}function Pv(t,e,n){const i=Object.assign(Object.assign({},aA()),{[e]:n});return new rr("auth","Firebase",i).create(e,{appName:t.name})}function lA(t,e,n){const i=n;if(!(e instanceof i))throw i.name!==e.constructor.name&&An(t,"argument-error"),Pv(t,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function hd(t,...e){if(typeof t!="string"){const n=e[0],i=[...e.slice(1)];return i[0]&&(i[0].appName=t.name),t._errorFactory.create(n,...i)}return Sv.create(t,...e)}function J(t,e,...n){if(!t)throw hd(e,...n)}function Vn(t){const e="INTERNAL ASSERTION FAILED: "+t;throw La(e),new Error(e)}function Hn(t,e){t||Vn(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mo{constructor(e,n){this.shortDelay=e,this.longDelay=n,Hn(n>e,"Short delay should be less than long delay!"),this.isMobile=od()||vv()}get(){return hA()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pA=new Mo(3e4,6e4);function fd(t,e){return t.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:t.tenantId}):e}async function ar(t,e,n,i,s={}){return Nv(t,s,async()=>{let r={},o={};i&&(e==="GET"?o=i:r={body:JSON.stringify(i)});const a=or(Object.assign({key:t.config.apiKey},o)).slice(1),c=await t._getAdditionalHeaders();return c["Content-Type"]="application/json",t.languageCode&&(c["X-Firebase-Locale"]=t.languageCode),kv.fetch()(xv(t,t.config.apiHost,n,a),Object.assign({method:e,headers:c,referrerPolicy:"no-referrer"},r))})}async function Nv(t,e,n){t._canInitEmulator=!1;const i=Object.assign(Object.assign({},fA),e);try{const s=new gA(t),r=await Promise.race([n(),s.promise]);s.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw fa(t,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const a=r.ok?o.errorMessage:o.error.message,[c,l]=a.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw fa(t,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw fa(t,"email-already-in-use",o);if(c==="USER_DISABLED")throw fa(t,"user-disabled",o);const u=i[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(l)throw Pv(t,u,l);An(t,u)}}catch(s){if(s instanceof Nn)throw s;An(t,"network-request-failed",{message:String(s)})}}async function mA(t,e,n,i,s={}){const r=await ar(t,e,n,i,s);return"mfaPendingCredential"in r&&An(t,"multi-factor-auth-required",{_serverResponse:r}),r}function xv(t,e,n,i){const s=`${e}${n}?${i}`;return t.config.emulator?dd(t.config,s):`${t.config.apiScheme}://${s}`}class gA{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,i)=>{this.timer=setTimeout(()=>i(yn(this.auth,"network-request-failed")),pA.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function fa(t,e,n){const i={appName:t.name};n.email&&(i.email=n.email),n.phoneNumber&&(i.phoneNumber=n.phoneNumber);const s=yn(t,e,i);return s.customData._tokenResponse=n,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _A(t,e){return ar(t,"POST","/v1/accounts:delete",e)}async function vA(t,e){return ar(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zr(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function yA(t,e=!1){const n=Lt(t),i=await n.getIdToken(e),s=pd(i);J(s&&s.exp&&s.auth_time&&s.iat,n.auth,"internal-error");const r=typeof s.firebase=="object"?s.firebase:void 0,o=r==null?void 0:r.sign_in_provider;return{claims:s,token:i,authTime:zr(Xl(s.auth_time)),issuedAtTime:zr(Xl(s.iat)),expirationTime:zr(Xl(s.exp)),signInProvider:o||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function Xl(t){return Number(t)*1e3}function pd(t){const[e,n,i]=t.split(".");if(e===void 0||n===void 0||i===void 0)return La("JWT malformed, contained fewer than 3 sections"),null;try{const s=tc(n);return s?JSON.parse(s):(La("Failed to decode base64 JWT payload"),null)}catch(s){return La("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function EA(t){const e=pd(t);return J(e,"internal-error"),J(typeof e.exp<"u","internal-error"),J(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function AA(t,e){const n=await Nv(t,{},async()=>{const i=or({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:r}=t.config,o=xv(t,s,"/v1/token",`key=${r}`),a=await t._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",kv.fetch()(o,{method:"POST",headers:a,body:i})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function CA(t,e){return ar(t,"POST","/v2/accounts:revokeToken",fd(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zp(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(qv(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Lv(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Fv(e))return"Blackberry";if(Uv(e))return"Webos";if(md(e))return"Safari";if((e.includes("chrome/")||Mv(e))&&!e.includes("edge/"))return"Chrome";if(Vv(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=t.match(n);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function Lv(t=Et()){return/firefox\//i.test(t)}function md(t=Et()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Mv(t=Et()){return/crios\//i.test(t)}function qv(t=Et()){return/iemobile/i.test(t)}function Vv(t=Et()){return/android/i.test(t)}function Fv(t=Et()){return/blackberry/i.test(t)}function Uv(t=Et()){return/webos/i.test(t)}function el(t=Et()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function SA(t=Et()){var e;return el(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function PA(){return Bb()&&document.documentMode===10}function zv(t=Et()){return el(t)||Vv(t)||Uv(t)||Fv(t)||/windows phone/i.test(t)||qv(t)}function kA(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jv(t,e=[]){let n;switch(t){case"Browser":n=zp(Et());break;case"Worker":n=`${zp(Et())}-${t}`;break;default:n=t}const i=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${bi}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xA(t,e={}){return ar(t,"GET","/v2/passwordPolicy",fd(t,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function FA(t,e){const n=cd(t,"auth");if(n.isInitialized()){const s=n.getImmediate(),r=n.getOptions();if(ic(r,e??{}))return s;An(s,"already-initialized")}return n.initialize({options:e})}function UA(t,e){const n=(e==null?void 0:e.persistence)||[],i=(Array.isArray(n)?n:[n]).map(Fn);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(i,e==null?void 0:e.popupRedirectResolver)}function zA(t,e,n){const i=tl(t);J(i._canInitEmulator,i,"emulator-config-failed"),J(/^https?:\/\//.test(e),i,"invalid-emulator-scheme");const s=!!(n!=null&&n.disableWarnings),r=Bv(e),{host:o,port:a}=jA(e),c=a===null?"":`:${a}`;i.config.emulator={url:`${r}//${o}${c}/`},i.settings.appVerificationDisabledForTesting=!0,i.emulatorConfig=Object.freeze({host:o,port:a,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:s})}),s||BA()}function Bv(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function jA(t){const e=Bv(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const i=n[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(i);if(s){const r=s[1];return{host:r,port:Bp(i.substr(r.length+1))}}else{const[r,o]=i.split(":");return{host:r,port:Bp(o)}}}function Bp(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function BA(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qo extends gd{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ri extends qo{constructor(){super("facebook.com")}static credential(e){return Qi._fromParams({providerId:ri.PROVIDER_ID,signInMethod:ri.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return ri.credentialFromTaggedObject(e)}static credentialFromError(e){return ri.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return ri.credential(e.oauthAccessToken)}catch{return null}}}ri.FACEBOOK_SIGN_IN_METHOD="facebook.com";ri.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oi extends qo{constructor(){super("github.com")}static credential(e){return Qi._fromParams({providerId:oi.PROVIDER_ID,signInMethod:oi.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return oi.credentialFromTaggedObject(e)}static credentialFromError(e){return oi.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return oi.credential(e.oauthAccessToken)}catch{return null}}}oi.GITHUB_SIGN_IN_METHOD="github.com";oi.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Us{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,n,i,s=!1){const r=await $i._fromIdTokenResponse(e,i,s),o=$p(i);return new Us({user:r,providerId:o,_tokenResponse:i,operationType:n})}static async _forOperation(e,n,i){await e._updateTokensIfNecessary(i,!0);const s=$p(i);return new Us({user:e,providerId:s,_tokenResponse:i,operationType:n})}}function $p(t){return t.providerId?t.providerId:"phoneNumber"in t?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function KA(t,e,n=!1){const i="signIn",s=await Wv(t,i,e),r=await Us._fromIdTokenResponse(t,i,s);return n||await t._updateCurrentUser(r.user),r}function GA(t,e,n,i){return Lt(t).onIdTokenChanged(e,n,i)}function QA(t,e,n){return Lt(t).beforeAuthStateChanged(e,n)}const cc="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nl{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const n=this.receivers.find(s=>s.isListeningto(e));if(n)return n;const i=new nl(e);return this.receivers.push(i),i}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const n=e,{eventId:i,eventType:s,data:r}=n.data,o=this.handlersMap[s];if(!(o!=null&&o.size))return;n.ports[0].postMessage({status:"ack",eventId:i,eventType:s});const a=Array.from(o).map(async l=>l(n.origin,r)),c=await eC(a);n.ports[0].postMessage({status:"done",eventId:i,eventType:s,response:c})}_subscribe(e,n){Object.keys(this.handlersMap).length===0&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(n)}_unsubscribe(e,n){this.handlersMap[e]&&n&&this.handlersMap[e].delete(n),(!n||this.handlersMap[e].size===0)&&delete this.handlersMap[e],Object.keys(this.handlersMap).length===0&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}nl.receivers=[];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _C="pendingRedirect",qa=new Map;class vC extends ty{constructor(e,n,i=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,i),this.eventId=null}async execute(){let e=qa.get(this.auth._key());if(!e){try{const i=await yC(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(i)}catch(n){e=()=>Promise.reject(n)}qa.set(this.auth._key(),e)}return this.bypassAuthState||qa.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function yC(t,e){const n=IC(e),i=TC(t);if(!await i._isAvailable())return!1;const s=await i._get(n)==="true";return await i._remove(n),s}function EC(t,e){qa.set(t._key(),e)}function TC(t){return Fn(t._redirectPersistence)}function IC(t){return Ma(_C,t.config.apiKey,t.name)}async function wC(t,e,n=!1){const i=tl(t),s=ey(i,e),o=await new vC(i,s,n).execute();return o&&!n&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xC=new Mo(3e4,6e4);function Gp(){const t=En().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function OC(t){return new Promise((e,n)=>{var i,s,r;function o(){Gp(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Gp(),n(yn(t,"network-request-failed"))},timeout:xC.get()})}if(!((s=(i=En().gapi)===null||i===void 0?void 0:i.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((r=En().gapi)===null||r===void 0)&&r.load)o();else{const a=VA("iframefcb");return En()[a]=()=>{gapi.load?o():n(yn(t,"network-request-failed"))},qA(`https://apis.google.com/js/api.js?onload=${a}`).catch(c=>n(c))}}).catch(e=>{throw Va=null,e})}let Va=null;function DC(t){return Va=Va||OC(t),Va}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const aS=new Map,cS={activated:!1,tokenObservers:[]};function sn(t){return aS.get(t)||Object.assign({},cS)}const em={OFFSET_DURATION:5*60*1e3,RETRIAL_MIN_WAIT:30*1e3,RETRIAL_MAX_WAIT:16*60*1e3};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dS="firebase-app-check-database",fS=1,Ku="firebase-app-check-store";let pa=null;function pS(){return pa||(pa=new Promise((t,e)=>{try{const n=indexedDB.open(dS,fS);n.onsuccess=i=>{t(i.target.result)},n.onerror=i=>{var s;e(uc.create("storage-open",{originalErrorMessage:(s=i.target.error)===null||s===void 0?void 0:s.message}))},n.onupgradeneeded=i=>{const s=i.target.result;switch(i.oldVersion){case 0:s.createObjectStore(Ku,{keyPath:"compositeKey"})}}}catch(n){e(uc.create("storage-open",{originalErrorMessage:n==null?void 0:n.message}))}}),pa)}function mS(t,e){return gS(_S(t),e)}async function gS(t,e){const i=(await pS()).transaction(Ku,"readwrite"),r=i.objectStore(Ku).put({compositeKey:t,value:e});return new Promise((o,a)=>{r.onsuccess=c=>{o()},i.onerror=c=>{var l;a(uc.create("storage-set",{originalErrorMessage:(l=c.target.error)===null||l===void 0?void 0:l.message}))}})}function _S(t){return`${t.options.appId}-${t.name}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gu=new Lo("@firebase/app-check");function tm(t,e){return Ev()?mS(t,e).catch(n=>{Gu.warn(`Failed to write token to IndexedDB. Error: ${n}`)}):Promise.resolve()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vS={error:"UNKNOWN_ERROR"};function yS(t){return Jc.encodeString(JSON.stringify(t),!1)}async function Qu(t,e=!1){const n=t.app;sy(n);const i=sn(n);let s=i.token,r;if(s&&!kr(s)&&(i.token=void 0,s=void 0),!s){const c=await i.cachedTokenPromise;c&&(kr(c)?s=c:await tm(n,void 0))}if(!e&&s&&kr(s))return{token:s.token};let o=!1;try{i.exchangeTokenPromise||(i.exchangeTokenPromise=i.provider.getToken().finally(()=>{i.exchangeTokenPromise=void 0}),o=!0),s=await sn(n).exchangeTokenPromise}catch(c){c.code==="appCheck/throttled"?Gu.warn(c.message):Gu.error(c),r=c}let a;return s?r?kr(s)?a={token:s.token,internalError:r}:a=im(r):(a={token:s.token},i.token=s,await tm(n,s)):a=im(r),o&&wS(n,a),a}async function ES(t){const e=t.app;sy(e);const{provider:n}=sn(e);{const{token:i}=await n.getToken();return{token:i}}}function TS(t,e,n,i){const{app:s}=t,r=sn(s),o={next:n,error:i,type:e};if(r.tokenObservers=[...r.tokenObservers,o],r.token&&kr(r.token)){const a=r.token;Promise.resolve().then(()=>{n({token:a.token}),nm(t)}).catch(()=>{})}r.cachedTokenPromise.then(()=>nm(t))}function ry(t,e){const n=sn(t),i=n.tokenObservers.filter(s=>s.next!==e);i.length===0&&n.tokenRefresher&&n.tokenRefresher.isRunning()&&n.tokenRefresher.stop(),n.tokenObservers=i}function nm(t){const{app:e}=t,n=sn(e);let i=n.tokenRefresher;i||(i=IS(t),n.tokenRefresher=i),!i.isRunning()&&n.isTokenAutoRefreshEnabled&&i.start()}function IS(t){const{app:e}=t;return new lS(async()=>{const n=sn(e);let i;if(n.token?i=await Qu(t,!0):i=await Qu(t),i.error)throw i.error;if(i.internalError)throw i.internalError},()=>!0,()=>{const n=sn(e);if(n.token){let i=n.token.issuedAtTimeMillis+(n.token.expireTimeMillis-n.token.issuedAtTimeMillis)*.5+3e5;const s=n.token.expireTimeMillis-5*60*1e3;return i=Math.min(i,s),Math.max(0,i-Date.now())}else return 0},em.RETRIAL_MIN_WAIT,em.RETRIAL_MAX_WAIT)}function wS(t,e){const n=sn(t).tokenObservers;for(const i of n)try{i.type==="EXTERNAL"&&e.error!=null?i.error(e.error):i.next(e)}catch{}}function kr(t){return t.expireTimeMillis-Date.now()>0}function im(t){return{token:yS(vS),error:t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bS{constructor(e,n){this.app=e,this.heartbeatServiceProvider=n}_delete(){const{tokenObservers:e}=sn(this.app);for(const n of e)ry(this.app,n.next);return Promise.resolve()}}function RS(t,e){return new bS(t,e)}function AS(t){return{getToken:e=>Qu(t,e),getLimitedUseToken:()=>ES(t),addTokenListener:e=>TS(t,"INTERNAL",e),removeTokenListener:e=>ry(t.app,e)}}const CS="@firebase/app-check",SS="0.8.0",PS="app-check",sm="app-check-internal";function kS(){Rn(new nn(PS,t=>{const e=t.getProvider("app").getImmediate(),n=t.getProvider("heartbeat");return RS(e,n)},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((t,e,n)=>{t.getProvider(sm).initialize()})),Rn(new nn(sm,t=>{const e=t.getProvider("app-check").getImmediate();return AS(e)},"PUBLIC").setInstantiationMode("EXPLICIT")),Ot(CS,SS)}kS();var NS="firebase",xS="10.6.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ks=new Lo("@firebase/database"),GS=function(){let t=1;return function(){return t++}}(),ly=function(t){const e=tR(t),n=new Yb;n.update(e);const i=n.digest();return Jc.encodeByteArray(i)},Fo=function(...t){let e="";for(let n=0;n<t.length;n++){const i=t[n];Array.isArray(i)||i&&typeof i=="object"&&typeof i.length=="number"?e+=Fo.apply(null,i):typeof i=="object"?e+=it(i):e+=i,e+=" "}return e};let Wi=null,am=!0;const QS=function(t,e){D(!e||t===!0||t===!1,"Can't turn on custom loggers persistently."),t===!0?(ks.logLevel=re.VERBOSE,Wi=ks.log.bind(ks),e&&Yu.set("logging_enabled",!0)):typeof t=="function"?Wi=t:(Wi=null,Yu.remove("logging_enabled"))},ft=function(...t){if(am===!0&&(am=!1,Wi===null&&Yu.get("logging_enabled")===!0&&QS(!0)),Wi){const e=Fo.apply(null,t);Wi(e)}},Uo=function(t){return function(...e){ft(t,...e)}},Xu=function(...t){const e="FIREBASE INTERNAL ERROR: "+Fo(...t);ks.error(e)},Yi=function(...t){const e=`FIREBASE FATAL ERROR: ${Fo(...t)}`;throw ks.error(e),new Error(e)},Dt=function(...t){const e="FIREBASE WARNING: "+Fo(...t);ks.warn(e)},YS=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&Dt("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},uy=function(t){return typeof t=="number"&&(t!==t||t===Number.POSITIVE_INFINITY||t===Number.NEGATIVE_INFINITY)},XS=function(t){if(document.readyState==="complete")t();else{let e=!1;const n=function(){if(!document.body){setTimeout(n,Math.floor(10));return}e||(e=!0,t())};document.addEventListener?(document.addEventListener("DOMContentLoaded",n,!1),window.addEventListener("load",n,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&n()}),window.attachEvent("onload",n))}},zs="[MIN_NAME]",Xi="[MAX_NAME]",cr=function(t,e){if(t===e)return 0;if(t===zs||e===Xi)return-1;if(e===zs||t===Xi)return 1;{const n=cm(t),i=cm(e);return n!==null?i!==null?n-i===0?t.length-e.length:n-i:-1:i!==null?1:t<e?-1:1}},JS=function(t,e){return t===e?0:t<e?-1:1},yr=function(t,e){if(e&&t in e)return e[t];throw new Error("Missing required key ("+t+") in object: "+it(e))},Id=function(t){if(typeof t!="object"||t===null)return it(t);const e=[];for(const i in t)e.push(i);e.sort();let n="{";for(let i=0;i<e.length;i++)i!==0&&(n+=","),n+=it(e[i]),n+=":",n+=Id(t[e[i]]);return n+="}",n},hy=function(t,e){const n=t.length;if(n<=e)return[t];const i=[];for(let s=0;s<n;s+=e)s+e>n?i.push(t.substring(s,n)):i.push(t.substring(s,s+e));return i};function Wt(t,e){for(const n in t)t.hasOwnProperty(n)&&e(n,t[n])}const dy=function(t){D(!uy(t),"Invalid JSON number");const e=11,n=52,i=(1<<e-1)-1;let s,r,o,a,c;t===0?(r=0,o=0,s=1/t===-1/0?1:0):(s=t<0,t=Math.abs(t),t>=Math.pow(2,1-i)?(a=Math.min(Math.floor(Math.log(t)/Math.LN2),i),r=a+i,o=Math.round(t*Math.pow(2,n-a)-Math.pow(2,n))):(r=0,o=Math.round(t/Math.pow(2,1-i-n))));const l=[];for(c=n;c;c-=1)l.push(o%2?1:0),o=Math.floor(o/2);for(c=e;c;c-=1)l.push(r%2?1:0),r=Math.floor(r/2);l.push(s?1:0),l.reverse();const u=l.join("");let h="";for(c=0;c<64;c+=8){let d=parseInt(u.substr(c,8),2).toString(16);d.length===1&&(d="0"+d),h=h+d}return h.toLowerCase()},ZS=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},eP=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"},tP=new RegExp("^-?(0*)\\d{1,10}$"),nP=-2147483648,iP=2147483647,cm=function(t){if(tP.test(t)){const e=Number(t);if(e>=nP&&e<=iP)return e}return null},zo=function(t){try{t()}catch(e){setTimeout(()=>{const n=e.stack||"";throw Dt("Exception was thrown by user callback.",n),e},Math.floor(0))}},sP=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},jr=function(t,e){const n=setTimeout(t,e);return typeof n=="number"&&typeof Deno<"u"&&Deno.unrefTimer?Deno.unrefTimer(n):typeof n=="object"&&n.unref&&n.unref(),n};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zl={},eu={};function bd(t){const e=t.toString();return Zl[e]||(Zl[e]=new lP),Zl[e]}function uP(t,e){const n=t.toString();return eu[n]||(eu[n]=e()),eu[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hP{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,n){this.closeAfterResponse=e,this.onClose=n,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,n){for(this.pendingResponses[e]=n;this.pendingResponses[this.currentResponseNum];){const i=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let s=0;s<i.length;++s)i[s]&&zo(()=>{this.onMessage_(i[s])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dc extends Py{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!od()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new dc}getInitialEvent(e){return D(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sl{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,n){const i=new ue(zs,e),s=new ue(zs,n);return this.compare(i,s)!==0}minPost(){return ue.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jP(t,e){return cr(t.name,e.name)}function Cd(t,e){return cr(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let nu;const ps={};class Un{constructor(e,n){this.indexes_=e,this.indexSet_=n}static get Default(){return D(ps&&_t,"ChildrenNode.ts has not been loaded"),nu=nu||new Un({".priority":ps},{".priority":_t}),nu}get(e){const n=Fs(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof mn?n:null}hasIndex(e){return Xn(this.indexSet_,e.toString())}addIndex(e,n){D(e!==Ns,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=n.getIterator(ue.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let a;s?a=fc(i,e.getCompare()):a=ps;const c=e.toString(),l=Object.assign({},this.indexSet_);l[c]=e;const u=Object.assign({},this.indexes_);return u[c]=a,new Un(u,l)}addToIndexes(e,n){const i=nc(this.indexes_,(s,r)=>{const o=Fs(this.indexSet_,r);if(D(o,"Missing index implementation for "+r),s===ps)if(o.isDefinedOn(e.node)){const a=[],c=n.getIterator(ue.Wrap);let l=c.getNext();for(;l;)l.name!==e.name&&a.push(l),l=c.getNext();return a.push(e),fc(a,o.getCompare())}else return ps;else{const a=n.get(e.name);let c=s;return a&&(c=c.remove(new ue(e.name,a))),c.insert(e,e.node)}});return new Un(i,this.indexSet_)}removeFromIndexes(e,n){const i=nc(this.indexes_,s=>{if(s===ps)return s;{const r=n.get(e.name);return r?s.remove(new ue(e.name,r)):s}});return new Un(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class JP extends sl{compare(e,n){const i=e.node.compareTo(n.node);return i===0?cr(e.name,n.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return ue.MIN}maxPost(){return ue.MAX}makePost(e,n){const i=pt(e);return new ue(n,i)}toString(){return".value"}}const ZP=new JP;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sd{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=_t}hasStart(){return this.startSet_}isViewFromLeft(){return this.viewFrom_===""?this.startSet_:this.viewFrom_==="l"}getIndexStartValue(){return D(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return D(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:zs}hasEnd(){return this.endSet_}getIndexEndValue(){return D(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return D(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:Xi}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&this.viewFrom_!==""}getLimit(){return D(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===_t}copy(){const e=new Sd;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.startAfterSet_=this.startAfterSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.endBeforeSet_=this.endBeforeSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function Im(t){const e={};if(t.isDefault())return e;let n;if(t.index_===_t?n="$priority":t.index_===ZP?n="$value":t.index_===Ns?n="$key":(D(t.index_ instanceof XP,"Unrecognized index type!"),n=t.index_.toString()),e.orderBy=it(n),t.startSet_){const i=t.startAfterSet_?"startAfter":"startAt";e[i]=it(t.indexStartValue_),t.startNameSet_&&(e[i]+=","+it(t.indexStartName_))}if(t.endSet_){const i=t.endBeforeSet_?"endBefore":"endAt";e[i]=it(t.indexEndValue_),t.endNameSet_&&(e[i]+=","+it(t.indexEndName_))}return t.limitSet_&&(t.isViewFromLeft()?e.limitToFirst=t.limit_:e.limitToLast=t.limit_),e}function wm(t){const e={};if(t.startSet_&&(e.sp=t.indexStartValue_,t.startNameSet_&&(e.sn=t.indexStartName_),e.sin=!t.startAfterSet_),t.endSet_&&(e.ep=t.indexEndValue_,t.endNameSet_&&(e.en=t.indexEndName_),e.ein=!t.endBeforeSet_),t.limitSet_){e.l=t.limit_;let n=t.viewFrom_;n===""&&(t.isViewFromLeft()?n="l":n="r"),e.vf=n}return t.index_!==_t&&(e.i=t.index_.toString()),e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bm=10*1e3,ak=30*1e3,ck=5*60*1e3;class lk{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new ok(e);const i=bm+(ak-bm)*Math.random();jr(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),n={};let i=!1;Wt(e,(s,r)=>{r>0&&Xn(this.statsToReport_,s)&&(n[s]=r,i=!0)}),i&&this.server_.reportStats(n),jr(this.reportStats_.bind(this),Math.floor(Math.random()*2*ck))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gc{constructor(e,n,i){this.path=e,this.affectedTree=n,this.revert=i,this.type=gn.ACK_USER_WRITE,this.source=zy()}operationForChild(e){if(ae(this.path)){if(this.affectedTree.value!=null)return D(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new De(e));return new gc(be(),n,this.revert)}}else return D(le(this.path)===e,"operationForChild called for unrelated child."),new gc(Ne(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class po{constructor(e,n,i){this.source=e,this.path=n,this.children=i,this.type=gn.MERGE}operationForChild(e){if(ae(this.path)){const n=this.children.subtree(new De(e));return n.isEmpty()?null:n.value?new Ji(this.source,be(),n.value):new po(this.source,be(),n)}else return D(le(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new po(this.source,Ne(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $y(t,e){return{eventCache:t,serverCache:e}}function Br(t,e,n,i){return $y(new Pd(e,n,i),t.serverCache)}function Wy(t,e,n,i){return $y(t.eventCache,new Pd(e,n,i))}function nh(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function Zi(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ky(t,e){return Jy(e,t)}function pk(t,e,n,i,s){D(i>t.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),t.allWrites.push({path:e,snap:n,writeId:i,visible:s}),s&&(t.visibleWrites=$r(t.visibleWrites,e,n)),t.lastWriteId=i}function mk(t,e){for(let n=0;n<t.allWrites.length;n++){const i=t.allWrites[n];if(i.writeId===e)return i}return null}function gk(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);D(n>=0,"removeWrite called with nonexistent writeId.");const i=t.allWrites[n];t.allWrites.splice(n,1);let s=i.visible,r=!1,o=t.allWrites.length-1;for(;s&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&_k(a,i.path)?s=!1:Yt(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return vk(t),!0;if(i.snap)t.visibleWrites=Am(t.visibleWrites,i.path);else{const a=i.children;Wt(a,c=>{t.visibleWrites=Am(t.visibleWrites,Qe(i.path,c))})}return!0}else return!1}function _k(t,e){if(t.snap)return Yt(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&Yt(Qe(t.path,n),e))return!0;return!1}function vk(t){t.visibleWrites=Gy(t.allWrites,yk,be()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function yk(t){return t.visible}function Gy(t,e,n){let i=tn.empty();for(let s=0;s<t.length;++s){const r=t[s];if(e(r)){const o=r.path;let a;if(r.snap)Yt(n,o)?(a=Bt(n,o),i=$r(i,a,r.snap)):Yt(o,n)&&(a=Bt(o,n),i=$r(i,be(),r.snap.getChild(a)));else if(r.children){if(Yt(n,o))a=Bt(n,o),i=Rm(i,a,r.children);else if(Yt(o,n))if(a=Bt(o,n),ae(a))i=Rm(i,be(),r.children);else{const c=Fs(r.children,le(a));if(c){const l=c.getChild(Ne(a));i=$r(i,be(),l)}}}else throw sr("WriteRecord should have .snap or .children")}}return i}function Qy(t,e,n,i,s){if(!i&&!s){const r=ss(t.visibleWrites,e);if(r!=null)return r;{const o=gi(t.visibleWrites,e);if(sh(o))return n;if(n==null&&!ih(o,be()))return null;{const a=n||ye.EMPTY_NODE;return js(o,a)}}}else{const r=gi(t.visibleWrites,e);if(!s&&sh(r))return n;if(!s&&n==null&&!ih(r,be()))return null;{const o=function(l){return(l.visible||s)&&(!i||!~i.indexOf(l.writeId))&&(Yt(l.path,e)||Yt(e,l.path))},a=Gy(t.allWrites,o,e),c=n||ye.EMPTY_NODE;return js(a,c)}}}function Ek(t,e,n){let i=ye.EMPTY_NODE;const s=ss(t.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(_t,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(n){const r=gi(t.visibleWrites,e);return n.forEachChild(_t,(o,a)=>{const c=js(gi(r,new De(o)),a);i=i.updateImmediateChild(o,c)}),Cm(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=gi(t.visibleWrites,e);return Cm(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function Tk(t,e,n,i,s){D(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=Qe(e,n);if(ih(t.visibleWrites,r))return null;{const o=gi(t.visibleWrites,r);return sh(o)?s.getChild(n):js(o,s.getChild(n))}}function Ik(t,e,n,i){const s=Qe(e,n),r=ss(t.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(n)){const o=gi(t.visibleWrites,s);return js(o,i.getNode().getImmediateChild(n))}else return null}function wk(t,e){return ss(t.visibleWrites,e)}function bk(t,e,n,i,s,r,o){let a;const c=gi(t.visibleWrites,e),l=ss(c,be());if(l!=null)a=l;else if(n!=null)a=js(c,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],h=o.getCompare(),d=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let f=d.getNext();for(;f&&u.length<s;)h(f,i)!==0&&u.push(f),f=d.getNext();return u}else return[]}function Rk(){return{visibleWrites:tn.empty(),allWrites:[],lastWriteId:-1}}function rh(t,e,n,i){return Qy(t.writeTree,t.treePath,e,n,i)}function Yy(t,e){return Ek(t.writeTree,t.treePath,e)}function Sm(t,e,n,i){return Tk(t.writeTree,t.treePath,e,n,i)}function _c(t,e){return wk(t.writeTree,Qe(t.treePath,e))}function Ak(t,e,n,i,s,r){return bk(t.writeTree,t.treePath,e,n,i,s,r)}function kd(t,e,n){return Ik(t.writeTree,t.treePath,e,n)}function Xy(t,e){return Jy(Qe(t.treePath,e),t.writeTree)}function Jy(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qd{constructor(e="",n=null,i={children:{},childCount:0}){this.name=e,this.parent=n,this.node=i}}function Vd(t,e){let n=e instanceof De?e:new De(e),i=t,s=le(n);for(;s!==null;){const r=Fs(i.node.children,s)||{children:{},childCount:0};i=new qd(s,i,r),n=Ne(n),s=le(n)}return i}function lr(t){return t.node.value}function aE(t,e){t.node.value=e,ch(t)}function cE(t){return t.node.childCount>0}function Qk(t){return lr(t)===void 0&&!cE(t)}function al(t,e){Wt(t.node.children,(n,i)=>{e(new qd(n,t,i))})}function lE(t,e,n,i){n&&!i&&e(t),al(t,s=>{lE(s,e,!0,i)}),n&&i&&e(t)}function Yk(t,e,n){let i=n?t:t.parent;for(;i!==null;){if(e(i))return!0;i=i.parent}return!1}function Bo(t){return new De(t.parent===null?t.name:Bo(t.parent)+"/"+t.name)}function ch(t){t.parent!==null&&Xk(t.parent,t.name,t)}function Xk(t,e,n){const i=Qk(n),s=Xn(t.node.children,e);i&&s?(delete t.node.children[e],t.node.childCount--,ch(t)):!i&&!s&&(t.node.children[e]=n.node,t.node.childCount++,ch(t))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const a1="repo_interrupt",c1=25;class l1{constructor(e,n,i,s){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=i,this.appCheckProvider_=s,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new i1,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=mc(),this.transactionQueueTree_=new qd,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function u1(t,e,n){if(t.stats_=bd(t.repoInfo_),t.forceRestClient_||sP())t.server_=new pc(t.repoInfo_,(i,s,r,o)=>{Mm(t,i,s,r,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>qm(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{it(n)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}t.persistentConnection_=new Bn(t.repoInfo_,e,(i,s,r,o)=>{Mm(t,i,s,r,o)},i=>{qm(t,i)},i=>{d1(t,i)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(i=>{t.server_.refreshAuthToken(i)}),t.appCheckProvider_.addTokenChangeListener(i=>{t.server_.refreshAppCheckToken(i.token)}),t.statsReporter_=uP(t.repoInfo_,()=>new lk(t.stats_,t.server_)),t.infoData_=new sk,t.infoSyncTree_=new Dm({startListening:(i,s,r,o)=>{let a=[];const c=t.infoData_.getNode(i._path);return c.isEmpty()||(a=rl(t.infoSyncTree_,i._path,c),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Fd(t,"connected",!1),t.serverSyncTree_=new Dm({startListening:(i,s,r,o)=>(t.server_.listen(i,r,s,(a,c)=>{const l=o(a,c);rs(t.eventQueue_,i._path,l)}),[]),stopListening:(i,s)=>{t.server_.unlisten(i,s)}})}function h1(t){const n=t.infoData_.getNode(new De(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function dE(t){return $k({timestamp:h1(t)})}function Mm(t,e,n,i,s){t.dataUpdateCount++;const r=new De(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(s)if(i){const c=nc(n,l=>pt(l));o=Bk(t.serverSyncTree_,r,c,s)}else{const c=pt(n);o=jk(t.serverSyncTree_,r,c,s)}else if(i){const c=nc(n,l=>pt(l));o=zk(t.serverSyncTree_,r,c)}else{const c=pt(n);o=rl(t.serverSyncTree_,r,c)}let a=r;o.length>0&&(a=zd(t,r)),rs(t.eventQueue_,a,o)}function qm(t,e){Fd(t,"connected",e),e===!1&&p1(t)}function d1(t,e){Wt(e,(n,i)=>{Fd(t,n,i)})}function Fd(t,e,n){const i=new De("/.info/"+e),s=pt(n);t.infoData_.updateSnapshot(i,s);const r=rl(t.infoSyncTree_,i,s);rs(t.eventQueue_,i,r)}function f1(t){return t.nextWriteId_++}function p1(t){fE(t,"onDisconnectEvents");const e=dE(t),n=mc();th(t.onDisconnect_,be(),(s,r)=>{const o=Kk(s,r,t.serverSyncTree_,e);Uy(n,s,o)});let i=[];th(n,be(),(s,r)=>{i=i.concat(rl(t.serverSyncTree_,s,r));const o=v1(t,s);zd(t,o)}),t.onDisconnect_=mc(),rs(t.eventQueue_,be(),i)}function m1(t){t.persistentConnection_&&t.persistentConnection_.interrupt(a1)}function fE(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),ft(n,...e)}function pE(t,e,n){return tE(t.serverSyncTree_,e,n)||ye.EMPTY_NODE}function Ud(t,e=t.transactionQueueTree_){if(e||cl(t,e),lr(e)){const n=gE(t,e);D(n.length>0,"Sending zero length transaction queue"),n.every(s=>s.status===0)&&g1(t,Bo(e),n)}else cE(e)&&al(e,n=>{Ud(t,n)})}function g1(t,e,n){const i=n.map(l=>l.currentWriteId),s=pE(t,e,i);let r=s;const o=s.hash();for(let l=0;l<n.length;l++){const u=n[l];D(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const h=Bt(e,u.path);r=r.updateChild(h,u.currentOutputSnapshotRaw)}const a=r.val(!0),c=e;t.server_.put(c.toString(),a,l=>{fE(t,"transaction put response",{path:c.toString(),status:l});let u=[];if(l==="ok"){const h=[];for(let d=0;d<n.length;d++)n[d].status=2,u=u.concat(Ts(t.serverSyncTree_,n[d].currentWriteId)),n[d].onComplete&&h.push(()=>n[d].onComplete(null,!0,n[d].currentOutputSnapshotResolved)),n[d].unwatcher();cl(t,Vd(t.transactionQueueTree_,e)),Ud(t,t.transactionQueueTree_),rs(t.eventQueue_,e,u);for(let d=0;d<h.length;d++)zo(h[d])}else{if(l==="datastale")for(let h=0;h<n.length;h++)n[h].status===3?n[h].status=4:n[h].status=0;else{Dt("transaction at "+c.toString()+" failed: "+l);for(let h=0;h<n.length;h++)n[h].status=4,n[h].abortReason=l}zd(t,e)}},o)}function zd(t,e){const n=mE(t,e),i=Bo(n),s=gE(t,n);return _1(t,s,i),i}function _1(t,e,n){if(e.length===0)return;const i=[];let s=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const c=e[a],l=Bt(n,c.path);let u=!1,h;if(D(l!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),c.status===4)u=!0,h=c.abortReason,s=s.concat(Ts(t.serverSyncTree_,c.currentWriteId,!0));else if(c.status===0)if(c.retryCount>=c1)u=!0,h="maxretry",s=s.concat(Ts(t.serverSyncTree_,c.currentWriteId,!0));else{const d=pE(t,c.path,o);c.currentInputSnapshot=d;const f=e[a].update(d.val());if(f!==void 0){hE("transaction failed: Data returned ",f,c.path);let g=pt(f);typeof f=="object"&&f!=null&&Xn(f,".priority")||(g=g.updatePriority(d.getPriority()));const y=c.currentWriteId,I=dE(t),P=Gk(g,d,I);c.currentOutputSnapshotRaw=g,c.currentOutputSnapshotResolved=P,c.currentWriteId=f1(t),o.splice(o.indexOf(y),1),s=s.concat(Uk(t.serverSyncTree_,c.path,P,c.currentWriteId,c.applyLocally)),s=s.concat(Ts(t.serverSyncTree_,y,!0))}else u=!0,h="nodata",s=s.concat(Ts(t.serverSyncTree_,c.currentWriteId,!0))}rs(t.eventQueue_,n,s),s=[],u&&(e[a].status=2,function(d){setTimeout(d,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(h==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(h),!1,null))))}cl(t,t.transactionQueueTree_);for(let a=0;a<i.length;a++)zo(i[a]);Ud(t,t.transactionQueueTree_)}function mE(t,e){let n,i=t.transactionQueueTree_;for(n=le(e);n!==null&&lr(i)===void 0;)i=Vd(i,n),e=Ne(e),n=le(e);return i}function gE(t,e){const n=[];return _E(t,e,n),n.sort((i,s)=>i.order-s.order),n}function _E(t,e,n){const i=lr(e);if(i)for(let s=0;s<i.length;s++)n.push(i[s]);al(e,s=>{_E(t,s,n)})}function cl(t,e){const n=lr(e);if(n){let i=0;for(let s=0;s<n.length;s++)n[s].status!==2&&(n[i]=n[s],i++);n.length=i,aE(e,n.length>0?n:void 0)}al(e,i=>{cl(t,i)})}function v1(t,e){const n=Bo(mE(t,e)),i=Vd(t.transactionQueueTree_,e);return Yk(i,s=>{ru(t,s)}),ru(t,i),lE(i,s=>{ru(t,s)}),n}function ru(t,e){const n=lr(e);if(n){const i=[];let s=[],r=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(D(r===o-1,"All SENT items should be at beginning of queue."),r=o,n[o].status=3,n[o].abortReason="set"):(D(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),s=s.concat(Ts(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&i.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?aE(e,void 0):n.length=r+1,rs(t.eventQueue_,Bo(e),s);for(let o=0;o<i.length;o++)zo(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jd{constructor(e,n,i,s){this._repo=e,this._path=n,this._queryParams=i,this._orderByCalled=s}get key(){return ae(this._path)?null:ky(this._path)}get ref(){return new ur(this._repo,this._path)}get _queryIdentifier(){const e=wm(this._queryParams),n=Id(e);return n==="{}"?"default":n}get _queryObject(){return wm(this._queryParams)}isEqual(e){if(e=Lt(e),!(e instanceof jd))return!1;const n=this._repo===e._repo,i=Oy(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return n&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+OP(this._path)}}class ur extends jd{constructor(e,n){super(e,n,new Sd,!1)}get parent(){const e=xy(this._path);return e===null?null:new ur(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}Vk(ur);Fk(ur);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function S1(t){WS(bi),Rn(new nn("database",(e,{instanceIdentifier:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return b1(i,s,r,n)},"PUBLIC").setMultipleInstances(!0)),Ot(rm,om,t),Ot(rm,om,"esm2017")}Bn.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Bn.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};S1();var P1=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},L,Bd=Bd||{},Y=P1||self;function ll(t){var e=typeof t;return e=e!="object"?e:t?Array.isArray(t)?"array":e:"null",e=="array"||e=="object"&&typeof t.length=="number"}function $o(t){var e=typeof t;return e=="object"&&t!=null||e=="function"}function k1(t){return Object.prototype.hasOwnProperty.call(t,ou)&&t[ou]||(t[ou]=++N1)}var ou="closure_uid_"+(1e9*Math.random()>>>0),N1=0;function x1(t,e,n){return t.call.apply(t.bind,arguments)}function O1(t,e,n){if(!t)throw Error();if(2<arguments.length){var i=Array.prototype.slice.call(arguments,2);return function(){var s=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(s,i),t.apply(e,s)}}return function(){return t.apply(e,arguments)}}function vt(t,e,n){return Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?vt=x1:vt=O1,vt.apply(null,arguments)}function va(t,e){var n=Array.prototype.slice.call(arguments,1);return function(){var i=n.slice();return i.push.apply(i,arguments),t.apply(this,i)}}function Je(t,e){function n(){}n.prototype=e.prototype,t.$=e.prototype,t.prototype=new n,t.prototype.constructor=t,t.ac=function(i,s,r){for(var o=Array(arguments.length-2),a=2;a<arguments.length;a++)o[a-2]=arguments[a];return e.prototype[s].apply(i,o)}}function Ri(){this.s=this.s,this.o=this.o}var D1=0;Ri.prototype.s=!1;Ri.prototype.sa=function(){!this.s&&(this.s=!0,this.N(),D1!=0)&&k1(this)};Ri.prototype.N=function(){if(this.o)for(;this.o.length;)this.o.shift()()};const vE=Array.prototype.indexOf?function(t,e){return Array.prototype.indexOf.call(t,e,void 0)}:function(t,e){if(typeof t=="string")return typeof e!="string"||e.length!=1?-1:t.indexOf(e,0);for(let n=0;n<t.length;n++)if(n in t&&t[n]===e)return n;return-1};function $d(t){const e=t.length;if(0<e){const n=Array(e);for(let i=0;i<e;i++)n[i]=t[i];return n}return[]}function Fm(t,e){for(let n=1;n<arguments.length;n++){const i=arguments[n];if(ll(i)){const s=t.length||0,r=i.length||0;t.length=s+r;for(let o=0;o<r;o++)t[s+o]=i[o]}else t.push(i)}}function yt(t,e){this.type=t,this.g=this.target=e,this.defaultPrevented=!1}yt.prototype.h=function(){this.defaultPrevented=!0};var L1=function(){if(!Y.addEventListener||!Object.defineProperty)return!1;var t=!1,e=Object.defineProperty({},"passive",{get:function(){t=!0}});try{Y.addEventListener("test",()=>{},e),Y.removeEventListener("test",()=>{},e)}catch{}return t}();function mo(t){return/^[\s\xa0]*$/.test(t)}function ul(){var t=Y.navigator;return t&&(t=t.userAgent)?t:""}function fn(t){return ul().indexOf(t)!=-1}function Wd(t){return Wd[" "](t),t}Wd[" "]=function(){};function M1(t,e){var n=SN;return Object.prototype.hasOwnProperty.call(n,t)?n[t]:n[t]=e(t)}var q1=fn("Opera"),Bs=fn("Trident")||fn("MSIE"),yE=fn("Edge"),uh=yE||Bs,EE=fn("Gecko")&&!(ul().toLowerCase().indexOf("webkit")!=-1&&!fn("Edge"))&&!(fn("Trident")||fn("MSIE"))&&!fn("Edge"),V1=ul().toLowerCase().indexOf("webkit")!=-1&&!fn("Edge");function TE(){var t=Y.document;return t?t.documentMode:void 0}var hh;e:{var au="",cu=function(){var t=ul();if(EE)return/rv:([^\);]+)(\)|;)/.exec(t);if(yE)return/Edge\/([\d\.]+)/.exec(t);if(Bs)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(t);if(V1)return/WebKit\/(\S+)/.exec(t);if(q1)return/(?:Version)[ \/]?(\S+)/.exec(t)}();if(cu&&(au=cu?cu[1]:""),Bs){var lu=TE();if(lu!=null&&lu>parseFloat(au)){hh=String(lu);break e}}hh=au}var dh;if(Y.document&&Bs){var Um=TE();dh=Um||parseInt(hh,10)||void 0}else dh=void 0;var F1=dh;function go(t,e){if(yt.call(this,t?t.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,t){var n=this.type=t.type,i=t.changedTouches&&t.changedTouches.length?t.changedTouches[0]:null;if(this.target=t.target||t.srcElement,this.g=e,e=t.relatedTarget){if(EE){e:{try{Wd(e.nodeName);var s=!0;break e}catch{}s=!1}s||(e=null)}}else n=="mouseover"?e=t.fromElement:n=="mouseout"&&(e=t.toElement);this.relatedTarget=e,i?(this.clientX=i.clientX!==void 0?i.clientX:i.pageX,this.clientY=i.clientY!==void 0?i.clientY:i.pageY,this.screenX=i.screenX||0,this.screenY=i.screenY||0):(this.clientX=t.clientX!==void 0?t.clientX:t.pageX,this.clientY=t.clientY!==void 0?t.clientY:t.pageY,this.screenX=t.screenX||0,this.screenY=t.screenY||0),this.button=t.button,this.key=t.key||"",this.ctrlKey=t.ctrlKey,this.altKey=t.altKey,this.shiftKey=t.shiftKey,this.metaKey=t.metaKey,this.pointerId=t.pointerId||0,this.pointerType=typeof t.pointerType=="string"?t.pointerType:U1[t.pointerType]||"",this.state=t.state,this.i=t,t.defaultPrevented&&go.$.h.call(this)}}Je(go,yt);var U1={2:"touch",3:"pen",4:"mouse"};go.prototype.h=function(){go.$.h.call(this);var t=this.i;t.preventDefault?t.preventDefault():t.returnValue=!1};var Wo="closure_listenable_"+(1e6*Math.random()|0),z1=0;function j1(t,e,n,i,s){this.listener=t,this.proxy=null,this.src=e,this.type=n,this.capture=!!i,this.la=s,this.key=++z1,this.fa=this.ia=!1}function hl(t){t.fa=!0,t.listener=null,t.proxy=null,t.src=null,t.la=null}function Hd(t,e,n){for(const i in t)e.call(n,t[i],i,t)}function B1(t,e){for(const n in t)e.call(void 0,t[n],n,t)}function IE(t){const e={};for(const n in t)e[n]=t[n];return e}const zm="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function wE(t,e){let n,i;for(let s=1;s<arguments.length;s++){i=arguments[s];for(n in i)t[n]=i[n];for(let r=0;r<zm.length;r++)n=zm[r],Object.prototype.hasOwnProperty.call(i,n)&&(t[n]=i[n])}}function dl(t){this.src=t,this.g={},this.h=0}dl.prototype.add=function(t,e,n,i,s){var r=t.toString();t=this.g[r],t||(t=this.g[r]=[],this.h++);var o=ph(t,e,i,s);return-1<o?(e=t[o],n||(e.ia=!1)):(e=new j1(e,this.src,r,!!i,s),e.ia=n,t.push(e)),e};function fh(t,e){var n=e.type;if(n in t.g){var i=t.g[n],s=vE(i,e),r;(r=0<=s)&&Array.prototype.splice.call(i,s,1),r&&(hl(e),t.g[n].length==0&&(delete t.g[n],t.h--))}}function ph(t,e,n,i){for(var s=0;s<t.length;++s){var r=t[s];if(!r.fa&&r.listener==e&&r.capture==!!n&&r.la==i)return s}return-1}var Kd="closure_lm_"+(1e6*Math.random()|0),uu={};function bE(t,e,n,i,s){if(i&&i.once)return AE(t,e,n,i,s);if(Array.isArray(e)){for(var r=0;r<e.length;r++)bE(t,e[r],n,i,s);return null}return n=Yd(n),t&&t[Wo]?t.O(e,n,$o(i)?!!i.capture:!!i,s):RE(t,e,n,!1,i,s)}function RE(t,e,n,i,s,r){if(!e)throw Error("Invalid event type");var o=$o(s)?!!s.capture:!!s,a=Qd(t);if(a||(t[Kd]=a=new dl(t)),n=a.add(e,n,i,o,r),n.proxy)return n;if(i=$1(),n.proxy=i,i.src=t,i.listener=n,t.addEventListener)L1||(s=o),s===void 0&&(s=!1),t.addEventListener(e.toString(),i,s);else if(t.attachEvent)t.attachEvent(SE(e.toString()),i);else if(t.addListener&&t.removeListener)t.addListener(i);else throw Error("addEventListener and attachEvent are unavailable.");return n}function $1(){function t(n){return e.call(t.src,t.listener,n)}const e=W1;return t}function AE(t,e,n,i,s){if(Array.isArray(e)){for(var r=0;r<e.length;r++)AE(t,e[r],n,i,s);return null}return n=Yd(n),t&&t[Wo]?t.P(e,n,$o(i)?!!i.capture:!!i,s):RE(t,e,n,!0,i,s)}function CE(t,e,n,i,s){if(Array.isArray(e))for(var r=0;r<e.length;r++)CE(t,e[r],n,i,s);else i=$o(i)?!!i.capture:!!i,n=Yd(n),t&&t[Wo]?(t=t.i,e=String(e).toString(),e in t.g&&(r=t.g[e],n=ph(r,n,i,s),-1<n&&(hl(r[n]),Array.prototype.splice.call(r,n,1),r.length==0&&(delete t.g[e],t.h--)))):t&&(t=Qd(t))&&(e=t.g[e.toString()],t=-1,e&&(t=ph(e,n,i,s)),(n=-1<t?e[t]:null)&&Gd(n))}function Gd(t){if(typeof t!="number"&&t&&!t.fa){var e=t.src;if(e&&e[Wo])fh(e.i,t);else{var n=t.type,i=t.proxy;e.removeEventListener?e.removeEventListener(n,i,t.capture):e.detachEvent?e.detachEvent(SE(n),i):e.addListener&&e.removeListener&&e.removeListener(i),(n=Qd(e))?(fh(n,t),n.h==0&&(n.src=null,e[Kd]=null)):hl(t)}}}function SE(t){return t in uu?uu[t]:uu[t]="on"+t}function W1(t,e){if(t.fa)t=!0;else{e=new go(e,this);var n=t.listener,i=t.la||t.src;t.ia&&Gd(t),t=n.call(i,e)}return t}function Qd(t){return t=t[Kd],t instanceof dl?t:null}var hu="__closure_events_fn_"+(1e9*Math.random()>>>0);function Yd(t){return typeof t=="function"?t:(t[hu]||(t[hu]=function(e){return t.handleEvent(e)}),t[hu])}function Xe(){Ri.call(this),this.i=new dl(this),this.S=this,this.J=null}Je(Xe,Ri);Xe.prototype[Wo]=!0;Xe.prototype.removeEventListener=function(t,e,n,i){CE(this,t,e,n,i)};function rt(t,e){var n,i=t.J;if(i)for(n=[];i;i=i.J)n.push(i);if(t=t.S,i=e.type||e,typeof e=="string")e=new yt(e,t);else if(e instanceof yt)e.target=e.target||t;else{var s=e;e=new yt(i,t),wE(e,s)}if(s=!0,n)for(var r=n.length-1;0<=r;r--){var o=e.g=n[r];s=ya(o,i,!0,e)&&s}if(o=e.g=t,s=ya(o,i,!0,e)&&s,s=ya(o,i,!1,e)&&s,n)for(r=0;r<n.length;r++)o=e.g=n[r],s=ya(o,i,!1,e)&&s}Xe.prototype.N=function(){if(Xe.$.N.call(this),this.i){var t=this.i,e;for(e in t.g){for(var n=t.g[e],i=0;i<n.length;i++)hl(n[i]);delete t.g[e],t.h--}}this.J=null};Xe.prototype.O=function(t,e,n,i){return this.i.add(String(t),e,!1,n,i)};Xe.prototype.P=function(t,e,n,i){return this.i.add(String(t),e,!0,n,i)};function ya(t,e,n,i){if(e=t.i.g[String(e)],!e)return!0;e=e.concat();for(var s=!0,r=0;r<e.length;++r){var o=e[r];if(o&&!o.fa&&o.capture==n){var a=o.listener,c=o.la||o.src;o.ia&&fh(t.i,o),s=a.call(c,i)!==!1&&s}}return s&&!i.defaultPrevented}var Xd=Y.JSON.stringify;class H1{constructor(e,n){this.i=e,this.j=n,this.h=0,this.g=null}get(){let e;return 0<this.h?(this.h--,e=this.g,this.g=e.next,e.next=null):e=this.i(),e}}function K1(){var t=Jd;let e=null;return t.g&&(e=t.g,t.g=t.g.next,t.g||(t.h=null),e.next=null),e}class G1{constructor(){this.h=this.g=null}add(e,n){const i=PE.get();i.set(e,n),this.h?this.h.next=i:this.g=i,this.h=i}}var PE=new H1(()=>new Q1,t=>t.reset());class Q1{constructor(){this.next=this.g=this.h=null}set(e,n){this.h=e,this.g=n,this.next=null}reset(){this.next=this.g=this.h=null}}function Y1(t){var e=1;t=t.split(":");const n=[];for(;0<e&&t.length;)n.push(t.shift()),e--;return t.length&&n.push(t.join(":")),n}function X1(t){Y.setTimeout(()=>{throw t},0)}let _o,vo=!1,Jd=new G1,kE=()=>{const t=Y.Promise.resolve(void 0);_o=()=>{t.then(J1)}};var J1=()=>{for(var t;t=K1();){try{t.h.call(t.g)}catch(n){X1(n)}var e=PE;e.j(t),100>e.h&&(e.h++,t.next=e.g,e.g=t)}vo=!1};function fl(t,e){Xe.call(this),this.h=t||1,this.g=e||Y,this.j=vt(this.qb,this),this.l=Date.now()}Je(fl,Xe);L=fl.prototype;L.ga=!1;L.T=null;L.qb=function(){if(this.ga){var t=Date.now()-this.l;0<t&&t<.8*this.h?this.T=this.g.setTimeout(this.j,this.h-t):(this.T&&(this.g.clearTimeout(this.T),this.T=null),rt(this,"tick"),this.ga&&(Zd(this),this.start()))}};L.start=function(){this.ga=!0,this.T||(this.T=this.g.setTimeout(this.j,this.h),this.l=Date.now())};function Zd(t){t.ga=!1,t.T&&(t.g.clearTimeout(t.T),t.T=null)}L.N=function(){fl.$.N.call(this),Zd(this),delete this.g};function ef(t,e,n){if(typeof t=="function")n&&(t=vt(t,n));else if(t&&typeof t.handleEvent=="function")t=vt(t.handleEvent,t);else throw Error("Invalid listener argument");return 2147483647<Number(e)?-1:Y.setTimeout(t,e||0)}function NE(t){t.g=ef(()=>{t.g=null,t.i&&(t.i=!1,NE(t))},t.j);const e=t.h;t.h=null,t.m.apply(null,e)}class Z1 extends Ri{constructor(e,n){super(),this.m=e,this.j=n,this.h=null,this.i=!1,this.g=null}l(e){this.h=arguments,this.g?this.i=!0:NE(this)}N(){super.N(),this.g&&(Y.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function yo(t){Ri.call(this),this.h=t,this.g={}}Je(yo,Ri);var jm=[];function xE(t,e,n,i){Array.isArray(n)||(n&&(jm[0]=n.toString()),n=jm);for(var s=0;s<n.length;s++){var r=bE(e,n[s],i||t.handleEvent,!1,t.h||t);if(!r)break;t.g[r.key]=r}}function OE(t){Hd(t.g,function(e,n){this.g.hasOwnProperty(n)&&Gd(e)},t),t.g={}}yo.prototype.N=function(){yo.$.N.call(this),OE(this)};yo.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};function pl(){this.g=!0}pl.prototype.Ea=function(){this.g=!1};function eN(t,e,n,i,s,r){t.info(function(){if(t.g)if(r)for(var o="",a=r.split("&"),c=0;c<a.length;c++){var l=a[c].split("=");if(1<l.length){var u=l[0];l=l[1];var h=u.split("_");o=2<=h.length&&h[1]=="type"?o+(u+"="+l+"&"):o+(u+"=redacted&")}}else o=null;else o=r;return"XMLHTTP REQ ("+i+") [attempt "+s+"]: "+e+`
`+n+`
`+o})}function tN(t,e,n,i,s,r,o){t.info(function(){return"XMLHTTP RESP ("+i+") [ attempt "+s+"]: "+e+`
`+n+`
`+r+" "+o})}function Is(t,e,n,i){t.info(function(){return"XMLHTTP TEXT ("+e+"): "+iN(t,n)+(i?" "+i:"")})}function nN(t,e){t.info(function(){return"TIMEOUT: "+e})}pl.prototype.info=function(){};function iN(t,e){if(!t.g)return e;if(!e)return null;try{var n=JSON.parse(e);if(n){for(t=0;t<n.length;t++)if(Array.isArray(n[t])){var i=n[t];if(!(2>i.length)){var s=i[1];if(Array.isArray(s)&&!(1>s.length)){var r=s[0];if(r!="noop"&&r!="stop"&&r!="close")for(var o=1;o<s.length;o++)s[o]=""}}}}return Xd(n)}catch{return e}}var os={},Bm=null;function ml(){return Bm=Bm||new Xe}os.Ta="serverreachability";function DE(t){yt.call(this,os.Ta,t)}Je(DE,yt);function Eo(t){const e=ml();rt(e,new DE(e))}os.STAT_EVENT="statevent";function LE(t,e){yt.call(this,os.STAT_EVENT,t),this.stat=e}Je(LE,yt);function wt(t){const e=ml();rt(e,new LE(e,t))}os.Ua="timingevent";function ME(t,e){yt.call(this,os.Ua,t),this.size=e}Je(ME,yt);function Ho(t,e){if(typeof t!="function")throw Error("Fn must not be null and must be a function");return Y.setTimeout(function(){t()},e)}var gl={NO_ERROR:0,rb:1,Eb:2,Db:3,yb:4,Cb:5,Fb:6,Qa:7,TIMEOUT:8,Ib:9},qE={wb:"complete",Sb:"success",Ra:"error",Qa:"abort",Kb:"ready",Lb:"readystatechange",TIMEOUT:"timeout",Gb:"incrementaldata",Jb:"progress",zb:"downloadprogress",$b:"uploadprogress"};function tf(){}tf.prototype.h=null;function $m(t){return t.h||(t.h=t.i())}function VE(){}var Ko={OPEN:"a",vb:"b",Ra:"c",Hb:"d"};function nf(){yt.call(this,"d")}Je(nf,yt);function sf(){yt.call(this,"c")}Je(sf,yt);var mh;function _l(){}Je(_l,tf);_l.prototype.g=function(){return new XMLHttpRequest};_l.prototype.i=function(){return{}};mh=new _l;function Go(t,e,n,i){this.l=t,this.j=e,this.m=n,this.W=i||1,this.U=new yo(this),this.P=sN,t=uh?125:void 0,this.V=new fl(t),this.I=null,this.i=!1,this.s=this.A=this.v=this.L=this.G=this.Y=this.B=null,this.F=[],this.g=null,this.C=0,this.o=this.u=null,this.ca=-1,this.J=!1,this.O=0,this.M=null,this.ba=this.K=this.aa=this.S=!1,this.h=new FE}function FE(){this.i=null,this.g="",this.h=!1}var sN=45e3,gh={},yc={};L=Go.prototype;L.setTimeout=function(t){this.P=t};function _h(t,e,n){t.L=1,t.v=yl(Kn(e)),t.s=n,t.S=!0,UE(t,null)}function UE(t,e){t.G=Date.now(),Qo(t),t.A=Kn(t.v);var n=t.A,i=t.W;Array.isArray(i)||(i=[String(i)]),GE(n.i,"t",i),t.C=0,n=t.l.J,t.h=new FE,t.g=mT(t.l,n?e:null,!t.s),0<t.O&&(t.M=new Z1(vt(t.Pa,t,t.g),t.O)),xE(t.U,t.g,"readystatechange",t.nb),e=t.I?IE(t.I):{},t.s?(t.u||(t.u="POST"),e["Content-Type"]="application/x-www-form-urlencoded",t.g.ha(t.A,t.u,t.s,e)):(t.u="GET",t.g.ha(t.A,t.u,null,e)),Eo(),eN(t.j,t.u,t.A,t.m,t.W,t.s)}L.nb=function(t){t=t.target;const e=this.M;e&&_n(t)==3?e.l():this.Pa(t)};L.Pa=function(t){try{if(t==this.g)e:{const u=_n(this.g);var e=this.g.Ia();const h=this.g.da();if(!(3>u)&&(u!=3||uh||this.g&&(this.h.h||this.g.ja()||Gm(this.g)))){this.J||u!=4||e==7||(e==8||0>=h?Eo(3):Eo(2)),vl(this);var n=this.g.da();this.ca=n;t:if(zE(this)){var i=Gm(this.g);t="";var s=i.length,r=_n(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){qi(this),Wr(this);var o="";break t}this.h.i=new Y.TextDecoder}for(e=0;e<s;e++)this.h.h=!0,t+=this.h.i.decode(i[e],{stream:r&&e==s-1});i.splice(0,s),this.h.g+=t,this.C=0,o=this.h.g}else o=this.g.ja();if(this.i=n==200,tN(this.j,this.u,this.A,this.m,this.W,u,n),this.i){if(this.aa&&!this.K){t:{if(this.g){var a,c=this.g;if((a=c.g?c.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!mo(a)){var l=a;break t}}l=null}if(n=l)Is(this.j,this.m,n,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,vh(this,n);else{this.i=!1,this.o=3,wt(12),qi(this),Wr(this);break e}}this.S?(jE(this,u,o),uh&&this.i&&u==3&&(xE(this.U,this.V,"tick",this.mb),this.V.start())):(Is(this.j,this.m,o,null),vh(this,o)),u==4&&qi(this),this.i&&!this.J&&(u==4?hT(this.l,this):(this.i=!1,Qo(this)))}else RN(this.g),n==400&&0<o.indexOf("Unknown SID")?(this.o=3,wt(12)):(this.o=0,wt(13)),qi(this),Wr(this)}}}catch{}finally{}};function zE(t){return t.g?t.u=="GET"&&t.L!=2&&t.l.Ha:!1}function jE(t,e,n){let i=!0,s;for(;!t.J&&t.C<n.length;)if(s=rN(t,n),s==yc){e==4&&(t.o=4,wt(14),i=!1),Is(t.j,t.m,null,"[Incomplete Response]");break}else if(s==gh){t.o=4,wt(15),Is(t.j,t.m,n,"[Invalid Chunk]"),i=!1;break}else Is(t.j,t.m,s,null),vh(t,s);zE(t)&&s!=yc&&s!=gh&&(t.h.g="",t.C=0),e!=4||n.length!=0||t.h.h||(t.o=1,wt(16),i=!1),t.i=t.i&&i,i?0<n.length&&!t.ba&&(t.ba=!0,e=t.l,e.g==t&&e.ca&&!e.M&&(e.l.info("Great, no buffering proxy detected. Bytes received: "+n.length),uf(e),e.M=!0,wt(11))):(Is(t.j,t.m,n,"[Invalid Chunked Response]"),qi(t),Wr(t))}L.mb=function(){if(this.g){var t=_n(this.g),e=this.g.ja();this.C<e.length&&(vl(this),jE(this,t,e),this.i&&t!=4&&Qo(this))}};function rN(t,e){var n=t.C,i=e.indexOf(`
`,n);return i==-1?yc:(n=Number(e.substring(n,i)),isNaN(n)?gh:(i+=1,i+n>e.length?yc:(e=e.slice(i,i+n),t.C=i+n,e)))}L.cancel=function(){this.J=!0,qi(this)};function Qo(t){t.Y=Date.now()+t.P,BE(t,t.P)}function BE(t,e){if(t.B!=null)throw Error("WatchDog timer not null");t.B=Ho(vt(t.lb,t),e)}function vl(t){t.B&&(Y.clearTimeout(t.B),t.B=null)}L.lb=function(){this.B=null;const t=Date.now();0<=t-this.Y?(nN(this.j,this.A),this.L!=2&&(Eo(),wt(17)),qi(this),this.o=2,Wr(this)):BE(this,this.Y-t)};function Wr(t){t.l.H==0||t.J||hT(t.l,t)}function qi(t){vl(t);var e=t.M;e&&typeof e.sa=="function"&&e.sa(),t.M=null,Zd(t.V),OE(t.U),t.g&&(e=t.g,t.g=null,e.abort(),e.sa())}function vh(t,e){try{var n=t.l;if(n.H!=0&&(n.g==t||yh(n.i,t))){if(!t.K&&yh(n.i,t)&&n.H==3){try{var i=n.Ja.g.parse(e)}catch{i=null}if(Array.isArray(i)&&i.length==3){var s=i;if(s[0]==0){e:if(!n.u){if(n.g)if(n.g.G+3e3<t.G)Ic(n),Il(n);else break e;lf(n),wt(18)}}else n.Fa=s[1],0<n.Fa-n.V&&37500>s[2]&&n.G&&n.A==0&&!n.v&&(n.v=Ho(vt(n.ib,n),6e3));if(1>=XE(n.i)&&n.oa){try{n.oa()}catch{}n.oa=void 0}}else Vi(n,11)}else if((t.K||n.g==t)&&Ic(n),!mo(e))for(s=n.Ja.g.parse(e),e=0;e<s.length;e++){let l=s[e];if(n.V=l[0],l=l[1],n.H==2)if(l[0]=="c"){n.K=l[1],n.pa=l[2];const u=l[3];u!=null&&(n.ra=u,n.l.info("VER="+n.ra));const h=l[4];h!=null&&(n.Ga=h,n.l.info("SVER="+n.Ga));const d=l[5];d!=null&&typeof d=="number"&&0<d&&(i=1.5*d,n.L=i,n.l.info("backChannelRequestTimeoutMs_="+i)),i=n;const f=t.g;if(f){const g=f.g?f.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(g){var r=i.i;r.g||g.indexOf("spdy")==-1&&g.indexOf("quic")==-1&&g.indexOf("h2")==-1||(r.j=r.l,r.g=new Set,r.h&&(rf(r,r.h),r.h=null))}if(i.F){const v=f.g?f.g.getResponseHeader("X-HTTP-Session-Id"):null;v&&(i.Da=v,xe(i.I,i.F,v))}}n.H=3,n.h&&n.h.Ba(),n.ca&&(n.S=Date.now()-t.G,n.l.info("Handshake RTT: "+n.S+"ms")),i=n;var o=t;if(i.wa=pT(i,i.J?i.pa:null,i.Y),o.K){JE(i.i,o);var a=o,c=i.L;c&&a.setTimeout(c),a.B&&(vl(a),Qo(a)),i.g=o}else lT(i);0<n.j.length&&wl(n)}else l[0]!="stop"&&l[0]!="close"||Vi(n,7);else n.H==3&&(l[0]=="stop"||l[0]=="close"?l[0]=="stop"?Vi(n,7):cf(n):l[0]!="noop"&&n.h&&n.h.Aa(l),n.A=0)}}Eo(4)}catch{}}function oN(t){if(t.Z&&typeof t.Z=="function")return t.Z();if(typeof Map<"u"&&t instanceof Map||typeof Set<"u"&&t instanceof Set)return Array.from(t.values());if(typeof t=="string")return t.split("");if(ll(t)){for(var e=[],n=t.length,i=0;i<n;i++)e.push(t[i]);return e}e=[],n=0;for(i in t)e[n++]=t[i];return e}function aN(t){if(t.ta&&typeof t.ta=="function")return t.ta();if(!t.Z||typeof t.Z!="function"){if(typeof Map<"u"&&t instanceof Map)return Array.from(t.keys());if(!(typeof Set<"u"&&t instanceof Set)){if(ll(t)||typeof t=="string"){var e=[];t=t.length;for(var n=0;n<t;n++)e.push(n);return e}e=[],n=0;for(const i in t)e[n++]=i;return e}}}function $E(t,e){if(t.forEach&&typeof t.forEach=="function")t.forEach(e,void 0);else if(ll(t)||typeof t=="string")Array.prototype.forEach.call(t,e,void 0);else for(var n=aN(t),i=oN(t),s=i.length,r=0;r<s;r++)e.call(void 0,i[r],n&&n[r],t)}var WE=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function cN(t,e){if(t){t=t.split("&");for(var n=0;n<t.length;n++){var i=t[n].indexOf("="),s=null;if(0<=i){var r=t[n].substring(0,i);s=t[n].substring(i+1)}else r=t[n];e(r,s?decodeURIComponent(s.replace(/\+/g," ")):"")}}}function Hi(t){if(this.g=this.s=this.j="",this.m=null,this.o=this.l="",this.h=!1,t instanceof Hi){this.h=t.h,Ec(this,t.j),this.s=t.s,this.g=t.g,Tc(this,t.m),this.l=t.l;var e=t.i,n=new To;n.i=e.i,e.g&&(n.g=new Map(e.g),n.h=e.h),Wm(this,n),this.o=t.o}else t&&(e=String(t).match(WE))?(this.h=!1,Ec(this,e[1]||"",!0),this.s=xr(e[2]||""),this.g=xr(e[3]||"",!0),Tc(this,e[4]),this.l=xr(e[5]||"",!0),Wm(this,e[6]||"",!0),this.o=xr(e[7]||"")):(this.h=!1,this.i=new To(null,this.h))}Hi.prototype.toString=function(){var t=[],e=this.j;e&&t.push(Or(e,Hm,!0),":");var n=this.g;return(n||e=="file")&&(t.push("//"),(e=this.s)&&t.push(Or(e,Hm,!0),"@"),t.push(encodeURIComponent(String(n)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),n=this.m,n!=null&&t.push(":",String(n))),(n=this.l)&&(this.g&&n.charAt(0)!="/"&&t.push("/"),t.push(Or(n,n.charAt(0)=="/"?hN:uN,!0))),(n=this.i.toString())&&t.push("?",n),(n=this.o)&&t.push("#",Or(n,fN)),t.join("")};function Kn(t){return new Hi(t)}function Ec(t,e,n){t.j=n?xr(e,!0):e,t.j&&(t.j=t.j.replace(/:$/,""))}function Tc(t,e){if(e){if(e=Number(e),isNaN(e)||0>e)throw Error("Bad port number "+e);t.m=e}else t.m=null}function Wm(t,e,n){e instanceof To?(t.i=e,pN(t.i,t.h)):(n||(e=Or(e,dN)),t.i=new To(e,t.h))}function xe(t,e,n){t.i.set(e,n)}function yl(t){return xe(t,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),t}function xr(t,e){return t?e?decodeURI(t.replace(/%25/g,"%2525")):decodeURIComponent(t):""}function Or(t,e,n){return typeof t=="string"?(t=encodeURI(t).replace(e,lN),n&&(t=t.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),t):null}function lN(t){return t=t.charCodeAt(0),"%"+(t>>4&15).toString(16)+(t&15).toString(16)}var Hm=/[#\/\?@]/g,uN=/[#\?:]/g,hN=/[#\?]/g,dN=/[#\?@]/g,fN=/#/g;function To(t,e){this.h=this.g=null,this.i=t||null,this.j=!!e}function Ai(t){t.g||(t.g=new Map,t.h=0,t.i&&cN(t.i,function(e,n){t.add(decodeURIComponent(e.replace(/\+/g," ")),n)}))}L=To.prototype;L.add=function(t,e){Ai(this),this.i=null,t=hr(this,t);var n=this.g.get(t);return n||this.g.set(t,n=[]),n.push(e),this.h+=1,this};function HE(t,e){Ai(t),e=hr(t,e),t.g.has(e)&&(t.i=null,t.h-=t.g.get(e).length,t.g.delete(e))}function KE(t,e){return Ai(t),e=hr(t,e),t.g.has(e)}L.forEach=function(t,e){Ai(this),this.g.forEach(function(n,i){n.forEach(function(s){t.call(e,s,i,this)},this)},this)};L.ta=function(){Ai(this);const t=Array.from(this.g.values()),e=Array.from(this.g.keys()),n=[];for(let i=0;i<e.length;i++){const s=t[i];for(let r=0;r<s.length;r++)n.push(e[i])}return n};L.Z=function(t){Ai(this);let e=[];if(typeof t=="string")KE(this,t)&&(e=e.concat(this.g.get(hr(this,t))));else{t=Array.from(this.g.values());for(let n=0;n<t.length;n++)e=e.concat(t[n])}return e};L.set=function(t,e){return Ai(this),this.i=null,t=hr(this,t),KE(this,t)&&(this.h-=this.g.get(t).length),this.g.set(t,[e]),this.h+=1,this};L.get=function(t,e){return t?(t=this.Z(t),0<t.length?String(t[0]):e):e};function GE(t,e,n){HE(t,e),0<n.length&&(t.i=null,t.g.set(hr(t,e),$d(n)),t.h+=n.length)}L.toString=function(){if(this.i)return this.i;if(!this.g)return"";const t=[],e=Array.from(this.g.keys());for(var n=0;n<e.length;n++){var i=e[n];const r=encodeURIComponent(String(i)),o=this.Z(i);for(i=0;i<o.length;i++){var s=r;o[i]!==""&&(s+="="+encodeURIComponent(String(o[i]))),t.push(s)}}return this.i=t.join("&")};function hr(t,e){return e=String(e),t.j&&(e=e.toLowerCase()),e}function pN(t,e){e&&!t.j&&(Ai(t),t.i=null,t.g.forEach(function(n,i){var s=i.toLowerCase();i!=s&&(HE(this,i),GE(this,s,n))},t)),t.j=e}var mN=class{constructor(t,e){this.g=t,this.map=e}};function QE(t){this.l=t||gN,Y.PerformanceNavigationTiming?(t=Y.performance.getEntriesByType("navigation"),t=0<t.length&&(t[0].nextHopProtocol=="hq"||t[0].nextHopProtocol=="h2")):t=!!(Y.g&&Y.g.Ka&&Y.g.Ka()&&Y.g.Ka().dc),this.j=t?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}var gN=10;function YE(t){return t.h?!0:t.g?t.g.size>=t.j:!1}function XE(t){return t.h?1:t.g?t.g.size:0}function yh(t,e){return t.h?t.h==e:t.g?t.g.has(e):!1}function rf(t,e){t.g?t.g.add(e):t.h=e}function JE(t,e){t.h&&t.h==e?t.h=null:t.g&&t.g.has(e)&&t.g.delete(e)}QE.prototype.cancel=function(){if(this.i=ZE(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const t of this.g.values())t.cancel();this.g.clear()}};function ZE(t){if(t.h!=null)return t.i.concat(t.h.F);if(t.g!=null&&t.g.size!==0){let e=t.i;for(const n of t.g.values())e=e.concat(n.F);return e}return $d(t.i)}var _N=class{stringify(t){return Y.JSON.stringify(t,void 0)}parse(t){return Y.JSON.parse(t,void 0)}};function vN(){this.g=new _N}function yN(t,e,n){const i=n||"";try{$E(t,function(s,r){let o=s;$o(s)&&(o=Xd(s)),e.push(i+r+"="+encodeURIComponent(o))})}catch(s){throw e.push(i+"type="+encodeURIComponent("_badmap")),s}}function EN(t,e){const n=new pl;if(Y.Image){const i=new Image;i.onload=va(Ea,n,i,"TestLoadImage: loaded",!0,e),i.onerror=va(Ea,n,i,"TestLoadImage: error",!1,e),i.onabort=va(Ea,n,i,"TestLoadImage: abort",!1,e),i.ontimeout=va(Ea,n,i,"TestLoadImage: timeout",!1,e),Y.setTimeout(function(){i.ontimeout&&i.ontimeout()},1e4),i.src=t}else e(!1)}function Ea(t,e,n,i,s){try{e.onload=null,e.onerror=null,e.onabort=null,e.ontimeout=null,s(i)}catch{}}function Yo(t){this.l=t.ec||null,this.j=t.ob||!1}Je(Yo,tf);Yo.prototype.g=function(){return new El(this.l,this.j)};Yo.prototype.i=function(t){return function(){return t}}({});function El(t,e){Xe.call(this),this.F=t,this.u=e,this.m=void 0,this.readyState=of,this.status=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.v=new Headers,this.h=null,this.C="GET",this.B="",this.g=!1,this.A=this.j=this.l=null}Je(El,Xe);var of=0;L=El.prototype;L.open=function(t,e){if(this.readyState!=of)throw this.abort(),Error("Error reopening a connection");this.C=t,this.B=e,this.readyState=1,Io(this)};L.send=function(t){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const e={headers:this.v,method:this.C,credentials:this.m,cache:void 0};t&&(e.body=t),(this.F||Y).fetch(new Request(this.B,e)).then(this.$a.bind(this),this.ka.bind(this))};L.abort=function(){this.response=this.responseText="",this.v=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Xo(this)),this.readyState=of};L.$a=function(t){if(this.g&&(this.l=t,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=t.headers,this.readyState=2,Io(this)),this.g&&(this.readyState=3,Io(this),this.g)))if(this.responseType==="arraybuffer")t.arrayBuffer().then(this.Ya.bind(this),this.ka.bind(this));else if(typeof Y.ReadableStream<"u"&&"body"in t){if(this.j=t.body.getReader(),this.u){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.A=new TextDecoder;eT(this)}else t.text().then(this.Za.bind(this),this.ka.bind(this))};function eT(t){t.j.read().then(t.Xa.bind(t)).catch(t.ka.bind(t))}L.Xa=function(t){if(this.g){if(this.u&&t.value)this.response.push(t.value);else if(!this.u){var e=t.value?t.value:new Uint8Array(0);(e=this.A.decode(e,{stream:!t.done}))&&(this.response=this.responseText+=e)}t.done?Xo(this):Io(this),this.readyState==3&&eT(this)}};L.Za=function(t){this.g&&(this.response=this.responseText=t,Xo(this))};L.Ya=function(t){this.g&&(this.response=t,Xo(this))};L.ka=function(){this.g&&Xo(this)};function Xo(t){t.readyState=4,t.l=null,t.j=null,t.A=null,Io(t)}L.setRequestHeader=function(t,e){this.v.append(t,e)};L.getResponseHeader=function(t){return this.h&&this.h.get(t.toLowerCase())||""};L.getAllResponseHeaders=function(){if(!this.h)return"";const t=[],e=this.h.entries();for(var n=e.next();!n.done;)n=n.value,t.push(n[0]+": "+n[1]),n=e.next();return t.join(`\r
`)};function Io(t){t.onreadystatechange&&t.onreadystatechange.call(t)}Object.defineProperty(El.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(t){this.m=t?"include":"same-origin"}});var TN=Y.JSON.parse;function Ve(t){Xe.call(this),this.headers=new Map,this.u=t||null,this.h=!1,this.C=this.g=null,this.I="",this.m=0,this.j="",this.l=this.G=this.v=this.F=!1,this.B=0,this.A=null,this.K=tT,this.L=this.M=!1}Je(Ve,Xe);var tT="",IN=/^https?$/i,wN=["POST","PUT"];L=Ve.prototype;L.Oa=function(t){this.M=t};L.ha=function(t,e,n,i){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.I+"; newUri="+t);e=e?e.toUpperCase():"GET",this.I=t,this.j="",this.m=0,this.F=!1,this.h=!0,this.g=this.u?this.u.g():mh.g(),this.C=this.u?$m(this.u):$m(mh),this.g.onreadystatechange=vt(this.La,this);try{this.G=!0,this.g.open(e,String(t),!0),this.G=!1}catch(r){Km(this,r);return}if(t=n||"",n=new Map(this.headers),i)if(Object.getPrototypeOf(i)===Object.prototype)for(var s in i)n.set(s,i[s]);else if(typeof i.keys=="function"&&typeof i.get=="function")for(const r of i.keys())n.set(r,i.get(r));else throw Error("Unknown input type for opt_headers: "+String(i));i=Array.from(n.keys()).find(r=>r.toLowerCase()=="content-type"),s=Y.FormData&&t instanceof Y.FormData,!(0<=vE(wN,e))||i||s||n.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[r,o]of n)this.g.setRequestHeader(r,o);this.K&&(this.g.responseType=this.K),"withCredentials"in this.g&&this.g.withCredentials!==this.M&&(this.g.withCredentials=this.M);try{sT(this),0<this.B&&((this.L=bN(this.g))?(this.g.timeout=this.B,this.g.ontimeout=vt(this.ua,this)):this.A=ef(this.ua,this.B,this)),this.v=!0,this.g.send(t),this.v=!1}catch(r){Km(this,r)}};function bN(t){return Bs&&typeof t.timeout=="number"&&t.ontimeout!==void 0}L.ua=function(){typeof Bd<"u"&&this.g&&(this.j="Timed out after "+this.B+"ms, aborting",this.m=8,rt(this,"timeout"),this.abort(8))};function Km(t,e){t.h=!1,t.g&&(t.l=!0,t.g.abort(),t.l=!1),t.j=e,t.m=5,nT(t),Tl(t)}function nT(t){t.F||(t.F=!0,rt(t,"complete"),rt(t,"error"))}L.abort=function(t){this.g&&this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1,this.m=t||7,rt(this,"complete"),rt(this,"abort"),Tl(this))};L.N=function(){this.g&&(this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1),Tl(this,!0)),Ve.$.N.call(this)};L.La=function(){this.s||(this.G||this.v||this.l?iT(this):this.kb())};L.kb=function(){iT(this)};function iT(t){if(t.h&&typeof Bd<"u"&&(!t.C[1]||_n(t)!=4||t.da()!=2)){if(t.v&&_n(t)==4)ef(t.La,0,t);else if(rt(t,"readystatechange"),_n(t)==4){t.h=!1;try{const o=t.da();e:switch(o){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var e=!0;break e;default:e=!1}var n;if(!(n=e)){var i;if(i=o===0){var s=String(t.I).match(WE)[1]||null;!s&&Y.self&&Y.self.location&&(s=Y.self.location.protocol.slice(0,-1)),i=!IN.test(s?s.toLowerCase():"")}n=i}if(n)rt(t,"complete"),rt(t,"success");else{t.m=6;try{var r=2<_n(t)?t.g.statusText:""}catch{r=""}t.j=r+" ["+t.da()+"]",nT(t)}}finally{Tl(t)}}}}function Tl(t,e){if(t.g){sT(t);const n=t.g,i=t.C[0]?()=>{}:null;t.g=null,t.C=null,e||rt(t,"ready");try{n.onreadystatechange=i}catch{}}}function sT(t){t.g&&t.L&&(t.g.ontimeout=null),t.A&&(Y.clearTimeout(t.A),t.A=null)}L.isActive=function(){return!!this.g};function _n(t){return t.g?t.g.readyState:0}L.da=function(){try{return 2<_n(this)?this.g.status:-1}catch{return-1}};L.ja=function(){try{return this.g?this.g.responseText:""}catch{return""}};L.Wa=function(t){if(this.g){var e=this.g.responseText;return t&&e.indexOf(t)==0&&(e=e.substring(t.length)),TN(e)}};function Gm(t){try{if(!t.g)return null;if("response"in t.g)return t.g.response;switch(t.K){case tT:case"text":return t.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in t.g)return t.g.mozResponseArrayBuffer}return null}catch{return null}}function RN(t){const e={};t=(t.g&&2<=_n(t)&&t.g.getAllResponseHeaders()||"").split(`\r
`);for(let i=0;i<t.length;i++){if(mo(t[i]))continue;var n=Y1(t[i]);const s=n[0];if(n=n[1],typeof n!="string")continue;n=n.trim();const r=e[s]||[];e[s]=r,r.push(n)}B1(e,function(i){return i.join(", ")})}L.Ia=function(){return this.m};L.Sa=function(){return typeof this.j=="string"?this.j:String(this.j)};function rT(t){let e="";return Hd(t,function(n,i){e+=i,e+=":",e+=n,e+=`\r
`}),e}function af(t,e,n){e:{for(i in n){var i=!1;break e}i=!0}i||(n=rT(n),typeof t=="string"?n!=null&&encodeURIComponent(String(n)):xe(t,e,n))}function wr(t,e,n){return n&&n.internalChannelParams&&n.internalChannelParams[t]||e}function oT(t){this.Ga=0,this.j=[],this.l=new pl,this.pa=this.wa=this.I=this.Y=this.g=this.Da=this.F=this.na=this.o=this.U=this.s=null,this.fb=this.W=0,this.cb=wr("failFast",!1,t),this.G=this.v=this.u=this.m=this.h=null,this.aa=!0,this.Fa=this.V=-1,this.ba=this.A=this.C=0,this.ab=wr("baseRetryDelayMs",5e3,t),this.hb=wr("retryDelaySeedMs",1e4,t),this.eb=wr("forwardChannelMaxRetries",2,t),this.xa=wr("forwardChannelRequestTimeoutMs",2e4,t),this.va=t&&t.xmlHttpFactory||void 0,this.Ha=t&&t.useFetchStreams||!1,this.L=void 0,this.J=t&&t.supportsCrossDomainXhr||!1,this.K="",this.i=new QE(t&&t.concurrentRequestLimit),this.Ja=new vN,this.P=t&&t.fastHandshake||!1,this.O=t&&t.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.bb=t&&t.bc||!1,t&&t.Ea&&this.l.Ea(),t&&t.forceLongPolling&&(this.aa=!1),this.ca=!this.P&&this.aa&&t&&t.detectBufferingProxy||!1,this.qa=void 0,t&&t.longPollingTimeout&&0<t.longPollingTimeout&&(this.qa=t.longPollingTimeout),this.oa=void 0,this.S=0,this.M=!1,this.ma=this.B=null}L=oT.prototype;L.ra=8;L.H=1;function cf(t){if(aT(t),t.H==3){var e=t.W++,n=Kn(t.I);if(xe(n,"SID",t.K),xe(n,"RID",e),xe(n,"TYPE","terminate"),Jo(t,n),e=new Go(t,t.l,e),e.L=2,e.v=yl(Kn(n)),n=!1,Y.navigator&&Y.navigator.sendBeacon)try{n=Y.navigator.sendBeacon(e.v.toString(),"")}catch{}!n&&Y.Image&&(new Image().src=e.v,n=!0),n||(e.g=mT(e.l,null),e.g.ha(e.v)),e.G=Date.now(),Qo(e)}fT(t)}function Il(t){t.g&&(uf(t),t.g.cancel(),t.g=null)}function aT(t){Il(t),t.u&&(Y.clearTimeout(t.u),t.u=null),Ic(t),t.i.cancel(),t.m&&(typeof t.m=="number"&&Y.clearTimeout(t.m),t.m=null)}function wl(t){if(!YE(t.i)&&!t.m){t.m=!0;var e=t.Na;_o||kE(),vo||(_o(),vo=!0),Jd.add(e,t),t.C=0}}function AN(t,e){return XE(t.i)>=t.i.j-(t.m?1:0)?!1:t.m?(t.j=e.F.concat(t.j),!0):t.H==1||t.H==2||t.C>=(t.cb?0:t.eb)?!1:(t.m=Ho(vt(t.Na,t,e),dT(t,t.C)),t.C++,!0)}L.Na=function(t){if(this.m)if(this.m=null,this.H==1){if(!t){this.W=Math.floor(1e5*Math.random()),t=this.W++;const s=new Go(this,this.l,t);let r=this.s;if(this.U&&(r?(r=IE(r),wE(r,this.U)):r=this.U),this.o!==null||this.O||(s.I=r,r=null),this.P)e:{for(var e=0,n=0;n<this.j.length;n++){t:{var i=this.j[n];if("__data__"in i.map&&(i=i.map.__data__,typeof i=="string")){i=i.length;break t}i=void 0}if(i===void 0)break;if(e+=i,4096<e){e=n;break e}if(e===4096||n===this.j.length-1){e=n+1;break e}}e=1e3}else e=1e3;e=cT(this,s,e),n=Kn(this.I),xe(n,"RID",t),xe(n,"CVER",22),this.F&&xe(n,"X-HTTP-Session-Id",this.F),Jo(this,n),r&&(this.O?e="headers="+encodeURIComponent(String(rT(r)))+"&"+e:this.o&&af(n,this.o,r)),rf(this.i,s),this.bb&&xe(n,"TYPE","init"),this.P?(xe(n,"$req",e),xe(n,"SID","null"),s.aa=!0,_h(s,n,null)):_h(s,n,e),this.H=2}}else this.H==3&&(t?Qm(this,t):this.j.length==0||YE(this.i)||Qm(this))};function Qm(t,e){var n;e?n=e.m:n=t.W++;const i=Kn(t.I);xe(i,"SID",t.K),xe(i,"RID",n),xe(i,"AID",t.V),Jo(t,i),t.o&&t.s&&af(i,t.o,t.s),n=new Go(t,t.l,n,t.C+1),t.o===null&&(n.I=t.s),e&&(t.j=e.F.concat(t.j)),e=cT(t,n,1e3),n.setTimeout(Math.round(.5*t.xa)+Math.round(.5*t.xa*Math.random())),rf(t.i,n),_h(n,i,e)}function Jo(t,e){t.na&&Hd(t.na,function(n,i){xe(e,i,n)}),t.h&&$E({},function(n,i){xe(e,i,n)})}function cT(t,e,n){n=Math.min(t.j.length,n);var i=t.h?vt(t.h.Va,t.h,t):null;e:{var s=t.j;let r=-1;for(;;){const o=["count="+n];r==-1?0<n?(r=s[0].g,o.push("ofs="+r)):r=0:o.push("ofs="+r);let a=!0;for(let c=0;c<n;c++){let l=s[c].g;const u=s[c].map;if(l-=r,0>l)r=Math.max(0,s[c].g-100),a=!1;else try{yN(u,o,"req"+l+"_")}catch{i&&i(u)}}if(a){i=o.join("&");break e}}}return t=t.j.splice(0,n),e.F=t,i}function lT(t){if(!t.g&&!t.u){t.ba=1;var e=t.Ma;_o||kE(),vo||(_o(),vo=!0),Jd.add(e,t),t.A=0}}function lf(t){return t.g||t.u||3<=t.A?!1:(t.ba++,t.u=Ho(vt(t.Ma,t),dT(t,t.A)),t.A++,!0)}L.Ma=function(){if(this.u=null,uT(this),this.ca&&!(this.M||this.g==null||0>=this.S)){var t=2*this.S;this.l.info("BP detection timer enabled: "+t),this.B=Ho(vt(this.jb,this),t)}};L.jb=function(){this.B&&(this.B=null,this.l.info("BP detection timeout reached."),this.l.info("Buffering proxy detected and switch to long-polling!"),this.G=!1,this.M=!0,wt(10),Il(this),uT(this))};function uf(t){t.B!=null&&(Y.clearTimeout(t.B),t.B=null)}function uT(t){t.g=new Go(t,t.l,"rpc",t.ba),t.o===null&&(t.g.I=t.s),t.g.O=0;var e=Kn(t.wa);xe(e,"RID","rpc"),xe(e,"SID",t.K),xe(e,"AID",t.V),xe(e,"CI",t.G?"0":"1"),!t.G&&t.qa&&xe(e,"TO",t.qa),xe(e,"TYPE","xmlhttp"),Jo(t,e),t.o&&t.s&&af(e,t.o,t.s),t.L&&t.g.setTimeout(t.L);var n=t.g;t=t.pa,n.L=1,n.v=yl(Kn(e)),n.s=null,n.S=!0,UE(n,t)}L.ib=function(){this.v!=null&&(this.v=null,Il(this),lf(this),wt(19))};function Ic(t){t.v!=null&&(Y.clearTimeout(t.v),t.v=null)}function hT(t,e){var n=null;if(t.g==e){Ic(t),uf(t),t.g=null;var i=2}else if(yh(t.i,e))n=e.F,JE(t.i,e),i=1;else return;if(t.H!=0){if(e.i)if(i==1){n=e.s?e.s.length:0,e=Date.now()-e.G;var s=t.C;i=ml(),rt(i,new ME(i,n)),wl(t)}else lT(t);else if(s=e.o,s==3||s==0&&0<e.ca||!(i==1&&AN(t,e)||i==2&&lf(t)))switch(n&&0<n.length&&(e=t.i,e.i=e.i.concat(n)),s){case 1:Vi(t,5);break;case 4:Vi(t,10);break;case 3:Vi(t,6);break;default:Vi(t,2)}}}function dT(t,e){let n=t.ab+Math.floor(Math.random()*t.hb);return t.isActive()||(n*=2),n*e}function Vi(t,e){if(t.l.info("Error code "+e),e==2){var n=null;t.h&&(n=null);var i=vt(t.pb,t);n||(n=new Hi("//www.google.com/images/cleardot.gif"),Y.location&&Y.location.protocol=="http"||Ec(n,"https"),yl(n)),EN(n.toString(),i)}else wt(2);t.H=0,t.h&&t.h.za(e),fT(t),aT(t)}L.pb=function(t){t?(this.l.info("Successfully pinged google.com"),wt(2)):(this.l.info("Failed to ping google.com"),wt(1))};function fT(t){if(t.H=0,t.ma=[],t.h){const e=ZE(t.i);(e.length!=0||t.j.length!=0)&&(Fm(t.ma,e),Fm(t.ma,t.j),t.i.i.length=0,$d(t.j),t.j.length=0),t.h.ya()}}function pT(t,e,n){var i=n instanceof Hi?Kn(n):new Hi(n);if(i.g!="")e&&(i.g=e+"."+i.g),Tc(i,i.m);else{var s=Y.location;i=s.protocol,e=e?e+"."+s.hostname:s.hostname,s=+s.port;var r=new Hi(null);i&&Ec(r,i),e&&(r.g=e),s&&Tc(r,s),n&&(r.l=n),i=r}return n=t.F,e=t.Da,n&&e&&xe(i,n,e),xe(i,"VER",t.ra),Jo(t,i),i}function mT(t,e,n){if(e&&!t.J)throw Error("Can't create secondary domain capable XhrIo object.");return e=n&&t.Ha&&!t.va?new Ve(new Yo({ob:!0})):new Ve(t.va),e.Oa(t.J),e}L.isActive=function(){return!!this.h&&this.h.isActive(this)};function gT(){}L=gT.prototype;L.Ba=function(){};L.Aa=function(){};L.za=function(){};L.ya=function(){};L.isActive=function(){return!0};L.Va=function(){};function wc(){if(Bs&&!(10<=Number(F1)))throw Error("Environmental error: no available transport.")}wc.prototype.g=function(t,e){return new Mt(t,e)};function Mt(t,e){Xe.call(this),this.g=new oT(e),this.l=t,this.h=e&&e.messageUrlParams||null,t=e&&e.messageHeaders||null,e&&e.clientProtocolHeaderRequired&&(t?t["X-Client-Protocol"]="webchannel":t={"X-Client-Protocol":"webchannel"}),this.g.s=t,t=e&&e.initMessageHeaders||null,e&&e.messageContentType&&(t?t["X-WebChannel-Content-Type"]=e.messageContentType:t={"X-WebChannel-Content-Type":e.messageContentType}),e&&e.Ca&&(t?t["X-WebChannel-Client-Profile"]=e.Ca:t={"X-WebChannel-Client-Profile":e.Ca}),this.g.U=t,(t=e&&e.cc)&&!mo(t)&&(this.g.o=t),this.A=e&&e.supportsCrossDomainXhr||!1,this.v=e&&e.sendRawJson||!1,(e=e&&e.httpSessionIdParam)&&!mo(e)&&(this.g.F=e,t=this.h,t!==null&&e in t&&(t=this.h,e in t&&delete t[e])),this.j=new dr(this)}Je(Mt,Xe);Mt.prototype.m=function(){this.g.h=this.j,this.A&&(this.g.J=!0);var t=this.g,e=this.l,n=this.h||void 0;wt(0),t.Y=e,t.na=n||{},t.G=t.aa,t.I=pT(t,null,t.Y),wl(t)};Mt.prototype.close=function(){cf(this.g)};Mt.prototype.u=function(t){var e=this.g;if(typeof t=="string"){var n={};n.__data__=t,t=n}else this.v&&(n={},n.__data__=Xd(t),t=n);e.j.push(new mN(e.fb++,t)),e.H==3&&wl(e)};Mt.prototype.N=function(){this.g.h=null,delete this.j,cf(this.g),delete this.g,Mt.$.N.call(this)};function _T(t){nf.call(this),t.__headers__&&(this.headers=t.__headers__,this.statusCode=t.__status__,delete t.__headers__,delete t.__status__);var e=t.__sm__;if(e){e:{for(const n in e){t=n;break e}t=void 0}(this.i=t)&&(t=this.i,e=e!==null&&t in e?e[t]:void 0),this.data=e}else this.data=t}Je(_T,nf);function vT(){sf.call(this),this.status=1}Je(vT,sf);function dr(t){this.g=t}Je(dr,gT);dr.prototype.Ba=function(){rt(this.g,"a")};dr.prototype.Aa=function(t){rt(this.g,new _T(t))};dr.prototype.za=function(t){rt(this.g,new vT)};dr.prototype.ya=function(){rt(this.g,"b")};function CN(){this.blockSize=-1}function rn(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.m=Array(this.blockSize),this.i=this.h=0,this.reset()}Je(rn,CN);rn.prototype.reset=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.i=this.h=0};function du(t,e,n){n||(n=0);var i=Array(16);if(typeof e=="string")for(var s=0;16>s;++s)i[s]=e.charCodeAt(n++)|e.charCodeAt(n++)<<8|e.charCodeAt(n++)<<16|e.charCodeAt(n++)<<24;else for(s=0;16>s;++s)i[s]=e[n++]|e[n++]<<8|e[n++]<<16|e[n++]<<24;e=t.g[0],n=t.g[1],s=t.g[2];var r=t.g[3],o=e+(r^n&(s^r))+i[0]+3614090360&4294967295;e=n+(o<<7&4294967295|o>>>25),o=r+(s^e&(n^s))+i[1]+3905402710&4294967295,r=e+(o<<12&4294967295|o>>>20),o=s+(n^r&(e^n))+i[2]+606105819&4294967295,s=r+(o<<17&4294967295|o>>>15),o=n+(e^s&(r^e))+i[3]+3250441966&4294967295,n=s+(o<<22&4294967295|o>>>10),o=e+(r^n&(s^r))+i[4]+4118548399&4294967295,e=n+(o<<7&4294967295|o>>>25),o=r+(s^e&(n^s))+i[5]+1200080426&4294967295,r=e+(o<<12&4294967295|o>>>20),o=s+(n^r&(e^n))+i[6]+2821735955&4294967295,s=r+(o<<17&4294967295|o>>>15),o=n+(e^s&(r^e))+i[7]+4249261313&4294967295,n=s+(o<<22&4294967295|o>>>10),o=e+(r^n&(s^r))+i[8]+1770035416&4294967295,e=n+(o<<7&4294967295|o>>>25),o=r+(s^e&(n^s))+i[9]+2336552879&4294967295,r=e+(o<<12&4294967295|o>>>20),o=s+(n^r&(e^n))+i[10]+4294925233&4294967295,s=r+(o<<17&4294967295|o>>>15),o=n+(e^s&(r^e))+i[11]+2304563134&4294967295,n=s+(o<<22&4294967295|o>>>10),o=e+(r^n&(s^r))+i[12]+1804603682&4294967295,e=n+(o<<7&4294967295|o>>>25),o=r+(s^e&(n^s))+i[13]+4254626195&4294967295,r=e+(o<<12&4294967295|o>>>20),o=s+(n^r&(e^n))+i[14]+2792965006&4294967295,s=r+(o<<17&4294967295|o>>>15),o=n+(e^s&(r^e))+i[15]+1236535329&4294967295,n=s+(o<<22&4294967295|o>>>10),o=e+(s^r&(n^s))+i[1]+4129170786&4294967295,e=n+(o<<5&4294967295|o>>>27),o=r+(n^s&(e^n))+i[6]+3225465664&4294967295,r=e+(o<<9&4294967295|o>>>23),o=s+(e^n&(r^e))+i[11]+643717713&4294967295,s=r+(o<<14&4294967295|o>>>18),o=n+(r^e&(s^r))+i[0]+3921069994&4294967295,n=s+(o<<20&4294967295|o>>>12),o=e+(s^r&(n^s))+i[5]+3593408605&4294967295,e=n+(o<<5&4294967295|o>>>27),o=r+(n^s&(e^n))+i[10]+38016083&4294967295,r=e+(o<<9&4294967295|o>>>23),o=s+(e^n&(r^e))+i[15]+3634488961&4294967295,s=r+(o<<14&4294967295|o>>>18),o=n+(r^e&(s^r))+i[4]+3889429448&4294967295,n=s+(o<<20&4294967295|o>>>12),o=e+(s^r&(n^s))+i[9]+568446438&4294967295,e=n+(o<<5&4294967295|o>>>27),o=r+(n^s&(e^n))+i[14]+3275163606&4294967295,r=e+(o<<9&4294967295|o>>>23),o=s+(e^n&(r^e))+i[3]+4107603335&4294967295,s=r+(o<<14&4294967295|o>>>18),o=n+(r^e&(s^r))+i[8]+1163531501&4294967295,n=s+(o<<20&4294967295|o>>>12),o=e+(s^r&(n^s))+i[13]+2850285829&4294967295,e=n+(o<<5&4294967295|o>>>27),o=r+(n^s&(e^n))+i[2]+4243563512&4294967295,r=e+(o<<9&4294967295|o>>>23),o=s+(e^n&(r^e))+i[7]+1735328473&4294967295,s=r+(o<<14&4294967295|o>>>18),o=n+(r^e&(s^r))+i[12]+2368359562&4294967295,n=s+(o<<20&4294967295|o>>>12),o=e+(n^s^r)+i[5]+4294588738&4294967295,e=n+(o<<4&4294967295|o>>>28),o=r+(e^n^s)+i[8]+2272392833&4294967295,r=e+(o<<11&4294967295|o>>>21),o=s+(r^e^n)+i[11]+1839030562&4294967295,s=r+(o<<16&4294967295|o>>>16),o=n+(s^r^e)+i[14]+4259657740&4294967295,n=s+(o<<23&4294967295|o>>>9),o=e+(n^s^r)+i[1]+2763975236&4294967295,e=n+(o<<4&4294967295|o>>>28),o=r+(e^n^s)+i[4]+1272893353&4294967295,r=e+(o<<11&4294967295|o>>>21),o=s+(r^e^n)+i[7]+4139469664&4294967295,s=r+(o<<16&4294967295|o>>>16),o=n+(s^r^e)+i[10]+3200236656&4294967295,n=s+(o<<23&4294967295|o>>>9),o=e+(n^s^r)+i[13]+681279174&4294967295,e=n+(o<<4&4294967295|o>>>28),o=r+(e^n^s)+i[0]+3936430074&4294967295,r=e+(o<<11&4294967295|o>>>21),o=s+(r^e^n)+i[3]+3572445317&4294967295,s=r+(o<<16&4294967295|o>>>16),o=n+(s^r^e)+i[6]+76029189&4294967295,n=s+(o<<23&4294967295|o>>>9),o=e+(n^s^r)+i[9]+3654602809&4294967295,e=n+(o<<4&4294967295|o>>>28),o=r+(e^n^s)+i[12]+3873151461&4294967295,r=e+(o<<11&4294967295|o>>>21),o=s+(r^e^n)+i[15]+530742520&4294967295,s=r+(o<<16&4294967295|o>>>16),o=n+(s^r^e)+i[2]+3299628645&4294967295,n=s+(o<<23&4294967295|o>>>9),o=e+(s^(n|~r))+i[0]+4096336452&4294967295,e=n+(o<<6&4294967295|o>>>26),o=r+(n^(e|~s))+i[7]+1126891415&4294967295,r=e+(o<<10&4294967295|o>>>22),o=s+(e^(r|~n))+i[14]+2878612391&4294967295,s=r+(o<<15&4294967295|o>>>17),o=n+(r^(s|~e))+i[5]+4237533241&4294967295,n=s+(o<<21&4294967295|o>>>11),o=e+(s^(n|~r))+i[12]+1700485571&4294967295,e=n+(o<<6&4294967295|o>>>26),o=r+(n^(e|~s))+i[3]+2399980690&4294967295,r=e+(o<<10&4294967295|o>>>22),o=s+(e^(r|~n))+i[10]+4293915773&4294967295,s=r+(o<<15&4294967295|o>>>17),o=n+(r^(s|~e))+i[1]+2240044497&4294967295,n=s+(o<<21&4294967295|o>>>11),o=e+(s^(n|~r))+i[8]+1873313359&4294967295,e=n+(o<<6&4294967295|o>>>26),o=r+(n^(e|~s))+i[15]+4264355552&4294967295,r=e+(o<<10&4294967295|o>>>22),o=s+(e^(r|~n))+i[6]+2734768916&4294967295,s=r+(o<<15&4294967295|o>>>17),o=n+(r^(s|~e))+i[13]+1309151649&4294967295,n=s+(o<<21&4294967295|o>>>11),o=e+(s^(n|~r))+i[4]+4149444226&4294967295,e=n+(o<<6&4294967295|o>>>26),o=r+(n^(e|~s))+i[11]+3174756917&4294967295,r=e+(o<<10&4294967295|o>>>22),o=s+(e^(r|~n))+i[2]+718787259&4294967295,s=r+(o<<15&4294967295|o>>>17),o=n+(r^(s|~e))+i[9]+3951481745&4294967295,t.g[0]=t.g[0]+e&4294967295,t.g[1]=t.g[1]+(s+(o<<21&4294967295|o>>>11))&4294967295,t.g[2]=t.g[2]+s&4294967295,t.g[3]=t.g[3]+r&4294967295}rn.prototype.j=function(t,e){e===void 0&&(e=t.length);for(var n=e-this.blockSize,i=this.m,s=this.h,r=0;r<e;){if(s==0)for(;r<=n;)du(this,t,r),r+=this.blockSize;if(typeof t=="string"){for(;r<e;)if(i[s++]=t.charCodeAt(r++),s==this.blockSize){du(this,i),s=0;break}}else for(;r<e;)if(i[s++]=t[r++],s==this.blockSize){du(this,i),s=0;break}}this.h=s,this.i+=e};rn.prototype.l=function(){var t=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);t[0]=128;for(var e=1;e<t.length-8;++e)t[e]=0;var n=8*this.i;for(e=t.length-8;e<t.length;++e)t[e]=n&255,n/=256;for(this.j(t),t=Array(16),e=n=0;4>e;++e)for(var i=0;32>i;i+=8)t[n++]=this.g[e]>>>i&255;return t};function Te(t,e){this.h=e;for(var n=[],i=!0,s=t.length-1;0<=s;s--){var r=t[s]|0;i&&r==e||(n[s]=r,i=!1)}this.g=n}var SN={};function hf(t){return-128<=t&&128>t?M1(t,function(e){return new Te([e|0],0>e?-1:0)}):new Te([t|0],0>t?-1:0)}function vn(t){if(isNaN(t)||!isFinite(t))return xs;if(0>t)return nt(vn(-t));for(var e=[],n=1,i=0;t>=n;i++)e[i]=t/n|0,n*=Eh;return new Te(e,0)}function yT(t,e){if(t.length==0)throw Error("number format error: empty string");if(e=e||10,2>e||36<e)throw Error("radix out of range: "+e);if(t.charAt(0)=="-")return nt(yT(t.substring(1),e));if(0<=t.indexOf("-"))throw Error('number format error: interior "-" character');for(var n=vn(Math.pow(e,8)),i=xs,s=0;s<t.length;s+=8){var r=Math.min(8,t.length-s),o=parseInt(t.substring(s,s+r),e);8>r?(r=vn(Math.pow(e,r)),i=i.R(r).add(vn(o))):(i=i.R(n),i=i.add(vn(o)))}return i}var Eh=4294967296,xs=hf(0),Th=hf(1),Ym=hf(16777216);L=Te.prototype;L.ea=function(){if(zt(this))return-nt(this).ea();for(var t=0,e=1,n=0;n<this.g.length;n++){var i=this.D(n);t+=(0<=i?i:Eh+i)*e,e*=Eh}return t};L.toString=function(t){if(t=t||10,2>t||36<t)throw Error("radix out of range: "+t);if(zn(this))return"0";if(zt(this))return"-"+nt(this).toString(t);for(var e=vn(Math.pow(t,6)),n=this,i="";;){var s=Rc(n,e).g;n=bc(n,s.R(e));var r=((0<n.g.length?n.g[0]:n.h)>>>0).toString(t);if(n=s,zn(n))return r+i;for(;6>r.length;)r="0"+r;i=r+i}};L.D=function(t){return 0>t?0:t<this.g.length?this.g[t]:this.h};function zn(t){if(t.h!=0)return!1;for(var e=0;e<t.g.length;e++)if(t.g[e]!=0)return!1;return!0}function zt(t){return t.h==-1}L.X=function(t){return t=bc(this,t),zt(t)?-1:zn(t)?0:1};function nt(t){for(var e=t.g.length,n=[],i=0;i<e;i++)n[i]=~t.g[i];return new Te(n,~t.h).add(Th)}L.abs=function(){return zt(this)?nt(this):this};L.add=function(t){for(var e=Math.max(this.g.length,t.g.length),n=[],i=0,s=0;s<=e;s++){var r=i+(this.D(s)&65535)+(t.D(s)&65535),o=(r>>>16)+(this.D(s)>>>16)+(t.D(s)>>>16);i=o>>>16,r&=65535,o&=65535,n[s]=o<<16|r}return new Te(n,n[n.length-1]&-2147483648?-1:0)};function bc(t,e){return t.add(nt(e))}L.R=function(t){if(zn(this)||zn(t))return xs;if(zt(this))return zt(t)?nt(this).R(nt(t)):nt(nt(this).R(t));if(zt(t))return nt(this.R(nt(t)));if(0>this.X(Ym)&&0>t.X(Ym))return vn(this.ea()*t.ea());for(var e=this.g.length+t.g.length,n=[],i=0;i<2*e;i++)n[i]=0;for(i=0;i<this.g.length;i++)for(var s=0;s<t.g.length;s++){var r=this.D(i)>>>16,o=this.D(i)&65535,a=t.D(s)>>>16,c=t.D(s)&65535;n[2*i+2*s]+=o*c,Ta(n,2*i+2*s),n[2*i+2*s+1]+=r*c,Ta(n,2*i+2*s+1),n[2*i+2*s+1]+=o*a,Ta(n,2*i+2*s+1),n[2*i+2*s+2]+=r*a,Ta(n,2*i+2*s+2)}for(i=0;i<e;i++)n[i]=n[2*i+1]<<16|n[2*i];for(i=e;i<2*e;i++)n[i]=0;return new Te(n,0)};function Ta(t,e){for(;(t[e]&65535)!=t[e];)t[e+1]+=t[e]>>>16,t[e]&=65535,e++}function br(t,e){this.g=t,this.h=e}function Rc(t,e){if(zn(e))throw Error("division by zero");if(zn(t))return new br(xs,xs);if(zt(t))return e=Rc(nt(t),e),new br(nt(e.g),nt(e.h));if(zt(e))return e=Rc(t,nt(e)),new br(nt(e.g),e.h);if(30<t.g.length){if(zt(t)||zt(e))throw Error("slowDivide_ only works with positive integers.");for(var n=Th,i=e;0>=i.X(t);)n=Xm(n),i=Xm(i);var s=ms(n,1),r=ms(i,1);for(i=ms(i,2),n=ms(n,2);!zn(i);){var o=r.add(i);0>=o.X(t)&&(s=s.add(n),r=o),i=ms(i,1),n=ms(n,1)}return e=bc(t,s.R(e)),new br(s,e)}for(s=xs;0<=t.X(e);){for(n=Math.max(1,Math.floor(t.ea()/e.ea())),i=Math.ceil(Math.log(n)/Math.LN2),i=48>=i?1:Math.pow(2,i-48),r=vn(n),o=r.R(e);zt(o)||0<o.X(t);)n-=i,r=vn(n),o=r.R(e);zn(r)&&(r=Th),s=s.add(r),t=bc(t,o)}return new br(s,t)}L.gb=function(t){return Rc(this,t).h};L.and=function(t){for(var e=Math.max(this.g.length,t.g.length),n=[],i=0;i<e;i++)n[i]=this.D(i)&t.D(i);return new Te(n,this.h&t.h)};L.or=function(t){for(var e=Math.max(this.g.length,t.g.length),n=[],i=0;i<e;i++)n[i]=this.D(i)|t.D(i);return new Te(n,this.h|t.h)};L.xor=function(t){for(var e=Math.max(this.g.length,t.g.length),n=[],i=0;i<e;i++)n[i]=this.D(i)^t.D(i);return new Te(n,this.h^t.h)};function Xm(t){for(var e=t.g.length+1,n=[],i=0;i<e;i++)n[i]=t.D(i)<<1|t.D(i-1)>>>31;return new Te(n,t.h)}function ms(t,e){var n=e>>5;e%=32;for(var i=t.g.length-n,s=[],r=0;r<i;r++)s[r]=0<e?t.D(r+n)>>>e|t.D(r+n+1)<<32-e:t.D(r+n);return new Te(s,t.h)}wc.prototype.createWebChannel=wc.prototype.g;Mt.prototype.send=Mt.prototype.u;Mt.prototype.open=Mt.prototype.m;Mt.prototype.close=Mt.prototype.close;gl.NO_ERROR=0;gl.TIMEOUT=8;gl.HTTP_ERROR=6;qE.COMPLETE="complete";VE.EventType=Ko;Ko.OPEN="a";Ko.CLOSE="b";Ko.ERROR="c";Ko.MESSAGE="d";Xe.prototype.listen=Xe.prototype.O;Ve.prototype.listenOnce=Ve.prototype.P;Ve.prototype.getLastError=Ve.prototype.Sa;Ve.prototype.getLastErrorCode=Ve.prototype.Ia;Ve.prototype.getStatus=Ve.prototype.da;Ve.prototype.getResponseJson=Ve.prototype.Wa;Ve.prototype.getResponseText=Ve.prototype.ja;Ve.prototype.send=Ve.prototype.ha;Ve.prototype.setWithCredentials=Ve.prototype.Oa;rn.prototype.digest=rn.prototype.l;rn.prototype.reset=rn.prototype.reset;rn.prototype.update=rn.prototype.j;Te.prototype.add=Te.prototype.add;Te.prototype.multiply=Te.prototype.R;Te.prototype.modulo=Te.prototype.gb;Te.prototype.compare=Te.prototype.X;Te.prototype.toNumber=Te.prototype.ea;Te.prototype.toString=Te.prototype.toString;Te.prototype.getBits=Te.prototype.D;Te.fromNumber=vn;Te.fromString=yT;var PN=function(){return new wc},kN=function(){return ml()},fu=gl,NN=qE,xN=os,Jm={xb:0,Ab:1,Bb:2,Ub:3,Zb:4,Wb:5,Xb:6,Vb:7,Tb:8,Yb:9,PROXY:10,NOPROXY:11,Rb:12,Nb:13,Ob:14,Mb:15,Pb:16,Qb:17,tb:18,sb:19,ub:20},ON=Yo,Ia=VE,DN=Ve,LN=rn,Os=Te;const Zm="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const es=new Lo("@firebase/firestore");function Rr(){return es.logLevel}function V(t,...e){if(es.logLevel<=re.DEBUG){const n=e.map(df);es.debug(`Firestore (${fr}): ${t}`,...n)}}function Gn(t,...e){if(es.logLevel<=re.ERROR){const n=e.map(df);es.error(`Firestore (${fr}): ${t}`,...n)}}function $s(t,...e){if(es.logLevel<=re.WARN){const n=e.map(df);es.warn(`Firestore (${fr}): ${t}`,...n)}}function df(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Zo(t){if(t.code!==b.FAILED_PRECONDITION||t.message!==GN)throw t;V("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ff{constructor(e,n){this.previousValue=e,n&&(n.sequenceNumberHandler=i=>this.se(i),this.oe=i=>n.writeSequenceNumber(i))}se(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.oe&&this.oe(e),e}}ff._e=-1;function bl(t){return t==null}function Ac(t){return t===0&&1/t==-1/0}function YN(t){return typeof t=="number"&&Number.isInteger(t)&&!Ac(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eg(t){let e=0;for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e++;return e}function pr(t,e){for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e(n,t[n])}function IT(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tt{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(s){try{return atob(s)}catch(r){throw typeof DOMException<"u"&&r instanceof DOMException?new wT("Invalid base64 string: "+r):r}}(e);return new Tt(n)}static fromUint8Array(e){const n=function(s){let r="";for(let o=0;o<s.length;++o)r+=String.fromCharCode(s[o]);return r}(e);return new Tt(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(n){return btoa(n)}(this.binaryString)}toUint8Array(){return function(n){const i=new Uint8Array(n.length);for(let s=0;s<n.length;s++)i[s]=n.charCodeAt(s);return i}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return me(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}Tt.EMPTY_BYTE_STRING=new Tt("");const XN=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Ii(t){if(Oe(!!t),typeof t=="string"){let e=0;const n=XN.exec(t);if(Oe(!!n),n[1]){let s=n[1];s=(s+"000000000").substr(0,9),e=Number(s)}const i=new Date(t);return{seconds:Math.floor(i.getTime()/1e3),nanos:e}}return{seconds:je(t.seconds),nanos:je(t.nanos)}}function je(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function ts(t){return typeof t=="string"?Tt.fromBase64String(t):Tt.fromUint8Array(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pf(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function mf(t){const e=t.mapValue.fields.__previous_value__;return pf(e)?mf(e):e}function bo(t){const e=Ii(t.mapValue.fields.__local_write_time__.timestampValue);return new Be(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sc{constructor(e,n="asc"){this.field=e,this.dir=n}}function ex(t,e){return t.dir===e.dir&&t.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rl{constructor(e,n=null,i=[],s=[],r=null,o="F",a=null,c=null){this.path=e,this.collectionGroup=n,this.explicitOrderBy=i,this.filters=s,this.limit=r,this.limitType=o,this.startAt=a,this.endAt=c,this.le=null,this.he=null,this.Pe=null,this.startAt,this.endAt}}function ux(t,e,n,i,s,r,o,a){return new Rl(t,e,n,i,s,r,o,a)}function Al(t){return new Rl(t)}function cg(t){return t.filters.length===0&&t.limit===null&&t.startAt==null&&t.endAt==null&&(t.explicitOrderBy.length===0||t.explicitOrderBy.length===1&&t.explicitOrderBy[0].field.isKeyField())}function hx(t){return t.collectionGroup!==null}function Kr(t){const e=te(t);if(e.le===null){e.le=[];const n=new Set;for(const r of e.explicitOrderBy)e.le.push(r),n.add(r.field.canonicalString());const i=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc";(function(o){let a=new ot(st.comparator);return o.filters.forEach(c=>{c.getFlattenedFilters().forEach(l=>{l.isInequality()&&(a=a.add(l.field))})}),a})(e).forEach(r=>{n.has(r.canonicalString())||r.isKeyField()||e.le.push(new Sc(r,i))}),n.has(st.keyField().canonicalString())||e.le.push(new Sc(st.keyField(),i))}return e.le}function Tn(t){const e=te(t);return e.he||(e.he=dx(e,Kr(t))),e.he}function dx(t,e){if(t.limitType==="F")return ag(t.path,t.collectionGroup,e,t.filters,t.limit,t.startAt,t.endAt);{e=e.map(s=>{const r=s.dir==="desc"?"asc":"desc";return new Sc(s.field,r)});const n=t.endAt?new Cc(t.endAt.position,t.endAt.inclusive):null,i=t.startAt?new Cc(t.startAt.position,t.startAt.inclusive):null;return ag(t.path,t.collectionGroup,e,t.filters,t.limit,n,i)}}function Ah(t,e,n){return new Rl(t.path,t.collectionGroup,t.explicitOrderBy.slice(),t.filters.slice(),e,n,t.startAt,t.endAt)}function Cl(t,e){return vf(Tn(t),Tn(e))&&t.limitType===e.limitType}function NT(t){return`${_f(Tn(t))}|lt:${t.limitType}`}function gs(t){return`Query(target=${function(n){let i=n.path.canonicalString();return n.collectionGroup!==null&&(i+=" collectionGroup="+n.collectionGroup),n.filters.length>0&&(i+=`, filters: [${n.filters.map(s=>PT(s)).join(", ")}]`),bl(n.limit)||(i+=", limit: "+n.limit),n.orderBy.length>0&&(i+=`, orderBy: [${n.orderBy.map(s=>function(o){return`${o.field.canonicalString()} (${o.dir})`}(s)).join(", ")}]`),n.startAt&&(i+=", startAt: ",i+=n.startAt.inclusive?"b:":"a:",i+=n.startAt.position.map(s=>Ks(s)).join(",")),n.endAt&&(i+=", endAt: ",i+=n.endAt.inclusive?"a:":"b:",i+=n.endAt.position.map(s=>Ks(s)).join(",")),`Target(${i})`}(Tn(t))}; limitType=${t.limitType})`}function Sl(t,e){return e.isFoundDocument()&&function(i,s){const r=s.key.path;return i.collectionGroup!==null?s.key.hasCollectionId(i.collectionGroup)&&i.path.isPrefixOf(r):H.isDocumentKey(i.path)?i.path.isEqual(r):i.path.isImmediateParentOf(r)}(t,e)&&function(i,s){for(const r of Kr(i))if(!r.field.isKeyField()&&s.data.field(r.field)===null)return!1;return!0}(t,e)&&function(i,s){for(const r of i.filters)if(!r.matches(s))return!1;return!0}(t,e)&&function(i,s){return!(i.startAt&&!function(o,a,c){const l=rg(o,a,c);return o.inclusive?l<=0:l<0}(i.startAt,Kr(i),s)||i.endAt&&!function(o,a,c){const l=rg(o,a,c);return o.inclusive?l>=0:l>0}(i.endAt,Kr(i),s))}(t,e)}function fx(t){return t.collectionGroup||(t.path.length%2==1?t.path.lastSegment():t.path.get(t.path.length-2))}function xT(t){return(e,n)=>{let i=!1;for(const s of Kr(t)){const r=px(s,e,n);if(r!==0)return r;i=i||s.field.isKeyField()}return 0}}function px(t,e,n){const i=t.field.isKeyField()?H.comparator(e.key,n.key):function(r,o,a){const c=o.data.field(r),l=a.data.field(r);return c!==null&&l!==null?Hs(c,l):Q()}(t.field,e,n);switch(t.dir){case"asc":return i;case"desc":return-1*i;default:return Q()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mx=new qe(H.comparator);function Qn(){return mx}const OT=new qe(H.comparator);function Dr(...t){let e=OT;for(const n of t)e=e.insert(n.key,n);return e}function DT(t){let e=OT;return t.forEach((n,i)=>e=e.insert(n,i.overlayedDocument)),e}function Fi(){return Gr()}function LT(){return Gr()}function Gr(){return new mr(t=>t.toString(),(t,e)=>t.isEqual(e))}const gx=new qe(H.comparator),_x=new ot(H.comparator);function oe(...t){let e=_x;for(const n of t)e=e.add(n);return e}const vx=new ot(me);function yx(){return vx}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function MT(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Ac(e)?"-0":e}}function qT(t){return{integerValue:""+t}}function Ex(t,e){return YN(e)?qT(e):MT(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pl{constructor(){this._=void 0}}function Tx(t,e,n){return t instanceof Pc?function(s,r){const o={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return r&&pf(r)&&(r=mf(r)),r&&(o.fields.__previous_value__=r),{mapValue:o}}(n,e):t instanceof Co?FT(t,e):t instanceof So?UT(t,e):function(s,r){const o=VT(s,r),a=lg(o)+lg(s.Ie);return wh(o)&&wh(s.Ie)?qT(a):MT(s.serializer,a)}(t,e)}function Ix(t,e,n){return t instanceof Co?FT(t,e):t instanceof So?UT(t,e):n}function VT(t,e){return t instanceof kc?function(i){return wh(i)||function(r){return!!r&&"doubleValue"in r}(i)}(e)?e:{integerValue:0}:null}class Pc extends Pl{}class Co extends Pl{constructor(e){super(),this.elements=e}}function FT(t,e){const n=zT(e);for(const i of t.elements)n.some(s=>Cn(s,i))||n.push(i);return{arrayValue:{values:n}}}class So extends Pl{constructor(e){super(),this.elements=e}}function UT(t,e){let n=zT(e);for(const i of t.elements)n=n.filter(s=>!Cn(s,i));return{arrayValue:{values:n}}}class kc extends Pl{constructor(e,n){super(),this.serializer=e,this.Ie=n}}function lg(t){return je(t.integerValue||t.doubleValue)}function zT(t){return gf(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}function wx(t,e){return t.field.isEqual(e.field)&&function(i,s){return i instanceof Co&&s instanceof Co||i instanceof So&&s instanceof So?Ws(i.elements,s.elements,Cn):i instanceof kc&&s instanceof kc?Cn(i.Ie,s.Ie):i instanceof Pc&&s instanceof Pc}(t.transform,e.transform)}class bx{constructor(e,n){this.version=e,this.transformResults=n}}class Wn{constructor(e,n){this.updateTime=e,this.exists=n}static none(){return new Wn}static exists(e){return new Wn(void 0,e)}static updateTime(e){return new Wn(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function za(t,e){return t.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(t.updateTime):t.exists===void 0||t.exists===e.isFoundDocument()}class kl{}function jT(t,e){if(!t.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return t.isNoDocument()?new $T(t.key,Wn.none()):new ta(t.key,t.data,Wn.none());{const n=t.data,i=jt.empty();let s=new ot(st.comparator);for(let r of e.fields)if(!s.has(r)){let o=n.field(r);o===null&&r.length>1&&(r=r.popLast(),o=n.field(r)),o===null?i.delete(r):i.set(r,o),s=s.add(r)}return new as(t.key,i,new Xt(s.toArray()),Wn.none())}}function Rx(t,e,n){t instanceof ta?function(s,r,o){const a=s.value.clone(),c=hg(s.fieldTransforms,r,o.transformResults);a.setAll(c),r.convertToFoundDocument(o.version,a).setHasCommittedMutations()}(t,e,n):t instanceof as?function(s,r,o){if(!za(s.precondition,r))return void r.convertToUnknownDocument(o.version);const a=hg(s.fieldTransforms,r,o.transformResults),c=r.data;c.setAll(BT(s)),c.setAll(a),r.convertToFoundDocument(o.version,c).setHasCommittedMutations()}(t,e,n):function(s,r,o){r.convertToNoDocument(o.version).setHasCommittedMutations()}(0,e,n)}function Qr(t,e,n,i){return t instanceof ta?function(r,o,a,c){if(!za(r.precondition,o))return a;const l=r.value.clone(),u=dg(r.fieldTransforms,c,o);return l.setAll(u),o.convertToFoundDocument(o.version,l).setHasLocalMutations(),null}(t,e,n,i):t instanceof as?function(r,o,a,c){if(!za(r.precondition,o))return a;const l=dg(r.fieldTransforms,c,o),u=o.data;return u.setAll(BT(r)),u.setAll(l),o.convertToFoundDocument(o.version,u).setHasLocalMutations(),a===null?null:a.unionWith(r.fieldMask.fields).unionWith(r.fieldTransforms.map(h=>h.field))}(t,e,n,i):function(r,o,a){return za(r.precondition,o)?(o.convertToNoDocument(o.version).setHasLocalMutations(),null):a}(t,e,n)}function Ax(t,e){let n=null;for(const i of t.fieldTransforms){const s=e.data.field(i.field),r=VT(i.transform,s||null);r!=null&&(n===null&&(n=jt.empty()),n.set(i.field,r))}return n||null}function ug(t,e){return t.type===e.type&&!!t.key.isEqual(e.key)&&!!t.precondition.isEqual(e.precondition)&&!!function(i,s){return i===void 0&&s===void 0||!(!i||!s)&&Ws(i,s,(r,o)=>wx(r,o))}(t.fieldTransforms,e.fieldTransforms)&&(t.type===0?t.value.isEqual(e.value):t.type!==1||t.data.isEqual(e.data)&&t.fieldMask.isEqual(e.fieldMask))}class ta extends kl{constructor(e,n,i,s=[]){super(),this.key=e,this.value=n,this.precondition=i,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class as extends kl{constructor(e,n,i,s,r=[]){super(),this.key=e,this.data=n,this.fieldMask=i,this.precondition=s,this.fieldTransforms=r,this.type=1}getFieldMask(){return this.fieldMask}}function BT(t){const e=new Map;return t.fieldMask.fields.forEach(n=>{if(!n.isEmpty()){const i=t.data.field(n);e.set(n,i)}}),e}function hg(t,e,n){const i=new Map;Oe(t.length===n.length);for(let s=0;s<n.length;s++){const r=t[s],o=r.transform,a=e.data.field(r.field);i.set(r.field,Ix(o,a,n[s]))}return i}function dg(t,e,n){const i=new Map;for(const s of t){const r=s.transform,o=n.data.field(s.field);i.set(s.field,Tx(r,o,e))}return i}class $T extends kl{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class Cx extends kl{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nl{constructor(e,n,i,s,r){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=i,this.documentUpdates=s,this.resolvedLimboDocuments=r}static createSynthesizedRemoteEventForCurrentChange(e,n,i){const s=new Map;return s.set(e,na.createSynthesizedTargetChangeForCurrentChange(e,n,i)),new Nl(X.min(),s,new qe(me),Qn(),oe())}}class na{constructor(e,n,i,s,r){this.resumeToken=e,this.current=n,this.addedDocuments=i,this.modifiedDocuments=s,this.removedDocuments=r}static createSynthesizedTargetChangeForCurrentChange(e,n,i){return new na(i,n,oe(),oe(),oe())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sO{constructor(e,n,i,s){this.remoteDocumentCache=e,this.mutationQueue=n,this.documentOverlayCache=i,this.indexManager=s}getDocument(e,n){let i=null;return this.documentOverlayCache.getOverlay(e,n).next(s=>(i=s,this.remoteDocumentCache.getEntry(e,n))).next(s=>(i!==null&&Qr(i.mutation,s,Xt.empty(),Be.now()),s))}getDocuments(e,n){return this.remoteDocumentCache.getEntries(e,n).next(i=>this.getLocalViewOfDocuments(e,i,oe()).next(()=>i))}getLocalViewOfDocuments(e,n,i=oe()){const s=Fi();return this.populateOverlays(e,s,n).next(()=>this.computeViews(e,n,s,i).next(r=>{let o=Dr();return r.forEach((a,c)=>{o=o.insert(a,c.overlayedDocument)}),o}))}getOverlayedDocuments(e,n){const i=Fi();return this.populateOverlays(e,i,n).next(()=>this.computeViews(e,n,i,oe()))}populateOverlays(e,n,i){const s=[];return i.forEach(r=>{n.has(r)||s.push(r)}),this.documentOverlayCache.getOverlays(e,s).next(r=>{r.forEach((o,a)=>{n.set(o,a)})})}computeViews(e,n,i,s){let r=Qn();const o=Gr(),a=function(){return Gr()}();return n.forEach((c,l)=>{const u=i.get(l.key);s.has(l.key)&&(u===void 0||u.mutation instanceof as)?r=r.insert(l.key,l):u!==void 0?(o.set(l.key,u.mutation.getFieldMask()),Qr(u.mutation,l,u.mutation.getFieldMask(),Be.now())):o.set(l.key,Xt.empty())}),this.recalculateAndSaveOverlays(e,r).next(c=>(c.forEach((l,u)=>o.set(l,u)),n.forEach((l,u)=>{var h;return a.set(l,new iO(u,(h=o.get(l))!==null&&h!==void 0?h:null))}),a))}recalculateAndSaveOverlays(e,n){const i=Gr();let s=new qe((o,a)=>o-a),r=oe();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,n).next(o=>{for(const a of o)a.keys().forEach(c=>{const l=n.get(c);if(l===null)return;let u=i.get(c)||Xt.empty();u=a.applyToLocalView(l,u),i.set(c,u);const h=(s.get(a.batchId)||oe()).add(c);s=s.insert(a.batchId,h)})}).next(()=>{const o=[],a=s.getReverseIterator();for(;a.hasNext();){const c=a.getNext(),l=c.key,u=c.value,h=LT();u.forEach(d=>{if(!r.has(d)){const f=jT(n.get(d),i.get(d));f!==null&&h.set(d,f),r=r.add(d)}}),o.push(this.documentOverlayCache.saveOverlays(e,l,h))}return C.waitFor(o)}).next(()=>i)}recalculateAndSaveOverlaysForDocumentKeys(e,n){return this.remoteDocumentCache.getEntries(e,n).next(i=>this.recalculateAndSaveOverlays(e,i))}getDocumentsMatchingQuery(e,n,i,s){return function(o){return H.isDocumentKey(o.path)&&o.collectionGroup===null&&o.filters.length===0}(n)?this.getDocumentsMatchingDocumentQuery(e,n.path):hx(n)?this.getDocumentsMatchingCollectionGroupQuery(e,n,i,s):this.getDocumentsMatchingCollectionQuery(e,n,i,s)}getNextDocuments(e,n,i,s){return this.remoteDocumentCache.getAllFromCollectionGroup(e,n,i,s).next(r=>{const o=s-r.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,n,i.largestBatchId,s-r.size):C.resolve(Fi());let a=-1,c=r;return o.next(l=>C.forEach(l,(u,h)=>(a<h.largestBatchId&&(a=h.largestBatchId),r.get(u)?C.resolve():this.remoteDocumentCache.getEntry(e,u).next(d=>{c=c.insert(u,d)}))).next(()=>this.populateOverlays(e,l,r)).next(()=>this.computeViews(e,c,l,oe())).next(u=>({batchId:a,changes:DT(u)})))})}getDocumentsMatchingDocumentQuery(e,n){return this.getDocument(e,new H(n)).next(i=>{let s=Dr();return i.isFoundDocument()&&(s=s.insert(i.key,i)),s})}getDocumentsMatchingCollectionGroupQuery(e,n,i,s){const r=n.collectionGroup;let o=Dr();return this.indexManager.getCollectionParents(e,r).next(a=>C.forEach(a,c=>{const l=function(h,d){return new Rl(d,null,h.explicitOrderBy.slice(),h.filters.slice(),h.limit,h.limitType,h.startAt,h.endAt)}(n,c.child(r));return this.getDocumentsMatchingCollectionQuery(e,l,i,s).next(u=>{u.forEach((h,d)=>{o=o.insert(h,d)})})}).next(()=>o))}getDocumentsMatchingCollectionQuery(e,n,i,s){let r;return this.documentOverlayCache.getOverlaysForCollection(e,n.path,i.largestBatchId).next(o=>(r=o,this.remoteDocumentCache.getDocumentsMatchingQuery(e,n,i,r,s))).next(o=>{r.forEach((c,l)=>{const u=l.getKey();o.get(u)===null&&(o=o.insert(u,mt.newInvalidDocument(u)))});let a=Dr();return o.forEach((c,l)=>{const u=r.get(c);u!==void 0&&Qr(u.mutation,l,Xt.empty(),Be.now()),Sl(n,l)&&(a=a.insert(c,l))}),a})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pO{constructor(){this.Ki=!1,this.$i=!1,this.Ui=100,this.Wi=8}initialize(e,n){this.Gi=e,this.indexManager=n,this.Ki=!0}getDocumentsMatchingQuery(e,n,i,s){const r={result:null};return this.zi(e,n).next(o=>{r.result=o}).next(()=>{if(!r.result)return this.ji(e,n,s,i).next(o=>{r.result=o})}).next(()=>{if(r.result)return;const o=new fO;return this.Hi(e,n,o).next(a=>{if(r.result=a,this.$i)return this.Ji(e,n,o,a.size)})}).next(()=>r.result)}Ji(e,n,i,s){return i.documentReadCount<this.Ui?(Rr()<=re.DEBUG&&V("QueryEngine","SDK will not create cache indexes for query:",gs(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Ui,"documents"),C.resolve()):(Rr()<=re.DEBUG&&V("QueryEngine","Query:",gs(n),"scans",i.documentReadCount,"local documents and returns",s,"documents as results."),i.documentReadCount>this.Wi*s?(Rr()<=re.DEBUG&&V("QueryEngine","The SDK decides to create cache indexes for query:",gs(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Tn(n))):C.resolve())}zi(e,n){if(cg(n))return C.resolve(null);let i=Tn(n);return this.indexManager.getIndexType(e,i).next(s=>s===0?null:(n.limit!==null&&s===1&&(n=Ah(n,null,"F"),i=Tn(n)),this.indexManager.getDocumentsMatchingTarget(e,i).next(r=>{const o=oe(...r);return this.Gi.getDocuments(e,o).next(a=>this.indexManager.getMinOffset(e,i).next(c=>{const l=this.Yi(n,a);return this.Zi(n,l,o,c.readTime)?this.zi(e,Ah(n,null,"F")):this.Xi(e,l,n,c)}))})))}ji(e,n,i,s){return cg(n)||s.isEqual(X.min())?C.resolve(null):this.Gi.getDocuments(e,i).next(r=>{const o=this.Yi(n,r);return this.Zi(n,o,i,s)?C.resolve(null):(Rr()<=re.DEBUG&&V("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),gs(n)),this.Xi(e,o,n,WN(s,-1)).next(a=>a))})}Yi(e,n){let i=new ot(xT(e));return n.forEach((s,r)=>{Sl(e,r)&&(i=i.add(r))}),i}Zi(e,n,i,s){if(e.limit===null)return!1;if(i.size!==n.size)return!0;const r=e.limitType==="F"?n.last():n.first();return!!r&&(r.hasPendingWrites||r.version.compareTo(s)>0)}Hi(e,n,i){return Rr()<=re.DEBUG&&V("QueryEngine","Using full collection scan to execute query:",gs(n)),this.Gi.getDocumentsMatchingQuery(e,n,Ti.min(),i)}Xi(e,n,i,s){return this.Gi.getDocumentsMatchingQuery(e,i,s).next(r=>(n.forEach(o=>{r=r.insert(o.key,o)}),r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ra=null;function mu(){return Ra===null?Ra=function(){return 268435456+Math.round(2147483648*Math.random())}():Ra++,"0x"+Ra.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ut="WebChannelConnection";class CO extends class{constructor(n){this.databaseInfo=n,this.databaseId=n.databaseId;const i=n.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),r=encodeURIComponent(this.databaseId.database);this.mo=i+"://"+n.host,this.fo=`projects/${s}/databases/${r}`,this.po=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${r}`}get yo(){return!1}wo(n,i,s,r,o){const a=mu(),c=this.So(n,i);V("RestConnection",`Sending RPC '${n}' ${a}:`,c,s);const l={"google-cloud-resource-prefix":this.fo,"x-goog-request-params":this.po};return this.bo(l,r,o),this.Do(n,c,l,s).then(u=>(V("RestConnection",`Received RPC '${n}' ${a}: `,u),u),u=>{throw $s("RestConnection",`RPC '${n}' ${a} failed with error: `,u,"url: ",c,"request:",s),u})}Co(n,i,s,r,o,a){return this.wo(n,i,s,r,o)}bo(n,i,s){n["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+fr}(),n["Content-Type"]="text/plain",this.databaseInfo.appId&&(n["X-Firebase-GMPID"]=this.databaseInfo.appId),i&&i.headers.forEach((r,o)=>n[o]=r),s&&s.headers.forEach((r,o)=>n[o]=r)}So(n,i){const s=RO[n];return`${this.mo}/v1/${i}:${s}`}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Do(e,n,i,s){const r=mu();return new Promise((o,a)=>{const c=new DN;c.setWithCredentials(!0),c.listenOnce(NN.COMPLETE,()=>{try{switch(c.getLastErrorCode()){case fu.NO_ERROR:const u=c.getResponseJson();V(ut,`XHR for RPC '${e}' ${r} received:`,JSON.stringify(u)),o(u);break;case fu.TIMEOUT:V(ut,`RPC '${e}' ${r} timed out`),a(new z(b.DEADLINE_EXCEEDED,"Request time out"));break;case fu.HTTP_ERROR:const h=c.getStatus();if(V(ut,`RPC '${e}' ${r} failed with status:`,h,"response text:",c.getResponseText()),h>0){let d=c.getResponseJson();Array.isArray(d)&&(d=d[0]);const f=d==null?void 0:d.error;if(f&&f.status&&f.message){const g=function(y){const I=y.toLowerCase().replace(/_/g,"-");return Object.values(b).indexOf(I)>=0?I:b.UNKNOWN}(f.status);a(new z(g,f.message))}else a(new z(b.UNKNOWN,"Server responded with status "+c.getStatus()))}else a(new z(b.UNAVAILABLE,"Connection failed."));break;default:Q()}}finally{V(ut,`RPC '${e}' ${r} completed.`)}});const l=JSON.stringify(s);V(ut,`RPC '${e}' ${r} sending request:`,s),c.send(n,"POST",l,i,15)})}vo(e,n,i){const s=mu(),r=[this.mo,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=PN(),a=kN(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},l=this.longPollingOptions.timeoutSeconds;l!==void 0&&(c.longPollingTimeout=Math.round(1e3*l)),this.useFetchStreams&&(c.xmlHttpFactory=new ON({})),this.bo(c.initMessageHeaders,n,i),c.encodeInitMessageHeaders=!0;const u=r.join("");V(ut,`Creating RPC '${e}' stream ${s}: ${u}`,c);const h=o.createWebChannel(u,c);let d=!1,f=!1;const g=new AO({co:y=>{f?V(ut,`Not sending because RPC '${e}' stream ${s} is closed:`,y):(d||(V(ut,`Opening RPC '${e}' stream ${s} transport.`),h.open(),d=!0),V(ut,`RPC '${e}' stream ${s} sending:`,y),h.send(y))},lo:()=>h.close()}),v=(y,I,P)=>{y.listen(I,k=>{try{P(k)}catch(R){setTimeout(()=>{throw R},0)}})};return v(h,Ia.EventType.OPEN,()=>{f||V(ut,`RPC '${e}' stream ${s} transport opened.`)}),v(h,Ia.EventType.CLOSE,()=>{f||(f=!0,V(ut,`RPC '${e}' stream ${s} transport closed`),g.Ro())}),v(h,Ia.EventType.ERROR,y=>{f||(f=!0,$s(ut,`RPC '${e}' stream ${s} transport errored:`,y),g.Ro(new z(b.UNAVAILABLE,"The operation could not be completed")))}),v(h,Ia.EventType.MESSAGE,y=>{var I;if(!f){const P=y.data[0];Oe(!!P);const k=P,R=k.error||((I=k[0])===null||I===void 0?void 0:I.error);if(R){V(ut,`RPC '${e}' stream ${s} received error:`,R);const K=R.status;let ie=function(ne){const Ie=ze[ne];if(Ie!==void 0)return WT(Ie)}(K),he=R.message;ie===void 0&&(ie=b.INTERNAL,he="Unknown error status: "+K+" with message "+R.message),f=!0,g.Ro(new z(ie,he)),h.close()}else V(ut,`RPC '${e}' stream ${s} received:`,P),g.Vo(P)}}),v(a,xN.STAT_EVENT,y=>{y.stat===Jm.PROXY?V(ut,`RPC '${e}' stream ${s} detected buffering proxy`):y.stat===Jm.NOPROXY&&V(ut,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{g.Ao()},0),g}}function gu(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xl(t){return new Vx(t,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xO{constructor(e,n,i,s,r){this.localStore=e,this.datastore=n,this.asyncQueue=i,this.remoteSyncer={},this.b_=[],this.D_=new Map,this.C_=new Set,this.v_=[],this.F_=r,this.F_.ro(o=>{i.enqueueAndForget(async()=>{cs(this)&&(V("RemoteStore","Restarting streams for network reachability change."),await async function(c){const l=te(c);l.C_.add(4),await ia(l),l.M_.set("Unknown"),l.C_.delete(4),await Ol(l)}(this))})}),this.M_=new NO(i,s)}}async function Ol(t){if(cs(t))for(const e of t.v_)await e(!0)}async function ia(t){for(const e of t.v_)await e(!1)}function sI(t,e){const n=te(t);n.D_.has(e.targetId)||(n.D_.set(e.targetId,e),Cf(n)?Af(n):gr(n).Ho()&&Rf(n,e))}function rI(t,e){const n=te(t),i=gr(n);n.D_.delete(e),i.Ho()&&oI(n,e),n.D_.size===0&&(i.Ho()?i.Zo():cs(n)&&n.M_.set("Unknown"))}function Rf(t,e){if(t.x_.Oe(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(X.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}gr(t).u_(e)}function oI(t,e){t.x_.Oe(e),gr(t).c_(e)}function Af(t){t.x_=new Dx({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),_t:e=>t.D_.get(e)||null,nt:()=>t.datastore.serializer.databaseId}),gr(t).start(),t.M_.g_()}function Cf(t){return cs(t)&&!gr(t).jo()&&t.D_.size>0}function cs(t){return te(t).C_.size===0}function aI(t){t.x_=void 0}async function OO(t){t.D_.forEach((e,n)=>{Rf(t,e)})}async function DO(t,e){aI(t),Cf(t)?(t.M_.w_(e),Af(t)):t.M_.set("Unknown")}async function LO(t,e,n){if(t.M_.set("Online"),e instanceof KT&&e.state===2&&e.cause)try{await async function(s,r){const o=r.cause;for(const a of r.targetIds)s.D_.has(a)&&(await s.remoteSyncer.rejectListen(a,o),s.D_.delete(a),s.x_.removeTarget(a))}(t,e)}catch(i){V("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),i),await xc(t,i)}else if(e instanceof ja?t.x_.$e(e):e instanceof HT?t.x_.Je(e):t.x_.Ge(e),!n.isEqual(X.min()))try{const i=await tI(t.localStore);n.compareTo(i)>=0&&await function(r,o){const a=r.x_.it(o);return a.targetChanges.forEach((c,l)=>{if(c.resumeToken.approximateByteSize()>0){const u=r.D_.get(l);u&&r.D_.set(l,u.withResumeToken(c.resumeToken,o))}}),a.targetMismatches.forEach((c,l)=>{const u=r.D_.get(c);if(!u)return;r.D_.set(c,u.withResumeToken(Tt.EMPTY_BYTE_STRING,u.snapshotVersion)),oI(r,c);const h=new ci(u.target,c,l,u.sequenceNumber);Rf(r,h)}),r.remoteSyncer.applyRemoteEvent(a)}(t,n)}catch(i){V("RemoteStore","Failed to raise snapshot:",i),await xc(t,i)}}async function xc(t,e,n){if(!ea(e))throw e;t.C_.add(1),await ia(t),t.M_.set("Offline"),n||(n=()=>tI(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{V("RemoteStore","Retrying IndexedDB access"),await n(),t.C_.delete(1),await Ol(t)})}function cI(t,e){return e().catch(n=>xc(t,n,e))}async function Dl(t){const e=te(t),n=wi(e);let i=e.b_.length>0?e.b_[e.b_.length-1].batchId:-1;for(;MO(e);)try{const s=await EO(e.localStore,i);if(s===null){e.b_.length===0&&n.Zo();break}i=s.batchId,qO(e,s)}catch(s){await xc(e,s)}lI(e)&&uI(e)}function MO(t){return cs(t)&&t.b_.length<10}function qO(t,e){t.b_.push(e);const n=wi(t);n.Ho()&&n.h_&&n.P_(e.mutations)}function lI(t){return cs(t)&&!wi(t).jo()&&t.b_.length>0}function uI(t){wi(t).start()}async function VO(t){wi(t).E_()}async function FO(t){const e=wi(t);for(const n of t.b_)e.P_(n.mutations)}async function UO(t,e,n){const i=t.b_.shift(),s=yf.from(i,e,n);await cI(t,()=>t.remoteSyncer.applySuccessfulWrite(s)),await Dl(t)}async function zO(t,e){e&&wi(t).h_&&await async function(i,s){if(function(o){return Nx(o)&&o!==b.ABORTED}(s.code)){const r=i.b_.shift();wi(i).Yo(),await cI(i,()=>i.remoteSyncer.rejectFailedWrite(r.batchId,s)),await Dl(i)}}(t,e),lI(t)&&uI(t)}async function Ig(t,e){const n=te(t);n.asyncQueue.verifyOperationInProgress(),V("RemoteStore","RemoteStore received new credentials");const i=cs(n);n.C_.add(3),await ia(n),i&&n.M_.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.C_.delete(3),await Ol(n)}async function jO(t,e){const n=te(t);e?(n.C_.delete(2),await Ol(n)):e||(n.C_.add(2),await ia(n),n.M_.set("Unknown"))}function gr(t){return t.O_||(t.O_=function(n,i,s){const r=te(n);return r.A_(),new SO(i,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,s)}(t.datastore,t.asyncQueue,{ho:OO.bind(null,t),Io:DO.bind(null,t),a_:LO.bind(null,t)}),t.v_.push(async e=>{e?(t.O_.Yo(),Cf(t)?Af(t):t.M_.set("Unknown")):(await t.O_.stop(),aI(t))})),t.O_}function wi(t){return t.N_||(t.N_=function(n,i,s){const r=te(n);return r.A_(),new PO(i,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,s)}(t.datastore,t.asyncQueue,{ho:VO.bind(null,t),Io:zO.bind(null,t),T_:FO.bind(null,t),I_:UO.bind(null,t)}),t.v_.push(async e=>{e?(t.N_.Yo(),await Dl(t)):(await t.N_.stop(),t.b_.length>0&&(V("RemoteStore",`Stopping write stream with ${t.b_.length} pending writes`),t.b_=[]))})),t.N_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ds{constructor(e){this.comparator=e?(n,i)=>e(n,i)||H.comparator(n.key,i.key):(n,i)=>H.comparator(n.key,i.key),this.keyedMap=Dr(),this.sortedSet=new qe(this.comparator)}static emptySet(e){return new Ds(e.comparator)}has(e){return this.keyedMap.get(e)!=null}get(e){return this.keyedMap.get(e)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(e){const n=this.keyedMap.get(e);return n?this.sortedSet.indexOf(n):-1}get size(){return this.sortedSet.size}forEach(e){this.sortedSet.inorderTraversal((n,i)=>(e(n),!1))}add(e){const n=this.delete(e.key);return n.copy(n.keyedMap.insert(e.key,e),n.sortedSet.insert(e,null))}delete(e){const n=this.get(e);return n?this.copy(this.keyedMap.remove(e),this.sortedSet.remove(n)):this}isEqual(e){if(!(e instanceof Ds)||this.size!==e.size)return!1;const n=this.sortedSet.getIterator(),i=e.sortedSet.getIterator();for(;n.hasNext();){const s=n.getNext().key,r=i.getNext().key;if(!s.isEqual(r))return!1}return!0}toString(){const e=[];return this.forEach(n=>{e.push(n.toString())}),e.length===0?"DocumentSet ()":`DocumentSet (
  `+e.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wg{constructor(){this.B_=new qe(H.comparator)}track(e){const n=e.doc.key,i=this.B_.get(n);i?e.type!==0&&i.type===3?this.B_=this.B_.insert(n,e):e.type===3&&i.type!==1?this.B_=this.B_.insert(n,{type:i.type,doc:e.doc}):e.type===2&&i.type===2?this.B_=this.B_.insert(n,{type:2,doc:e.doc}):e.type===2&&i.type===0?this.B_=this.B_.insert(n,{type:0,doc:e.doc}):e.type===1&&i.type===0?this.B_=this.B_.remove(n):e.type===1&&i.type===2?this.B_=this.B_.insert(n,{type:1,doc:i.doc}):e.type===0&&i.type===1?this.B_=this.B_.insert(n,{type:2,doc:e.doc}):Q():this.B_=this.B_.insert(n,e)}L_(){const e=[];return this.B_.inorderTraversal((n,i)=>{e.push(i)}),e}}class Qs{constructor(e,n,i,s,r,o,a,c,l){this.query=e,this.docs=n,this.oldDocs=i,this.docChanges=s,this.mutatedKeys=r,this.fromCache=o,this.syncStateChanged=a,this.excludesMetadataChanges=c,this.hasCachedResults=l}static fromInitialDocuments(e,n,i,s,r){const o=[];return n.forEach(a=>{o.push({type:0,doc:a})}),new Qs(e,n,Ds.emptySet(n),o,i,s,!0,!1,r)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&Cl(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const n=this.docChanges,i=e.docChanges;if(n.length!==i.length)return!1;for(let s=0;s<n.length;s++)if(n[s].type!==i[s].type||!n[s].doc.isEqual(i[s].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ql{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new z(b.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new z(b.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return me(this._lat,e._lat)||me(this._long,e._long)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ED=/^__.*__$/;class TD{constructor(e,n,i){this.data=e,this.fieldMask=n,this.fieldTransforms=i}toMutation(e,n){return this.fieldMask!==null?new as(e,this.data,this.fieldMask,n,this.fieldTransforms):new ta(e,this.data,n,this.fieldTransforms)}}function wI(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw Q()}}class Vf{constructor(e,n,i,s,r,o){this.settings=e,this.databaseId=n,this.serializer=i,this.ignoreUndefinedProperties=s,r===void 0&&this.Pu(),this.fieldTransforms=r||[],this.fieldMask=o||[]}get path(){return this.settings.path}get Iu(){return this.settings.Iu}Tu(e){return new Vf(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Eu(e){var n;const i=(n=this.path)===null||n===void 0?void 0:n.child(e),s=this.Tu({path:i,du:!1});return s.Au(e),s}Ru(e){var n;const i=(n=this.path)===null||n===void 0?void 0:n.child(e),s=this.Tu({path:i,du:!1});return s.Pu(),s}Vu(e){return this.Tu({path:void 0,du:!0})}mu(e){return Dc(e,this.settings.methodName,this.settings.fu||!1,this.path,this.settings.gu)}contains(e){return this.fieldMask.find(n=>e.isPrefixOf(n))!==void 0||this.fieldTransforms.find(n=>e.isPrefixOf(n.field))!==void 0}Pu(){if(this.path)for(let e=0;e<this.path.length;e++)this.Au(this.path.get(e))}Au(e){if(e.length===0)throw this.mu("Document fields must not be empty");if(wI(this.Iu)&&ED.test(e))throw this.mu('Document fields cannot begin and end with "__"')}}class ID{constructor(e,n,i){this.databaseId=e,this.ignoreUndefinedProperties=n,this.serializer=i||xl(e)}pu(e,n,i,s=!1){return new Vf({Iu:e,methodName:n,gu:i,path:st.emptyPath(),du:!1,fu:s},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function wD(t){const e=t._freezeSettings(),n=xl(t._databaseId);return new ID(t._databaseId,!!e.ignoreUndefinedProperties,n)}function bD(t,e,n,i,s,r={}){const o=t.pu(r.merge||r.mergeFields?2:0,e,n,s);CI("Data must be an object, but it was:",o,i);const a=RI(i,o);let c,l;if(r.merge)c=new Xt(o.fieldMask),l=o.fieldTransforms;else if(r.mergeFields){const u=[];for(const h of r.mergeFields){const d=RD(e,h,n);if(!o.contains(d))throw new z(b.INVALID_ARGUMENT,`Field '${d}' is specified in your field mask but missing from your input data.`);CD(u,d)||u.push(d)}c=new Xt(u),l=o.fieldTransforms.filter(h=>c.covers(h.field))}else c=null,l=o.fieldTransforms;return new TD(new jt(a),c,l)}function bI(t,e){if(AI(t=Lt(t)))return CI("Unsupported field value:",e,t),RI(t,e);if(t instanceof II)return function(i,s){if(!wI(s.Iu))throw s.mu(`${i._methodName}() can only be used with update() and set()`);if(!s.path)throw s.mu(`${i._methodName}() is not currently supported inside arrays`);const r=i._toFieldTransform(s);r&&s.fieldTransforms.push(r)}(t,e),null;if(t===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.du&&e.Iu!==4)throw e.mu("Nested arrays are not supported");return function(i,s){const r=[];let o=0;for(const a of i){let c=bI(a,s.Vu(o));c==null&&(c={nullValue:"NULL_VALUE"}),r.push(c),o++}return{arrayValue:{values:r}}}(t,e)}return function(i,s){if((i=Lt(i))===null)return{nullValue:"NULL_VALUE"};if(typeof i=="number")return Ex(s.serializer,i);if(typeof i=="boolean")return{booleanValue:i};if(typeof i=="string")return{stringValue:i};if(i instanceof Date){const r=Be.fromDate(i);return{timestampValue:Nc(s.serializer,r)}}if(i instanceof Be){const r=new Be(i.seconds,1e3*Math.floor(i.nanoseconds/1e3));return{timestampValue:Nc(s.serializer,r)}}if(i instanceof ql)return{geoPointValue:{latitude:i.latitude,longitude:i.longitude}};if(i instanceof Xs)return{bytesValue:GT(s.serializer,i._byteString)};if(i instanceof Ct){const r=s.databaseId,o=i.firestore._databaseId;if(!o.isEqual(r))throw s.mu(`Document reference is for database ${o.projectId}/${o.database} but should be for database ${r.projectId}/${r.database}`);return{referenceValue:Tf(i.firestore._databaseId||s.databaseId,i._key.path)}}throw s.mu(`Unsupported field value: ${Mf(i)}`)}(t,e)}function RI(t,e){const n={};return IT(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):pr(t,(i,s)=>{const r=bI(s,e.Eu(i));r!=null&&(n[i]=r)}),{mapValue:{fields:n}}}function AI(t){return!(typeof t!="object"||t===null||t instanceof Array||t instanceof Date||t instanceof Be||t instanceof ql||t instanceof Xs||t instanceof Ct||t instanceof II)}function CI(t,e,n){if(!AI(n)||!function(s){return typeof s=="object"&&s!==null&&(Object.getPrototypeOf(s)===Object.prototype||Object.getPrototypeOf(s)===null)}(n)){const i=Mf(n);throw i==="an object"?e.mu(t+" a custom object"):e.mu(t+" "+i)}}function RD(t,e,n){if((e=Lt(e))instanceof qf)return e._internalPath;if(typeof e=="string")return SI(t,e);throw Dc("Field path arguments must be of type string or ",t,!1,void 0,n)}const AD=new RegExp("[~\\*/\\[\\]]");function SI(t,e,n){if(e.search(AD)>=0)throw Dc(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,n);try{return new qf(...e.split("."))._internalPath}catch{throw Dc(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,n)}}function Dc(t,e,n,i,s){const r=i&&!i.isEmpty(),o=s!==void 0;let a=`Function ${e}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(r||o)&&(c+=" (found",r&&(c+=` in field ${i}`),o&&(c+=` in document ${s}`),c+=")"),new z(b.INVALID_ARGUMENT,a+t+c)}function CD(t,e){return t.some(n=>n.isEqual(e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function DI(t){t=wn(t,Ct);const e=wn(t.firestore,Ys);return pD(Ml(e),t._key).then(n=>MI(e,t,n))}class Ff extends PD{constructor(e){super(),this.firestore=e}convertBytes(e){return new Xs(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Ct(this.firestore,null,n)}}function LI(t){t=wn(t,ra);const e=wn(t.firestore,Ys),n=Ml(e),i=new Ff(e);return NI(t._query),mD(n,t._query).then(s=>new OI(e,i,t,s))}function yu(t,e,n){t=wn(t,Ct);const i=wn(t.firestore,Ys),s=kD(t.converter,e,n);return xD(i,[bD(wD(i),"setDoc",t._key,s,t.converter!==null,n).toMutation(t._key,Wn.none())])}function Uf(t,...e){var n,i,s;t=Lt(t);let r={includeMetadataChanges:!1},o=0;typeof e[o]!="object"||xg(e[o])||(r=e[o],o++);const a={includeMetadataChanges:r.includeMetadataChanges};if(xg(e[o])){const h=e[o];e[o]=(n=h.next)===null||n===void 0?void 0:n.bind(h),e[o+1]=(i=h.error)===null||i===void 0?void 0:i.bind(h),e[o+2]=(s=h.complete)===null||s===void 0?void 0:s.bind(h)}let c,l,u;if(t instanceof Ct)l=wn(t.firestore,Ys),u=Al(t._key.path),c={next:h=>{e[o]&&e[o](MI(l,t,h))},error:e[o+1],complete:e[o+2]};else{const h=wn(t,ra);l=wn(h.firestore,Ys),u=h._query;const d=new Ff(l);c={next:f=>{e[o]&&e[o](new OI(l,d,h,f))},error:e[o+1],complete:e[o+2]},NI(t._query)}return function(d,f,g,v){const y=new Lf(v),I=new Of(f,y,g);return d.asyncQueue.enqueueAndForget(async()=>kf(await Oc(d),I)),()=>{y.Na(),d.asyncQueue.enqueueAndForget(async()=>Nf(await Oc(d),I))}}(Ml(l),u,a,c)}function xD(t,e){return function(i,s){const r=new $n;return i.asyncQueue.enqueueAndForget(async()=>eD(await fD(i),s,r)),r.promise}(Ml(t),e)}function MI(t,e,n){const i=n.docs.get(e._key),s=new Ff(t);return new xI(t,s,e._key,i,new Mr(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(s){fr=s})(bi),Rn(new nn("firestore",(i,{instanceIdentifier:s,options:r})=>{const o=i.getProvider("app").getImmediate(),a=new Ys(new VN(i.getProvider("auth-internal")),new jN(i.getProvider("app-check-internal")),function(l,u){if(!Object.prototype.hasOwnProperty.apply(l.options,["projectId"]))throw new z(b.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ro(l.options.projectId,u)}(o,s),o);return r=Object.assign({useFetchStreams:n},r),a._setSettings(r),a},"PUBLIC").setMultipleInstances(!0)),Ot(Zm,"4.3.2",e),Ot(Zm,"4.3.2","esm2017")})();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class GD{constructor(e,n,i,s,r,o,a,c,l,u,h,d=!0){this.url_=e,this.method_=n,this.headers_=i,this.body_=s,this.successCodes_=r,this.additionalRetryCodes_=o,this.callback_=a,this.errorCallback_=c,this.timeout_=l,this.progressCallback_=u,this.connectionFactory_=h,this.retry=d,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((f,g)=>{this.resolve_=f,this.reject_=g,this.start_()})}start_(){const e=(i,s)=>{if(s){i(!1,new Aa(!1,null,!0));return}const r=this.connectionFactory_();this.pendingConnection_=r;const o=a=>{const c=a.loaded,l=a.lengthComputable?a.total:-1;this.progressCallback_!==null&&this.progressCallback_(c,l)};this.progressCallback_!==null&&r.addUploadProgressListener(o),r.send(this.url_,this.method_,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&r.removeUploadProgressListener(o),this.pendingConnection_=null;const a=r.getErrorCode()===Lc.NO_ERROR,c=r.getStatus();if(!a||KD(c,this.additionalRetryCodes_)&&this.retry){const u=r.getErrorCode()===Lc.ABORT;i(!1,new Aa(!1,null,u));return}const l=this.successCodes_.indexOf(c)!==-1;i(!0,new Aa(l,r))})},n=(i,s)=>{const r=this.resolve_,o=this.reject_,a=s.connection;if(s.wasSuccessCode)try{const c=this.callback_(a,a.getResponse());WD(c)?r(c):r()}catch(c){o(c)}else if(a!==null){const c=MD();c.serverResponse=a.getErrorText(),this.errorCallback_?o(this.errorCallback_(a,c)):o(c)}else if(s.canceled){const c=this.appDelete_?VI():VD();o(c)}else{const c=qD();o(c)}};this.canceled_?n(!1,new Aa(!1,null,!0)):this.backoffId_=BD(e,n,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&$D(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class Aa{constructor(e,n,i){this.wasSuccessCode=e,this.connection=n,this.canceled=!!i}}function QD(t,e){e!==null&&e.length>0&&(t.Authorization="Firebase "+e)}function YD(t,e){t["X-Firebase-Storage-Version"]="webjs/"+(e??"AppManager")}function XD(t,e){e&&(t["X-Firebase-GMPID"]=e)}function JD(t,e){e!==null&&(t["X-Firebase-AppCheck"]=e)}function ZD(t,e,n,i,s,r,o=!0){const a=HD(t.urlParams),c=t.url+a,l=Object.assign({},t.headers);return XD(l,e),QD(l,n),YD(l,r),JD(l,i),new GD(c,t.method,l,t.body,t.successCodes,t.additionalRetryCodes,t.handler,t.errorHandler,t.timeout,t.progressCallback,s,o)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
