 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bi=KR;function bv(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const i=Object.assign({name:Fu,automaticDataCollectionEnabled:!1},e),s=i.name;if(typeof s!="string"||!s)throw mi.create("bad-app-name",{appName:String(s)});if(n||(n=gv()),!n)throw mi.create("no-options");const r=Ja.get(s);if(r){if(Xa(n,r.options)&&Xa(i,r.config))return r;throw mi.create("duplicate-app",{appName:s})}const o=new rR(s);for(const c of Uu.values())o.addComponent(c);const a=new XR(n,i,o);return Ja.set(s,a),a}function ad(t=Fu){const e=Ja.get(t);if(!e&&t===Fu&&gv())return bv();if(!e)throw mi.create("no-app",{appName:t});return e}function Ot(t,e,n){var i;let s=(i=GR[t])!==null&&i!==void 0?i:t;n&&(s+=`-${n}`);const r=s.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${s}" with version "${e}":`];r&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Gi.warn(a.join(" "));return}Rn(new nn(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Za=new Oo("@firebase/auth");function cA(t,...e){Za.logLevel<=re.WARN&&Za.warn(`Auth (${bi}): ${t}`,...e)}function Na(t,...e){Za.logLevel<=re.ERROR&&Za.error(`Auth (${bi}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function df(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function ff(t){const e=t.mapValue.fields.__previous_value__;return df(e)?ff(e):e}function bo(t){const e=Ii(t.mapValue.fields.__local_write_time__.timestampValue);return new Be(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
