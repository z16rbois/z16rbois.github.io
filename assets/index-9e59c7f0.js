 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rS(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function oS(t){Rn(new sn("auth",(e,{options:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),r=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=i.options;J(o&&!o.includes(":"),"invalid-api-key",{appName:i.name});const c={apiKey:o,authDomain:a,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:jv(t)},l=new VA(i,s,r,c);return BA(l,n),l},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,i)=>{e.getProvider("auth-internal").initialize()})),Rn(new sn("auth-internal",e=>{const n=nl(e.getProvider("auth").getImmediate());return(i=>new sS(i))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Dt(Jp,Zp,rS(t)),Dt(Jp,Zp,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uS=new Map,hS={activated:!1,tokenObservers:[]};function rn(t){return uS.get(t)||Object.assign({},hS)}const tm={OFFSET_DURATION:5*60*1e3,RETRIAL_MIN_WAIT:30*1e3,RETRIAL_MAX_WAIT:16*60*1e3};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TS={error:"UNKNOWN_ERROR"};function IS(t){return Zc.encodeString(JSON.stringify(t),!1)}async function Yu(t,e=!1){const n=t.app;sy(n);const i=rn(n);let s=i.token,r;if(s&&!kr(s)&&(i.token=void 0,s=void 0),!s){const c=await i.cachedTokenPromise;c&&(kr(c)?s=c:await nm(n,void 0))}if(!e&&s&&kr(s))return{token:s.token};let o=!1;try{i.exchangeTokenPromise||(i.exchangeTokenPromise=i.provider.getToken().finally(()=>{i.exchangeTokenPromise=void 0}),o=!0),s=await rn(n).exchangeTokenPromise}catch(c){c.code==="appCheck/throttled"?Qu.warn(c.message):Qu.error(c),r=c}let a;return s?r?kr(s)?a={token:s.token,internalError:r}:a=sm(r):(a={token:s.token},i.token=s,await nm(n,s)):a=sm(r),o&&AS(n,a),a}async function wS(t){const e=t.app;sy(e);const{provider:n}=rn(e);{const{token:i}=await n.getToken();return{token:i}}}function bS(t,e,n,i){const{app:s}=t,r=rn(s),o={next:n,error:i,type:e};if(r.tokenObservers=[...r.tokenObservers,o],r.token&&kr(r.token)){const a=r.token;Promise.resolve().then(()=>{n({token:a.token}),im(t)}).catch(()=>{})}r.cachedTokenPromise.then(()=>im(t))}function ry(t,e){const n=rn(t),i=n.tokenObservers.filter(s=>s.next!==e);i.length===0&&n.tokenRefresher&&n.tokenRefresher.isRunning()&&n.tokenRefresher.stop(),n.tokenObservers=i}function im(t){const{app:e}=t,n=rn(e);let i=n.tokenRefresher;i||(i=RS(t),n.tokenRefresher=i),!i.isRunning()&&n.isTokenAutoRefreshEnabled&&i.start()}function RS(t){const{app:e}=t;return new dS(async()=>{const n=rn(e);let i;if(n.token?i=await Yu(t,!0):i=await Yu(t),i.error)throw i.error;if(i.internalError)throw i.internalError},()=>!0,()=>{const n=rn(e);if(n.token){let i=n.token.issuedAtTimeMillis+(n.token.expireTimeMillis-n.token.issuedAtTimeMillis)*.5+3e5;const s=n.token.expireTimeMillis-5*60*1e3;return i=Math.min(i,s),Math.max(0,i-Date.now())}else return 0},tm.RETRIAL_MIN_WAIT,tm.RETRIAL_MAX_WAIT)}function AS(t,e){const n=rn(t).tokenObservers;for(const i of n)try{i.type==="EXTERNAL"&&e.error!=null?i.error(e.error):i.next(e)}catch{}}function kr(t){return t.expireTimeMillis-Date.now()>0}function sm(t){return{token:IS(TS),error:t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class CS{constructor(e,n){this.app=e,this.heartbeatServiceProvider=n}_delete(){const{tokenObservers:e}=rn(this.app);for(const n of e)ry(this.app,n.next);return Promise.resolve()}}function SS(t,e){return new CS(t,e)}function PS(t){return{getToken:e=>Yu(t,e),getLimitedUseToken:()=>wS(t),addTokenListener:e=>bS(t,"INTERNAL",e),removeTokenListener:e=>ry(t.app,e)}}const kS="@firebase/app-check",NS="0.8.0",xS="app-check",rm="app-check-internal";function DS(){Rn(new sn(xS,t=>{const e=t.getProvider("app").getImmediate(),n=t.getProvider("heartbeat");return SS(e,n)},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((t,e,n)=>{t.getProvider(rm).initialize()})),Rn(new sn(rm,t=>{const e=t.getProvider("app-check").getImmediate();return PS(e)},"PUBLIC").setInstantiationMode("EXPLICIT")),Dt(kS,NS)}DS();var OS="firebase",LS="10.6.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nn{constructor(e){this.writeTree_=e}static empty(){return new nn(new Pe(null))}}function $r(t,e,n){if(ae(e))return new nn(new Pe(n));{const i=t.writeTree_.findRootMostValueAndPath(e);if(i!=null){const s=i.path;let r=i.value;const o=Bt(s,e);return r=r.updateChild(o,n),new nn(t.writeTree_.set(s,r))}else{const s=new Pe(n),r=t.writeTree_.setTree(e,s);return new nn(r)}}}function Am(t,e,n){let i=t;return Wt(n,(s,r)=>{i=$r(i,Qe(e,s),r)}),i}function Cm(t,e){if(ae(e))return nn.empty();{const n=t.writeTree_.setTree(e,new Pe(null));return new nn(n)}}function sh(t,e){return is(t,e)!=null}function is(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return n!=null?t.writeTree_.get(n.path).getChild(Bt(n.path,e)):null}function Sm(t){const e=[],n=t.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(_t,(i,s)=>{e.push(new ue(i,s))}):t.writeTree_.children.inorderTraversal((i,s)=>{s.value!=null&&e.push(new ue(i,s.value))}),e}function gi(t,e){if(ae(e))return t;{const n=is(t,e);return n!=null?new nn(new Pe(n)):new nn(t.writeTree_.subtree(e))}}function rh(t){return t.writeTree_.isEmpty()}function js(t,e){return Hy(be(),t.writeTree_,e)}function Hy(t,e,n){if(e.value!=null)return n.updateChild(t,e.value);{let i=null;return e.children.inorderTraversal((s,r)=>{s===".priority"?(O(r.value!==null,"Priority writes must always be leaf nodes"),i=r.value):n=Hy(Qe(t,s),r,n)}),!n.getChild(t).isEmpty()&&i!==null&&(n=n.updateChild(Qe(t,".priority"),i)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
